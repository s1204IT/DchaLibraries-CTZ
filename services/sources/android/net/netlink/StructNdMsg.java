...
public class StructNdMsg {
    ...
    public String toString() {
        return "StructNdMsg{ family{" + NetlinkConstants.stringForAddressFamily(this.ndm_family) + "}, ifindex{" + this.ndm_ifindex + "}, state{" + (BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + ((int) this.ndm_state) + " (" + stringForNudState(this.ndm_state) + ")") + "}, flags{" + (BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + ((int) this.ndm_flags) + " (" + stringForNudFlags(this.ndm_flags) + ")") + "}, type{" + ((int) this.ndm_type) + "} }";
    }
}
