...
public class RtNetlinkNeighborMessage extends NetlinkMessage {
    ...
    public static byte[] newGetNeighborsRequest(int i) {
        ...
        structNlMsgHdr.pack(byteBufferWrap);
        new StructNdMsg().pack(byteBufferWrap);
        return bArr;
    }
    ...
    public String toString() {
        String hostAddress = this.mDestination == null ? BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS : this.mDestination.getHostAddress();
