...
public class ConnectivityPacketSummary {
    ...
    private void parseIPv4(StringJoiner stringJoiner) {
        ...
        int i = (this.mPacket.get(iPosition) & UsbDescriptor.DESCRIPTORTYPE_BOS) * 4;
    ...
    private void parseICMPv6(StringJoiner stringJoiner) {
        ...
        switch (iAsUint) {
            ...
            case NetworkConstants.ICMPV6_NEIGHBOR_ADVERTISEMENT:
                ...
                break;
            default:
                stringJoiner.add(DatabaseHelper.SoundModelContract.KEY_TYPE).add(NetworkConstants.asString(iAsUint));
