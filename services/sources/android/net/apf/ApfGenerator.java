...
public class ApfGenerator {
    ...
    private class Instruction {
        ...
        private int calculateTargetLabelOffset() throws IllegalInstructionException {
            ...
            if (this.mTargetLabel == ApfGenerator.DROP_LABEL) {
                ...
                instruction = this.mTargetLabel == ApfGenerator.PASS_LABEL ? ApfGenerator.this.mPassLabel : (Instruction) ApfGenerator.this.mLabels.get(this.mTargetLabel);
            }
            if (instruction == null) {
    ...
    public ApfGenerator addLoad32Indexed(Register register, int i) {
    ...
    public ApfGenerator addMul(int i) {
    ...
    public ApfGenerator addDiv(int i) {
    ...
    public ApfGenerator addOr(int i) {
    ...
    public ApfGenerator addLeftShift(int i) {
    ...
    public ApfGenerator addJumpIfR0EqualsR1(String str) {
    ...
    public ApfGenerator addJumpIfR0NotEqualsR1(String str) {
    ...
    public ApfGenerator addJumpIfR0GreaterThanR1(String str) {
    ...
    public ApfGenerator addJumpIfR0LessThanR1(String str) {
    ...
    public ApfGenerator addJumpIfR0AnyBitsSetR1(String str) {
    ...
    public ApfGenerator addStoreToMemory(Register register, int i) throws IllegalInstructionException {
        if (i < 0 || i > 15) {
            throw new IllegalInstructionException("illegal memory slot number: " + i);
        }
        Instruction instruction = new Instruction(Opcodes.EXT, register);
