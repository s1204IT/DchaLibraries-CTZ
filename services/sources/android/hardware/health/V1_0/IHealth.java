...
public interface IHealth extends IBase {
    ...
    public static final class Proxy implements IHealth {
        ...
        @Override
        public HealthConfig init(HealthConfig healthConfig) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IHealth.kInterfaceName);
            healthConfig.writeToParcel(hwParcel);
            ...
            try {
                ...
                healthConfig2.readFromParcel(hwParcel2);
                return healthConfig2;
            } finally {
                hwParcel2.release();
            }
        }
        ...
        @Override
        public void update(HealthInfo healthInfo, updateCallback updatecallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IHealth.kInterfaceName);
            ...
            try {
                ...
                hwParcel2.verifySuccess();
                hwParcel.releaseTemporaryStorage();
                boolean bool = hwParcel2.readBool();
                HealthInfo healthInfo2 = new HealthInfo();
                healthInfo2.readFromParcel(hwParcel2);
                updatecallback.onValues(bool, healthInfo2);
            } finally {
                hwParcel2.release();
            }
        }
        ...
        @Override
        public void energyCounter(energyCounterCallback energycountercallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IHealth.kInterfaceName);
            HwParcel hwParcel2 = new HwParcel();
            try {
                ...
                hwParcel2.verifySuccess();
                hwParcel.releaseTemporaryStorage();
                energycountercallback.onValues(hwParcel2.readInt32(), hwParcel2.readInt64());
            } finally {
                hwParcel2.release();
            }
        }
            ...
            switch (i) {
                case 1:
                    if ((i2 & 1) != 0) {
                        ...
                        healthConfig.readFromParcel(hwParcel);
                        HealthConfig healthConfigInit = init(healthConfig);
                        hwParcel2.writeStatus(0);
                        healthConfigInit.writeToParcel(hwParcel2);
                        hwParcel2.send();
                    }
                    break;
                case 2:
                    if (((i2 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        update(healthInfo, new updateCallback() {
                            @Override
                            public void onValues(boolean z, HealthInfo healthInfo2) {
                                hwParcel2.writeStatus(0);
                                hwParcel2.writeBool(z);
                                healthInfo2.writeToParcel(hwParcel2);
                                hwParcel2.send();
                            }
                        });
                    }
