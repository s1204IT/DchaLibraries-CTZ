...
public interface ITunerSession extends IBase {
    ...
    static ITunerSession asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof ITunerSession)) {
            return (ITunerSession) iHwInterfaceQueryLocalInterface;
        }
    ...
    public static abstract class Stub extends HwBinder implements ITunerSession {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-41, 4, 100, -59, 23, -92, -95, -75, 22, 119, UsbDescriptor.DESCRIPTORTYPE_ENDPOINT_COMPANION, -124, 55, 117, -87, 127, 69, 81, 2, -111, -98, -108, 91, 4, -9, 23, -71, -38, 57, 12, UsbDescriptor.DESCRIPTORTYPE_BOS, 57}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, UsbASFormat.EXT_FORMAT_TYPE_II, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, UsbDescriptor.DESCRIPTORTYPE_BOS, -39}));
        }
            ...
            switch (i) {
                case 1:
                    if ((i2 & 1) != 0) {
                        ...
                        int iTune = tune(programSelector);
                        hwParcel2.writeStatus(0);
                        hwParcel2.writeInt32(iTune);
                        hwParcel2.send();
                    }
                    break;
                case 2:
                    if ((i2 & 1) != 0) {
                        ...
                        hwParcel.enforceInterface(ITunerSession.kInterfaceName);
                        int iScan = scan(hwParcel.readBool(), hwParcel.readBool());
                        hwParcel2.writeStatus(0);
                        hwParcel2.writeInt32(iScan);
                        hwParcel2.send();
                    }
                    break;
                case 3:
                    if ((i2 & 1) != 0) {
                        ...
                        hwParcel.enforceInterface(ITunerSession.kInterfaceName);
                        int iStep = step(hwParcel.readBool());
                        hwParcel2.writeStatus(0);
                        hwParcel2.writeInt32(iStep);
                        hwParcel2.send();
                    }
                    break;
                case 4:
                ...
                case 5:
                    if ((i2 & 1) != 0) {
                        ...
                        int iStartProgramListUpdates = startProgramListUpdates(programFilter);
                        hwParcel2.writeStatus(0);
                        hwParcel2.writeInt32(iStartProgramListUpdates);
                        hwParcel2.send();
                    }
                    break;
                case 6:
                ...
                case 7:
                    if (((i2 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        hwParcel.enforceInterface(ITunerSession.kInterfaceName);
                        isConfigFlagSet(hwParcel.readInt32(), new isConfigFlagSetCallback() {
                            @Override
