...
public interface ITunerCallback extends IBase {
    ...
    static ITunerCallback asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof ITunerCallback)) {
            return (ITunerCallback) iHwInterfaceQueryLocalInterface;
        }
            ...
            switch (i) {
                case 1:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
                        ...
                        onTuneFailed(int32, programSelector);
                    }
                    break;
                case 2:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
