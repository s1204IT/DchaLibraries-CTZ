...
public interface IWeaver extends IBase {
    ...
    static IWeaver asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IWeaver)) {
            return (IWeaver) iHwInterfaceQueryLocalInterface;
        }
    ...
    public static final class Proxy implements IWeaver {
        ...
        public void getConfig(getConfigCallback getconfigcallback) throws RemoteException {
            ...
            try {
                ...
                getconfigcallback.onValues(int32, weaverConfig);
            } finally {
                hwParcel2.release();
            }
        }
        ...
        public void read(int i, ArrayList<Byte> arrayList, readCallback readcallback) throws RemoteException {
            ...
            try {
                ...
                readcallback.onValues(int32, weaverReadResponse);
            } finally {
                hwParcel2.release();
            }
        }
            ...
            switch (i) {
                ...
                case 2:
                    if ((i2 & 1) != 0) {
                        ...
                        hwParcel.enforceInterface(IWeaver.kInterfaceName);
                        int iWrite = write(hwParcel.readInt32(), hwParcel.readInt8Vector(), hwParcel.readInt8Vector());
                        hwParcel2.writeStatus(0);
                        hwParcel2.writeInt32(iWrite);
                        hwParcel2.send();
                    }
                    break;
                case 3:
                    if (((i2 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        hwParcel.enforceInterface(IWeaver.kInterfaceName);
                        read(hwParcel.readInt32(), hwParcel.readInt8Vector(), new readCallback() {
                            @Override
