...
public interface IUsb extends IBase {
    ...
    static IUsb asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IUsb)) {
            return (IUsb) iHwInterfaceQueryLocalInterface;
        }
