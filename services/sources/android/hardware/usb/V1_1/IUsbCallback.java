...
public interface IUsbCallback extends android.hardware.usb.V1_0.IUsbCallback {
    ...
    static IUsbCallback asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IUsbCallback)) {
            return (IUsbCallback) iHwInterfaceQueryLocalInterface;
        }
            ...
            switch (i) {
                ...
                case 2:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
                        ...
                        notifyRoleSwitchStatus(string, portRole, hwParcel.readInt32());
                    }
                    break;
                case 3:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
