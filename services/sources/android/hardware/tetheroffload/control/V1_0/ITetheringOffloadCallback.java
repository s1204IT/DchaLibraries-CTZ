...
public interface ITetheringOffloadCallback extends IBase {
    ...
    static ITetheringOffloadCallback asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface iHwInterfaceQueryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof ITetheringOffloadCallback)) {
            return (ITetheringOffloadCallback) iHwInterfaceQueryLocalInterface;
        }
    ...
    static ITetheringOffloadCallback castFrom(IHwInterface iHwInterface) {
    ...
    static ITetheringOffloadCallback getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static ITetheringOffloadCallback getService(boolean z) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, z);
    }

    static ITetheringOffloadCallback getService(String str) throws RemoteException {
    ...
    public static final class Proxy implements ITetheringOffloadCallback {
        ...
        public void onEvent(int i) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(ITetheringOffloadCallback.kInterfaceName);
        ...
        @Override
        public void updateTimeout(NatTimeoutUpdate natTimeoutUpdate) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(ITetheringOffloadCallback.kInterfaceName);
            natTimeoutUpdate.writeToParcel(hwParcel);
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements ITetheringOffloadCallback {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (ITetheringOffloadCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
            ...
            switch (i) {
                case 1:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
                        ...
                        hwParcel.enforceInterface(ITetheringOffloadCallback.kInterfaceName);
                        onEvent(hwParcel.readInt32());
                    }
                    break;
                case 2:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
                        ...
                        hwParcel.enforceInterface(ITetheringOffloadCallback.kInterfaceName);
                        NatTimeoutUpdate natTimeoutUpdate = new NatTimeoutUpdate();
                        natTimeoutUpdate.readFromParcel(hwParcel);
                        updateTimeout(natTimeoutUpdate);
                    }
                    break;
                case 256067662:
                    if ((i2 & 1) != 0) {
