...
public interface IBiometricsFingerprintClientCallback extends IBase {
    ...
    static IBiometricsFingerprintClientCallback asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IBiometricsFingerprintClientCallback)) {
            return (IBiometricsFingerprintClientCallback) iHwInterfaceQueryLocalInterface;
        }
