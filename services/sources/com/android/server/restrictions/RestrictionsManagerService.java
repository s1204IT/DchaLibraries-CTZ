        ...
        public Intent createLocalApprovalIntent() throws RemoteException {
            ...
            if (this.mDpm != null) {
                ...
                try {
                    ...
                    ResolveInfo resolveInfoResolveIntent = AppGlobals.getPackageManager().resolveIntent(intent, (String) null, 0, callingUserId);
                    if (resolveInfoResolveIntent != null && resolveInfoResolveIntent.activityInfo != null && resolveInfoResolveIntent.activityInfo.exported) {
                        intent.setComponent(new ComponentName(resolveInfoResolveIntent.activityInfo.packageName, resolveInfoResolveIntent.activityInfo.name));
                        return intent;
                    }
                } finally {
                    Binder.restoreCallingIdentity(jClearCallingIdentity);
