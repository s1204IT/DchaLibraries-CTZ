...
public class NotificationChannelExtractor implements NotificationSignalExtractor {
    ...
    public RankingReconsideration process(NotificationRecord notificationRecord) {
        ...
        notificationRecord.updateNotificationChannel(this.mConfig.getNotificationChannel(notificationRecord.sbn.getPackageName(), notificationRecord.sbn.getUid(), notificationRecord.getChannel().getId(), false));
        return null;
    }
