...
public class FunctionTable {
    ...
    Function getFunction(int i) throws TransformerException {
        try {
            if (i < 37) {
    ...
    Object getFunctionID(String str) {
    ...
    public int installFunction(String str, Class cls) {
        ...
        if (functionID != null) {
            int iIntValue = ((Integer) functionID).intValue();
            if (iIntValue < 37) {
                iIntValue = this.m_funcNextFreeIndex;
                this.m_funcNextFreeIndex = iIntValue + 1;
                this.m_functionID_customer.put(str, new Integer(iIntValue));
            }
            this.m_functions_customer[iIntValue - 37] = cls;
            return iIntValue;
        }
