...
public class URI implements Serializable {
    ...
    private void initialize(URI uri, String str) throws MalformedURIException {
        ...
        if (iIndexOf < 0) {
            if (uri == null) {
                throw new MalformedURIException(XMLMessages.createXMLMessage("ER_NO_SCHEME_IN_URI", new Object[]{strTrim}));
            }
        } else {
            ...
            if (this.m_host == null) {
                ...
                while (true) {
                    ...
                    if (iLastIndexOf3 != -1) {
                        ...
                        if (!strSubstring.substring(iLastIndexOf3).equals(org.apache.xalan.templates.Constants.ATTRVAL_PARENT)) {
    ...
    private void initializePath(String str) throws MalformedURIException {
        ...
        while (i2 < length && (cCharAt = str.charAt(i2)) != '?' && cCharAt != '#') {
            if (cCharAt == '%') {
                ...
                throw new MalformedURIException(XMLMessages.createXMLMessage("ER_PATH_INVALID_CHAR", new Object[]{String.valueOf(cCharAt)}));
            }
            i2++;
        }
    ...
    public static boolean isWellFormedAddress(String str) {
        ...
        int length;
        int i;
        if (str == null || (length = (strTrim = str.trim()).length()) == 0 || length > 255 || strTrim.startsWith(org.apache.xalan.templates.Constants.ATTRVAL_THIS) || strTrim.startsWith("-")) {
            return false;
        }
        int iLastIndexOf = strTrim.lastIndexOf(46);
        if (strTrim.endsWith(org.apache.xalan.templates.Constants.ATTRVAL_THIS)) {
