...
public class XMLChar {
    ...
    static {
        ...
        int[] iArr16 = iArr7;
        for (int i3 = 0; i3 < iArr15.length; i3++) {
            CHARS[iArr15[i3]] = (byte) (CHARS[iArr15[i3]] & (-33));
        }
        for (int i4 : iArr3) {
            byte[] bArr2 = CHARS;
        ...
        for (int i6 = 0; i6 < iArr8.length; i6 += 2) {
            for (int i7 = iArr8[i6]; i7 <= iArr8[i6 + 1]; i7++) {
                byte[] bArr4 = CHARS;
        ...
        for (int i10 = 0; i10 < iArr12.length; i10 += 2) {
            for (int i11 = iArr12[i10]; i11 <= iArr12[i10 + 1]; i11++) {
                byte[] bArr7 = CHARS;
                bArr7[i11] = (byte) (bArr7[i11] | 136);
            }
        }
        for (int i12 = 0; i12 < iArr10.length; i12 += 2) {
            for (int i13 = iArr10[i12]; i13 <= iArr10[i12 + 1]; i13++) {
                byte[] bArr8 = CHARS;
        ...
        for (int i15 = 0; i15 < iArr13.length; i15 += 2) {
            for (int i16 = iArr13[i15]; i16 <= iArr13[i15 + 1]; i16++) {
                byte[] bArr10 = CHARS;
        ...
        while (true) {
            int[] iArr17 = iArr16;
            if (i19 < iArr17.length) {
                for (int i20 = iArr17[i19]; i20 <= iArr17[i19 + 1]; i20++) {
                    byte[] bArr14 = CHARS;
