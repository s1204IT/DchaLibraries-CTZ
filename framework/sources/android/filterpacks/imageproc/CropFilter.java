...
public class CropFilter extends Filter {
    ...
    public void process(FilterContext filterContext) {
        ...
        mutableFrameFormatMutableCopy.setDimensions(this.mOutputWidth == -1 ? mutableFrameFormatMutableCopy.getWidth() : this.mOutputWidth, this.mOutputHeight == -1 ? mutableFrameFormatMutableCopy.getHeight() : this.mOutputHeight);
