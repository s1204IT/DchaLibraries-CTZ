...
public interface IVibrator extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IVibrator {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{6, -22, 100, -52, 53, 101, 119, 127, 59, 37, -98, BluetoothHidDevice.SUBCLASS1_KEYBOARD, MidiConstants.STATUS_CHANNEL_MASK, -6, 113, 0, MidiConstants.STATUS_CHANNEL_PRESSURE, 127, 56, 39, -83, -109, 87, MidiConstants.STATUS_CONTROL_CHANGE, -59, -45, -58, 81, 56, 78, 85, 83}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 125, -64, -126, -116, MidiConstants.STATUS_MIDI_TIME_CODE, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, MidiConstants.STATUS_CHANNEL_MASK, -39}));
        }
            ...
            switch (i) {
                ...
                case 5:
                    if (((i2 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        hwParcel.enforceInterface(IVibrator.kInterfaceName);
                        perform(hwParcel.readInt32(), hwParcel.readInt8(), new performCallback() {
                            @Override
