...
public interface IVibrator extends android.hardware.vibrator.V1_1.IVibrator {
    ...
    public static abstract class Stub extends HwBinder implements IVibrator {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{GsmAlphabet.GSM_EXTENDED_ESCAPE, -4, -97, -39, 83, 110, MidiConstants.STATUS_CHANNEL_PRESSURE, -97, 4, -68, -81, 34, 42, 51, 43, -55, 25, MidiConstants.STATUS_MIDI_TIME_CODE, 86, 93, 77, 8, -67, -36, -51, -21, -31, -65, -54, -113, 1, -75}, new byte[]{-7, 90, 30, -123, 97, 47, 45, 13, 97, 110, -84, -46, -21, 99, -59, 45, WifiScanner.PnoSettings.PnoNetwork.FLAG_SAME_NETWORK, -33, -88, -119, MidiConstants.STATUS_MIDI_TIME_CODE, 101, -33, 87, 105, 124, 48, -31, -12, 123, 71, -123}, new byte[]{6, -22, 100, -52, 53, 101, 119, 127, 59, 37, -98, BluetoothHidDevice.SUBCLASS1_KEYBOARD, MidiConstants.STATUS_CHANNEL_MASK, -6, 113, 0, MidiConstants.STATUS_CHANNEL_PRESSURE, 127, 56, 39, -83, -109, 87, MidiConstants.STATUS_CONTROL_CHANGE, -59, -45, -58, 81, 56, 78, 85, 83}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 125, -64, -126, -116, MidiConstants.STATUS_MIDI_TIME_CODE, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, MidiConstants.STATUS_CHANNEL_MASK, -39}));
        }
            ...
            switch (i) {
                ...
                case 5:
                    if (((i2 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        hwParcel.enforceInterface(android.hardware.vibrator.V1_0.IVibrator.kInterfaceName);
                        perform(hwParcel.readInt32(), hwParcel.readInt8(), new IVibrator.performCallback() {
                            @Override
                ...
                case 6:
                    if (((i2 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        perform_1_1(hwParcel.readInt32(), hwParcel.readInt8(), new IVibrator.perform_1_1Callback() {
                            @Override
                            public void onValues(int i3, int i4) {
                                hwParcel2.writeStatus(0);
                                hwParcel2.writeInt32(i3);
                ...
                case 7:
                    if (((i2 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        perform_1_2(hwParcel.readInt32(), hwParcel.readInt8(), new perform_1_2Callback() {
                            @Override
                            public void onValues(int i3, int i4) {
                                hwParcel2.writeStatus(0);
                                hwParcel2.writeInt32(i3);
