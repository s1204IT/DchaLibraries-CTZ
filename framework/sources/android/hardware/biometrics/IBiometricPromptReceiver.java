...
public interface IBiometricPromptReceiver extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBiometricPromptReceiver {
        ...
        public static IBiometricPromptReceiver asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IBiometricPromptReceiver)) {
                return (IBiometricPromptReceiver) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onDialogDismissed(parcel.readInt());
                return true;
            }
            if (i == 1598968902) {
