...
public final class CellIdentity {
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        ...
        HwBlob embeddedBuffer2 = hwParcel.readEmbeddedBuffer(int322 * 48, hwBlob.handle(), j3 + 0, true);
        ...
        HwBlob embeddedBuffer3 = hwParcel.readEmbeddedBuffer(int323 * 20, hwBlob.handle(), j4 + 0, true);
        ...
        HwBlob embeddedBuffer4 = hwParcel.readEmbeddedBuffer(int324 * 48, hwBlob.handle(), j5 + 0, true);
        ...
        HwBlob embeddedBuffer5 = hwParcel.readEmbeddedBuffer(int325 * 48, hwBlob.handle(), 0 + j6, true);
