    ...
    public static abstract class Stub extends Binder implements IUsbManager {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface(DESCRIPTOR);
                    ParcelFileDescriptor parcelFileDescriptorOpenDevice = openDevice(parcel.readString(), parcel.readString());
                    parcel2.writeNoException();
                ...
                case 7:
                    parcel.enforceInterface(DESCRIPTOR);
                    boolean zHasDevicePermission = hasDevicePermission(parcel.readInt() != 0 ? UsbDevice.CREATOR.createFromParcel(parcel) : null, parcel.readString());
                    parcel2.writeNoException();
                ...
                case 9:
                    parcel.enforceInterface(DESCRIPTOR);
                    if (parcel.readInt() != 0) {
                        usbDeviceCreateFromParcel = UsbDevice.CREATOR.createFromParcel(parcel);
                    } else {
                        usbDeviceCreateFromParcel = null;
                    }
                    requestDevicePermission(usbDeviceCreateFromParcel, parcel.readString(), parcel.readInt() != 0 ? PendingIntent.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 10:
                    parcel.enforceInterface(DESCRIPTOR);
                    if (parcel.readInt() != 0) {
                        usbAccessoryCreateFromParcel = UsbAccessory.CREATOR.createFromParcel(parcel);
                    } else {
                        usbAccessoryCreateFromParcel = null;
                    }
                    requestAccessoryPermission(usbAccessoryCreateFromParcel, parcel.readString(), parcel.readInt() != 0 ? PendingIntent.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 11:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 15:
                    parcel.enforceInterface(DESCRIPTOR);
                    boolean zIsFunctionEnabled = isFunctionEnabled(parcel.readString());
                    parcel2.writeNoException();
                    parcel2.writeInt(zIsFunctionEnabled ? 1 : 0);
                    return true;
                case 16:
                    parcel.enforceInterface(DESCRIPTOR);
                    setCurrentFunctions(parcel.readLong());
                    parcel2.writeNoException();
                    return true;
                case 17:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 19:
                    parcel.enforceInterface(DESCRIPTOR);
                    setScreenUnlockedFunctions(parcel.readLong());
                    parcel2.writeNoException();
                    return true;
                case 20:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 21:
                    parcel.enforceInterface(DESCRIPTOR);
                    ParcelFileDescriptor controlFd = getControlFd(parcel.readLong());
                    parcel2.writeNoException();
                    if (controlFd != null) {
                        parcel2.writeInt(1);
                        controlFd.writeToParcel(parcel2, 1);
                    } else {
                        parcel2.writeInt(0);
                    }
                    return true;
                ...
                case 25:
                    ...
                    parcel2.writeNoException();
                    parcel2.writeTypedArray(ports, 1);
                    return true;
                case 26:
                    parcel.enforceInterface(DESCRIPTOR);
                    UsbPortStatus portStatus = getPortStatus(parcel.readString());
                    parcel2.writeNoException();
                    if (portStatus != null) {
                        parcel2.writeInt(1);
                        portStatus.writeToParcel(parcel2, 1);
                    } else {
                        parcel2.writeInt(0);
                    }
                    return true;
                ...
                case 28:
                    parcel.enforceInterface(DESCRIPTOR);
                    setUsbDeviceConnectionHandler(parcel.readInt() != 0 ? ComponentName.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                default:
        ...
        private static class Proxy implements IUsbManager {
            ...
            public UsbAccessory getCurrentAccessory() throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain2.readException();
                    if (parcelObtain2.readInt() != 0) {
                        usbAccessoryCreateFromParcel = UsbAccessory.CREATOR.createFromParcel(parcelObtain2);
                    } else {
                        usbAccessoryCreateFromParcel = null;
                    }
            ...
            @Override
            public void setCurrentFunctions(long j) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public UsbPort[] getPorts() throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain2.readException();
                    return (UsbPort[]) parcelObtain2.createTypedArray(UsbPort.CREATOR);
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
                }
            ...
            public UsbPortStatus getPortStatus(String str) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain2.readException();
                    if (parcelObtain2.readInt() != 0) {
                        usbPortStatusCreateFromParcel = UsbPortStatus.CREATOR.createFromParcel(parcelObtain2);
                    } else {
