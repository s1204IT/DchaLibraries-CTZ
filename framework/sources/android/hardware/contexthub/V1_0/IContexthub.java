...
public interface IContexthub extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IContexthub {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-91, -82, MidiConstants.STATUS_CHANNEL_MASK, -24, 102, 127, 11, 26, -16, -101, 19, -25, 45, 41, 96, MidiConstants.STATUS_CHANNEL_MASK, 78, -77, -123, 59, 37, 112, 121, -60, 90, -103, -74, -12, -93, 54, 6, 73}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 125, -64, -126, -116, MidiConstants.STATUS_MIDI_TIME_CODE, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, MidiConstants.STATUS_CHANNEL_MASK, -39}));
        }
