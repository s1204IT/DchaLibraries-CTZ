...
public interface IContexthubCallback extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IContexthubCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{42, -77, 5, 76, 45, -109, 2, -40, 65, 126, -25, 73, 83, 83, -94, -120, 127, -29, 56, -7, 19, 39, 111, 46, -76, 30, -128, MidiConstants.STATUS_MIDI_TIME_CODE, 19, -107, -20, 46}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 125, -64, -126, -116, MidiConstants.STATUS_MIDI_TIME_CODE, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, MidiConstants.STATUS_CHANNEL_MASK, -39}));
        }
