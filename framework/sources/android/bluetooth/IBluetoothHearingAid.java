...
public interface IBluetoothHearingAid extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothHearingAid {
        ...
        public static IBluetoothHearingAid asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IBluetoothHearingAid)) {
                return (IBluetoothHearingAid) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 7:
                    parcel.enforceInterface(DESCRIPTOR);
                    List<BluetoothDevice> activeDevices = getActiveDevices();
                    parcel2.writeNoException();
                    parcel2.writeTypedList(activeDevices);
                    return true;
                case 8:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 13:
                    parcel.enforceInterface(DESCRIPTOR);
                    long hiSyncId = getHiSyncId(parcel.readInt() != 0 ? BluetoothDevice.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    parcel2.writeLong(hiSyncId);
                    return true;
                case 14:
                    parcel.enforceInterface(DESCRIPTOR);
                    int deviceSide = getDeviceSide(parcel.readInt() != 0 ? BluetoothDevice.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    parcel2.writeInt(deviceSide);
                    return true;
                case 15:
                    parcel.enforceInterface(DESCRIPTOR);
                    int deviceMode = getDeviceMode(parcel.readInt() != 0 ? BluetoothDevice.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
        ...
        private static class Proxy implements IBluetoothHearingAid {
            ...
            @Override
            public void adjustVolume(int i) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
