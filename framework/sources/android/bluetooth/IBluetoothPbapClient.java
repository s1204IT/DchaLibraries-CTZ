...
public interface IBluetoothPbapClient extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothPbapClient {
        ...
        public static IBluetoothPbapClient asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IBluetoothPbapClient)) {
                return (IBluetoothPbapClient) iInterfaceQueryLocalInterface;
            }
