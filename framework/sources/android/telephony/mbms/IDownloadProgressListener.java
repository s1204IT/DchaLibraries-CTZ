...
public interface IDownloadProgressListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDownloadProgressListener {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            onProgressUpdated(downloadRequestCreateFromParcel, parcel.readInt() != 0 ? FileInfo.CREATOR.createFromParcel(parcel) : null, parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt());
