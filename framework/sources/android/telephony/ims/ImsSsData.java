...
public final class ImsSsData implements Parcelable {
    ...
    private ImsSsData(Parcel parcel) {
        ...
        this.mCfInfo = (ImsCallForwardInfo[]) parcel.readParcelableArray(getClass().getClassLoader());
        this.mImsSsInfo = (ImsSsInfo[]) parcel.readParcelableArray(getClass().getClassLoader());
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeParcelableArray(this.mCfInfo, 0);
        parcel.writeParcelableArray(this.mImsSsInfo, 0);
    }
