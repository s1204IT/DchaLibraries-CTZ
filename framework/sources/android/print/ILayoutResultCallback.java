    ...
    public static abstract class Stub extends Binder implements ILayoutResultCallback {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface(DESCRIPTOR);
                    PrintDocumentInfo printDocumentInfoCreateFromParcel = parcel.readInt() != 0 ? PrintDocumentInfo.CREATOR.createFromParcel(parcel) : null;
                    if (parcel.readInt() == 0) {
                        z = false;
                    } else {
                        z = true;
                    }
                    onLayoutFinished(printDocumentInfoCreateFromParcel, z, parcel.readInt());
                    return true;
                case 3:
                    parcel.enforceInterface(DESCRIPTOR);
