...
public interface IPowerManager extends IInterface {
    ...
    boolean getKeepAwake() throws RemoteException;
    ...
    void setKeepAwake(boolean z) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IPowerManager {
        ...
        static final int TRANSACTION_getKeepAwake = 29;
        ...
        static final int TRANSACTION_setKeepAwake = 28;
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 12:
                    ...
                    parcel2.writeNoException();
                    parcel2.writeInt(zIsInteractive ? 1 : 0);
                    return true;
                case 13:
                    parcel.enforceInterface(DESCRIPTOR);
                    boolean zIsPowerSaveMode = isPowerSaveMode();
                    parcel2.writeNoException();
                    parcel2.writeInt(zIsPowerSaveMode ? 1 : 0);
                    return true;
                case 14:
                    parcel.enforceInterface(DESCRIPTOR);
                    PowerSaveState powerSaveState = getPowerSaveState(parcel.readInt());
                    parcel2.writeNoException();
                    if (powerSaveState != null) {
                        parcel2.writeInt(1);
                        powerSaveState.writeToParcel(parcel2, 1);
                    } else {
                        parcel2.writeInt(0);
                    }
                    return true;
                ...
                case 16:
                    ...
                    parcel2.writeNoException();
                    parcel2.writeInt(zIsDeviceIdleMode ? 1 : 0);
                    return true;
                case 17:
                    parcel.enforceInterface(DESCRIPTOR);
                    boolean zIsLightDeviceIdleMode = isLightDeviceIdleMode();
                    parcel2.writeNoException();
                    parcel2.writeInt(zIsLightDeviceIdleMode ? 1 : 0);
                    return true;
                case 18:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 19:
                    parcel.enforceInterface(DESCRIPTOR);
                    rebootSafeMode(parcel.readInt() != 0, parcel.readInt() != 0);
                    parcel2.writeNoException();
                    return true;
                case 20:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 25:
                    ...
                    parcel2.writeNoException();
                    parcel2.writeInt(zIsScreenBrightnessBoosted ? 1 : 0);
                    return true;
                case 26:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 27:
                    parcel.enforceInterface(DESCRIPTOR);
                    setDozeAfterScreenOff(parcel.readInt() != 0);
                    parcel2.writeNoException();
                    return true;
                case 28:
                    parcel.enforceInterface(DESCRIPTOR);
                    setKeepAwake(parcel.readInt() != 0);
                    parcel2.writeNoException();
                    return true;
                case 29:
                    parcel.enforceInterface(DESCRIPTOR);
                    boolean keepAwake = getKeepAwake();
                    parcel2.writeNoException();
                    parcel2.writeInt(keepAwake ? 1 : 0);
                    return true;
                default:
        ...
        private static class Proxy implements IPowerManager {
            ...
            public PowerSaveState getPowerSaveState(int i) throws RemoteException {
                PowerSaveState powerSaveStateCreateFromParcel;
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    if (parcelObtain2.readInt() != 0) {
                        powerSaveStateCreateFromParcel = PowerSaveState.CREATOR.createFromParcel(parcelObtain2);
                    } else {
                        powerSaveStateCreateFromParcel = null;
                    }
                    return powerSaveStateCreateFromParcel;
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
                }
            ...
            @Override
            public void setKeepAwake(boolean z) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override
            public boolean getKeepAwake() throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
