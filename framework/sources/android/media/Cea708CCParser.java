    ...
    private int parseC1(byte[] bArr, int i) {
        ...
        switch (i3) {
            ...
            case 144:
                ...
                i2 = i + 2;
                emitCaptionEvent(new CaptionEvent(12, new CaptionPenAttr(i11, i12, i10, bArr[i13] & 7, (bArr[i13] & 56) >> 3, (bArr[i13] & BluetoothHidDevice.SUBCLASS1_KEYBOARD) != 0, z)));
                break;
            case 145:
            ...
            default:
                switch (i3) {
                    case 151:
                        ...
                        int i20 = i + 3;
                        i2 = i + 4;
                        emitCaptionEvent(new CaptionEvent(15, new CaptionWindowAttr(captionColor3, captionColor4, i19, (bArr[i18] & BluetoothHidDevice.SUBCLASS1_KEYBOARD) != 0, (bArr[i18] & 48) >> 4, (bArr[i18] & 12) >> 2, bArr[i18] & 3, (bArr[i20] & 12) >> 2, (bArr[i20] & 240) >> 4, bArr[i20] & 3)));
                        break;
                    case 152:
                    case 153:
                    case 154:
                    ...
                    case 159:
                        ...
                        int i23 = i + 5;
                        i2 = i + 6;
                        emitCaptionEvent(new CaptionEvent(16, new CaptionWindow(this.mCommand - 152, (bArr[i] & 32) != 0, (bArr[i] & WifiScanner.PnoSettings.PnoNetwork.FLAG_SAME_NETWORK) != 0, (bArr[i] & 8) != 0, bArr[i] & 7, (bArr[i21] & 128) != 0, bArr[i21] & 127, bArr[i + 2] & 255, (bArr[i22] & 240) >> 4, bArr[i22] & MidiConstants.STATUS_CHANNEL_MASK, bArr[i + 4] & 63, bArr[i23] & 7, (bArr[i23] & 56) >> 3)));
                        break;
                    default:
                        return i;
                }
