...
public class AudioSystem {
    ...
    public static int[] DEFAULT_STREAM_VOLUME = {4, 15, 8, 8, 8, 8, 7, 15, 11, 11, 11};
    ...
    private static void recordingCallbackFromNative(int i, int i2, int i3, int i4, int[] iArr) {
        AudioRecordingCallback audioRecordingCallback;
        synchronized (AudioSystem.class) {
            audioRecordingCallback = sRecordingCallback;
        }
        if (audioRecordingCallback != null) {
            audioRecordingCallback.onRecordingConfigurationChanged(i, i2, i3, i4, iArr, "");
        }
    }
    ...
    static boolean isOffloadSupported(AudioFormat audioFormat) {
        return native_is_offload_supported(audioFormat.getEncoding(), audioFormat.getSampleRate(), audioFormat.getChannelMask(), audioFormat.getChannelIndexMask());
    }
