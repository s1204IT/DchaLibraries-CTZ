...
public final class SessionCommand2 {
    ...
    public SessionCommand2(int i) {
        this.mProvider = ApiLoader.getProvider().createMediaSession2Command(this, i, null, null);
    }
    ...
    public SessionCommand2(String str, Bundle bundle) {
        ...
        this.mProvider = ApiLoader.getProvider().createMediaSession2Command(this, 0, str, bundle);
    }
    ...
    public static SessionCommand2 fromBundle(Bundle bundle) {
        return ApiLoader.getProvider().fromBundle_MediaSession2Command(bundle);
    }
}
