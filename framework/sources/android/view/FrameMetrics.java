...
public final class FrameMetrics {
    ...
    public FrameMetrics(FrameMetrics frameMetrics) {
        ...
        System.arraycopy(frameMetrics.mTimingData, 0, this.mTimingData, 0, this.mTimingData.length);
    }
    ...
    public long getMetric(int i) {
        if (i < 0 || i > 11 || this.mTimingData == null) {
            return -1L;
        }
        if (i == 9) {
        ...
        int i2 = 2 * i;
        return this.mTimingData[DURATIONS[i2 + 1]] - this.mTimingData[DURATIONS[i2]];
    }
}
