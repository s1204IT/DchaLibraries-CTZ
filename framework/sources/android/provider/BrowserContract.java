...
public class BrowserContract {
    ...
    public static final class Settings {
        ...
        public static boolean isSyncEnabled(Context context) throws Throwable {
            Cursor cursor = null;
            try {
                Cursor cursorQuery = context.getContentResolver().query(CONTENT_URI, new String[]{"value"}, "key=?", new String[]{KEY_SYNC_ENABLED}, null);
                if (cursorQuery != null) {
                    try {
