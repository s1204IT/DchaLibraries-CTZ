...
public class BlockedNumberContract {
    ...
    public static boolean isBlocked(Context context, String str) {
        try {
            Bundle bundleCall = context.getContentResolver().call(AUTHORITY_URI, METHOD_IS_BLOCKED, str, null);
            if (bundleCall != null) {
                return bundleCall.getBoolean(RES_NUMBER_IS_BLOCKED, false);
            }
            return false;
    ...
    public static int unblock(Context context, String str) {
        return context.getContentResolver().call(AUTHORITY_URI, METHOD_UNBLOCK, str, null).getInt(RES_NUM_ROWS_DELETED, 0);
    }

    public static boolean canCurrentUserBlockNumbers(Context context) {
        try {
            Bundle bundleCall = context.getContentResolver().call(AUTHORITY_URI, METHOD_CAN_CURRENT_USER_BLOCK_NUMBERS, null, null);
            if (bundleCall != null) {
                return bundleCall.getBoolean(RES_CAN_BLOCK_NUMBERS, false);
            }
            return false;
        } catch (IllegalArgumentException | NullPointerException e) {
    ...
    public static class SystemContract {
        ...
        public static boolean shouldSystemBlockNumber(Context context, String str, Bundle bundle) {
            try {
                ...
                if (bundleCall != null) {
                    return bundleCall.getBoolean(BlockedNumberContract.RES_NUMBER_IS_BLOCKED, false);
                }
                return false;
            } catch (IllegalArgumentException | NullPointerException e) {
        ...
        public static BlockSuppressionStatus getBlockSuppressionStatus(Context context) {
            Bundle bundleCall = context.getContentResolver().call(BlockedNumberContract.AUTHORITY_URI, METHOD_GET_BLOCK_SUPPRESSION_STATUS, null, null);
            return new BlockSuppressionStatus(bundleCall.getBoolean(RES_IS_BLOCKING_SUPPRESSED, false), bundleCall.getLong(RES_BLOCKING_SUPPRESSED_UNTIL_TIMESTAMP, 0L));
        }

        public static boolean shouldShowEmergencyCallNotification(Context context) {
            try {
                Bundle bundleCall = context.getContentResolver().call(BlockedNumberContract.AUTHORITY_URI, METHOD_SHOULD_SHOW_EMERGENCY_CALL_NOTIFICATION, null, null);
                if (bundleCall != null) {
                    return bundleCall.getBoolean("show_emergency_call_notification", false);
                }
                return false;
            } catch (IllegalArgumentException | NullPointerException e) {
        ...
        public static boolean getEnhancedBlockSetting(Context context, String str) {
            ...
            try {
                Bundle bundleCall = context.getContentResolver().call(BlockedNumberContract.AUTHORITY_URI, METHOD_GET_ENHANCED_BLOCK_SETTING, null, bundle);
                if (bundleCall != null) {
                    return bundleCall.getBoolean(BlockedNumberContract.RES_ENHANCED_SETTING_IS_ENABLED, false);
                }
                return false;
            } catch (IllegalArgumentException | NullPointerException e) {
        ...
        public static void setEnhancedBlockSetting(Context context, String str, boolean z) {
            ...
            context.getContentResolver().call(BlockedNumberContract.AUTHORITY_URI, METHOD_SET_ENHANCED_BLOCK_SETTING, null, bundle);
        }
