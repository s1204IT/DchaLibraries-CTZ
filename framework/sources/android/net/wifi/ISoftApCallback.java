...
public interface ISoftApCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISoftApCallback {
        ...
        public static ISoftApCallback asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof ISoftApCallback)) {
                return (ISoftApCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface(DESCRIPTOR);
                    onNumClientsChanged(parcel.readInt());
                    return true;
                default:
        ...
        private static class Proxy implements ISoftApCallback {
            ...
            @Override
            public void onNumClientsChanged(int i) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    parcelObtain.writeInt(i);
