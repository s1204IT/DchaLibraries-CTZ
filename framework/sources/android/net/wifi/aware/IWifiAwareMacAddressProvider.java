...
public interface IWifiAwareMacAddressProvider extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWifiAwareMacAddressProvider {
        ...
        public static IWifiAwareMacAddressProvider asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IWifiAwareMacAddressProvider)) {
                return (IWifiAwareMacAddressProvider) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                macAddress(parcel.readHashMap(getClass().getClassLoader()));
                return true;
            }
            if (i == 1598968902) {
