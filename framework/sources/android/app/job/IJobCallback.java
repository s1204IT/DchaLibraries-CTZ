    ...
    public static abstract class Stub extends Binder implements IJobCallback {
        ...
        private static class Proxy implements IJobCallback {
            ...
            public JobWorkItem dequeueWork(int i) throws RemoteException {
                JobWorkItem jobWorkItemCreateFromParcel;
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    if (parcelObtain2.readInt() != 0) {
                        jobWorkItemCreateFromParcel = JobWorkItem.CREATOR.createFromParcel(parcelObtain2);
                    } else {
                        jobWorkItemCreateFromParcel = null;
                    }
                    return jobWorkItemCreateFromParcel;
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
                }
