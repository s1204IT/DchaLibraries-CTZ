...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    static class AnimateOnHWLayerIfNeededListener implements Animator.AnimatorListener {
        ...
        public void onAnimationStart(Animator animator) {
            this.mShouldRunOnHWLayer = FragmentManagerImpl.shouldRunOnHWLayer(this.mView, animator);
                    ...
                    case 3:
                        if (i4 < 2) {
                            ...
                            if (fragment.mView != null && fragment.mContainer != null) {
                                ...
                                Animator animatorLoadAnimator = (this.mCurState <= 0 || this.mDestroyed || fragment.mView.getVisibility() != 0 || fragment.mView.getTransitionAlpha() <= 0.0f) ? null : loadAnimator(fragment, i2, false, i3);
                                ...
                                if (animatorLoadAnimator != null) {
                                    ...
                                    animatorLoadAnimator.addListener(new AnimatorListenerAdapter() {
                                        @Override
                                        public void onAnimationEnd(Animator animator) {
                                            viewGroup2.endViewTransition(view);
                                            Animator animatingAway = fragment.getAnimatingAway();
                                            fragment.setAnimatingAway(null);
                                            if (viewGroup2.indexOfChild(view) == -1 && animatingAway != null) {
    ...
    void restoreAllState(Parcelable parcelable, FragmentManagerNonConfig fragmentManagerNonConfig) {
        ...
        for (int i3 = 0; i3 < fragmentManagerState.mActive.length; i3++) {
            ...
            if (fragmentState2 != null) {
                if (childNonConfigs != null && i3 < childNonConfigs.size()) {
                    fragmentManagerNonConfig2 = childNonConfigs.get(i3);
                } else {
                    fragmentManagerNonConfig2 = null;
                }
                Fragment fragmentInstantiate = fragmentState2.instantiate(this.mHost, this.mContainer, this.mParent, fragmentManagerNonConfig2);
                if (DEBUG) {
