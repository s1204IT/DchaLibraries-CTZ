...
public interface ISliceListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISliceListener {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (parcel.readInt() != 0) {
                sliceCreateFromParcel = Slice.CREATOR.createFromParcel(parcel);
            } else {
                sliceCreateFromParcel = null;
            }
            onSliceUpdated(sliceCreateFromParcel);
            return true;
        }
            ...
            public void onSliceUpdated(Slice slice) throws RemoteException {
                ...
                try {
                    ...
                    if (slice != null) {
                        ...
                        slice.writeToParcel(parcelObtain, 0);
                    } else {
