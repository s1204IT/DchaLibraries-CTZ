    ...
    public static abstract class Stub extends Binder implements IKeyAttestationApplicationIdProvider {
        ...
        private static class Proxy implements IKeyAttestationApplicationIdProvider {
            ...
            public KeyAttestationApplicationId getKeyAttestationApplicationId(int i) throws RemoteException {
                KeyAttestationApplicationId keyAttestationApplicationIdCreateFromParcel;
                ...
                try {
                    ...
                    if (parcelObtain2.readInt() != 0) {
                        keyAttestationApplicationIdCreateFromParcel = KeyAttestationApplicationId.CREATOR.createFromParcel(parcelObtain2);
                    } else {
                        keyAttestationApplicationIdCreateFromParcel = null;
                    }
                    return keyAttestationApplicationIdCreateFromParcel;
                } finally {
