...
public abstract class PackageManager {
    ...
    public PackageInfo getPackageArchiveInfo(String str, int i) {
        ...
        int i2 = i;
        try {
            PackageParser.Package monolithicPackage = packageParser.parseMonolithicPackage(file, 0);
            if ((i2 & 64) != 0) {
                PackageParser.collectCertificates(monolithicPackage, false);
            }
            return PackageParser.generatePackageInfo(monolithicPackage, null, i2, 0L, 0L, null, new PackageUserState());
