...
abstract class MapCollections<K, V> {
    ...
    final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public final int hashCode() {
            ...
            if (objColGetEntry != null) {
                iHashCode = objColGetEntry.hashCode();
            } else {
                iHashCode = 0;
            }
            return iHashCode ^ (objColGetEntry2 != null ? objColGetEntry2.hashCode() : 0);
        }
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public int hashCode() {
            ...
            for (int iColGetSize = MapCollections.this.colGetSize() - 1; iColGetSize >= 0; iColGetSize--) {
                ...
                iHashCode2 += iHashCode ^ (objColGetEntry2 == null ? 0 : objColGetEntry2.hashCode());
            }
            return iHashCode2;
        }
    }
