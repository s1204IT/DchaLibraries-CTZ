...
public interface ICompanionDeviceDiscoveryServiceCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICompanionDeviceDiscoveryServiceCallback {
        ...
        public static ICompanionDeviceDiscoveryServiceCallback asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof ICompanionDeviceDiscoveryServiceCallback)) {
                return (ICompanionDeviceDiscoveryServiceCallback) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements ICompanionDeviceDiscoveryServiceCallback {
            ...
            @Override
            public void onDeviceSelected(String str, int i, String str2) throws RemoteException {
