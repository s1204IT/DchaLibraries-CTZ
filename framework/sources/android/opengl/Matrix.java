...
public class Matrix {
    ...
    public static void scaleM(float[] fArr, int i, float[] fArr2, int i2, float f, float f2, float f3) {
        for (int i3 = 0; i3 < 4; i3++) {
            ...
            int i5 = i2 + i3;
            fArr[i4] = fArr2[i5] * f;
            fArr[4 + i4] = fArr2[4 + i5] * f2;
            fArr[8 + i4] = fArr2[8 + i5] * f3;
            fArr[i4 + 12] = fArr2[12 + i5];
        }
    }
    ...
    public static void translateM(float[] fArr, int i, float[] fArr2, int i2, float f, float f2, float f3) {
        ...
        for (int i4 = 0; i4 < 4; i4++) {
            int i5 = i2 + i4;
            fArr[i + i4 + 12] = (fArr2[i5] * f) + (fArr2[4 + i5] * f2) + (fArr2[8 + i5] * f3) + fArr2[i5 + 12];
        }
    }
    ...
    public static void translateM(float[] fArr, int i, float f, float f2, float f3) {
        for (int i2 = 0; i2 < 4; i2++) {
            int i3 = i + i2;
            int i4 = 12 + i3;
            fArr[i4] = fArr[i4] + (fArr[i3] * f) + (fArr[4 + i3] * f2) + (fArr[8 + i3] * f3);
        }
    }
