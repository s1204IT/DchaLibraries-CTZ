...
public class MediaFactory {
    private static final String CLASS_NAME_MEDIA_FACTORY_IMPL = "com.mediatek.media.MediaFactoryImpl";
    ...
    static {
        ...
        try {
            mediaFactory = (MediaFactory) Class.forName(CLASS_NAME_MEDIA_FACTORY_IMPL).newInstance();
