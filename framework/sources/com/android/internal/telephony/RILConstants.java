...
public interface RILConstants {
    ...
    static {
        ...
        if (SystemProperties.get("ro.mtk_protocol1_rat_config").equals("C/Lf")) {
            i = 8;
        } else if (SystemProperties.get("ro.boot.opt_ps1_rat").contains("C")) {
            i = SystemProperties.get("ro.boot.opt_ps1_rat").contains("L") ? 10 : 7;
        } else if (SystemProperties.get("ro.boot.opt_ps1_rat").contains("L")) {
            i = 9;
        } else {
            i = Integer.parseInt(TelephonyManager.getTelephonyProperty(0, "ro.telephony.default_network", Integer.toString(0)));
        }
        PREFERRED_NETWORK_MODE = i;
    }
}
