...
public final class ColorUtils {
    ...
    public static int calculateMinimumBackgroundAlpha(int i, int i2, float f) {
        ...
        return binaryAlphaSearch(i, alphaComponent, f, new ContrastCalculator() {
            @Override
    ...
    public static int calculateMinimumAlpha(int i, int i2, float f) {
        ...
        $$Lambda$ColorUtils$r4F1J7Y711kBAemoOw8QHbDba_8 __lambda_colorutils_r4f1j7y711kbaemoow8qhbdba_8 = new ContrastCalculator() {
            @Override
            public final double calculateContrast(int i3, int i4, int i5) {
                return ColorUtils.calculateContrast(ColorUtils.setAlphaComponent(i3, i5), i4);
            }
        };
        if (__lambda_colorutils_r4f1j7y711kbaemoow8qhbdba_8.calculateContrast(i, i2, 255) < f) {
            return -1;
        }
        return binaryAlphaSearch(setAlphaComponent(i, 255), i2, f, __lambda_colorutils_r4f1j7y711kbaemoow8qhbdba_8);
    }
