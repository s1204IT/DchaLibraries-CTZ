...
public class MimeIconUtils {
    ...
    static {
        ...
        add(ClipDescription.MIMETYPE_TEXT_HTML, R.drawable.ic_doc_codes);
        ...
        add(ContactsContract.Contacts.CONTENT_VCARD_TYPE, R.drawable.ic_doc_contact);
    ...
    public static Drawable loadMimeIcon(Context context, String str) {
        ...
        if (SliceItem.FORMAT_IMAGE.equals(str2)) {
