...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemClickListener {
    ...
    public void animateToVisibility(int i) {
        ...
        if (i == 0) {
            ...
            ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, "alpha", 1.0f);
    ...
    private TabView createTabView(Context context, ActionBar.Tab tab, boolean z) {
    ...
    private class TabAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            if (view == null) {
                return ScrollingTabContainerView.this.createTabView(ScrollingTabContainerView.this.mContext, (ActionBar.Tab) getItem(i), true);
            }
