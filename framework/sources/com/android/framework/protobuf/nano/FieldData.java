...
class FieldData implements Cloneable {
    ...
    public int hashCode() {
        try {
            return MetricsProto.MetricsEvent.DIALOG_SUPPORT_PHONE + Arrays.hashCode(toByteArray());
        } catch (IOException e) {
            throw new IllegalStateException(e);
        }
    }
    ...
    public final FieldData m45clone() {
        ...
        try {
            ...
            if (this.value != null) {
                if (this.value instanceof MessageNano) {
                    fieldData.value = ((MessageNano) this.value).mo43clone();
                    ...
                    if (this.value instanceof byte[][]) {
                        ...
                        while (i < messageNanoArr.length) {
                            messageNanoArr2[i] = messageNanoArr[i].mo43clone();
                            i++;
                        }
                    }
                }
