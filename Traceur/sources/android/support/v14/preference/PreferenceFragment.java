...
public abstract class PreferenceFragment extends Fragment implements DialogPreference.TargetFragment, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, PreferenceManager.OnPreferenceTreeClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ?? FindViewById = view.findViewById(android.R.id.list_container);
        if (!(FindViewById instanceof ViewGroup)) {
            throw new RuntimeException("Content has view with id attribute 'android.R.id.list_container' that is not a ViewGroup class");
        }
        RecyclerView listView = onCreateRecyclerView(themedInflater, FindViewById, savedInstanceState);
        if (listView == null) {
        ...
        FindViewById.addView(this.mList);
    ...
    private class DividerDecoration extends RecyclerView.ItemDecoration {
        ...
        private boolean shouldDrawDividerBelow(View view, RecyclerView parent) {
            ...
            if (index < parent.getChildCount() - 1) {
                ...
                ?? childViewHolder = parent.getChildViewHolder(nextView);
                if ((childViewHolder instanceof PreferenceViewHolder) && childViewHolder.isDividerAllowedAbove()) {
                    z = true;
                }
