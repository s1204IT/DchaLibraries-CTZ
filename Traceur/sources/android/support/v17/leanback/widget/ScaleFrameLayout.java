        ...
        while (i < count) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (gravity2 == 1) {
                    ...
                    childLeft = ((((childLeft2 - width) / 2) + parentLeft) + ((ViewGroup.MarginLayoutParams) lp).leftMargin) - ((ViewGroup.MarginLayoutParams) lp).rightMargin;
                } else if (gravity2 == 5) {
                    childLeft = (parentRight - width) - ((ViewGroup.MarginLayoutParams) lp).rightMargin;
                } else {
                    childLeft = ((ViewGroup.MarginLayoutParams) lp).leftMargin + parentLeft;
                }
                if (verticalGravity == 16) {
                    childTop = (((((parentBottom - parentTop) - height) / 2) + parentTop) + ((ViewGroup.MarginLayoutParams) lp).topMargin) - ((ViewGroup.MarginLayoutParams) lp).bottomMargin;
                } else if (verticalGravity != 48 && verticalGravity == 80) {
                    childTop = (parentBottom - height) - ((ViewGroup.MarginLayoutParams) lp).bottomMargin;
                } else {
                    childTop = ((ViewGroup.MarginLayoutParams) lp).topMargin + parentTop;
                }
