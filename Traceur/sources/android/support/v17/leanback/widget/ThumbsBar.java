...
public class ThumbsBar extends LinearLayout {
    ...
    private void setNumberOfThumbsInternal() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (heroIndex == i) {
                ((ViewGroup.LayoutParams) lp).width = this.mHeroThumbWidthInPixel;
                ((ViewGroup.LayoutParams) lp).height = this.mHeroThumbHeightInPixel;
            } else {
                ((ViewGroup.LayoutParams) lp).width = this.mThumbWidthInPixel;
                ((ViewGroup.LayoutParams) lp).height = this.mThumbHeightInPixel;
            }
