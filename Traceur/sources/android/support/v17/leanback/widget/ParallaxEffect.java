...
public abstract class ParallaxEffect {
    ...
    static final class IntEffect extends ParallaxEffect {
        ...
        Number calculateDirectValue(Parallax source) {
            ...
            Integer num = ((Parallax.IntProperty) this.mMarkerValues.get(0).getProperty()).get(source);
            if (num.intValue() < value1) {
                Number currentValue = Integer.valueOf(value1);
                return currentValue;
            }
            if (num.intValue() > value2) {
                Number currentValue2 = Integer.valueOf(value2);
