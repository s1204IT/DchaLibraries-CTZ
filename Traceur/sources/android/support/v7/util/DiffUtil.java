...
public class DiffUtil {
    ...
    public static class DiffResult {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback updateCallback) {
            ...
            BatchingListUpdateCallback batchingListUpdateCallback2 = batchingListUpdateCallback;
            ...
            while (true) {
                ...
                if (snakeIndex2 >= 0) {
                    ...
                    if (endX < posOld2) {
                        endY = endY2;
                        dispatchRemovals(postponedUpdates, batchingListUpdateCallback2, endX, posOld2 - endX, endX);
                    } else {
                        endY = endY2;
                    }
                    if (endY < posNew2) {
                        snakeSize = snakeSize2;
                        dispatchAdditions(postponedUpdates, batchingListUpdateCallback2, endX, posNew2 - endY, endY);
                    } else {
                        snakeSize = snakeSize2;
                    }
                    int i = snakeSize - 1;
                    while (true) {
                        ...
                        if (i2 >= 0) {
                            if ((this.mOldItemStatuses[snake.x + i2] & 31) == 2) {
                                batchingListUpdateCallback2.onChanged(snake.x + i2, 1, this.mCallback.getChangePayload(snake.x + i2, snake.y + i2));
                            }
                            i = i2 - 1;
                        }
                    }
