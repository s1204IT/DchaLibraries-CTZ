...
public class ButtonBarLayout extends LinearLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (firstVisible >= 0) {
            ...
            minHeight = 0 + getPaddingTop() + firstButton.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) firstParams).topMargin + ((ViewGroup.MarginLayoutParams) firstParams).bottomMargin;
            if (isStacked()) {
