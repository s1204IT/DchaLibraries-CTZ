...
public class ActionBarContainer extends FrameLayout {
    ...
    private int getMeasuredHeightWithMargins(View view) {
        ...
        return view.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) lp).topMargin + ((ViewGroup.MarginLayoutParams) lp).bottomMargin;
    }
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (tabContainer != null && tabContainer.getVisibility() != 8) {
            ...
            tabContainer.layout(l, (containerHeight - tabHeight) - ((ViewGroup.MarginLayoutParams) lp).bottomMargin, r, containerHeight - ((ViewGroup.MarginLayoutParams) lp).bottomMargin);
        }
