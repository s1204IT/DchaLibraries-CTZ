...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public int calculateDyToMakeVisible(View view, int snapPreference) {
        ...
        int top = layoutManager.getDecoratedTop(view) - ((ViewGroup.MarginLayoutParams) params).topMargin;
        int bottom = layoutManager.getDecoratedBottom(view) + ((ViewGroup.MarginLayoutParams) params).bottomMargin;
    ...
    public int calculateDxToMakeVisible(View view, int snapPreference) {
        ...
        RecyclerView.LayoutParams params = (RecyclerView.LayoutParams) view.getLayoutParams();
        int left = layoutManager.getDecoratedLeft(view) - ((ViewGroup.MarginLayoutParams) params).leftMargin;
        int right = layoutManager.getDecoratedRight(view) + ((ViewGroup.MarginLayoutParams) params).rightMargin;
