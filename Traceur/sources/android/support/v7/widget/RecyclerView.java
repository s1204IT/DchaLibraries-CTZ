...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2 {
    ...
    private void requestChildOnScreen(View child, View focused) {
        ...
        ?? layoutParams = rectView.getLayoutParams();
        if ((layoutParams instanceof LayoutParams) && !layoutParams.mInsetsDirty) {
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof LayoutParams) && this.mLayout.checkLayoutParams(layoutParams);
    }
        ...
        private void invalidateDisplayListInt(ViewGroup viewGroup, boolean invalidateThis) {
            for (int i = viewGroup.getChildCount() - 1; i >= 0; i--) {
                ...
                if (childAt instanceof ViewGroup) {
                    invalidateDisplayListInt(childAt, true);
                }
            }
            if (!invalidateThis) {
                return;
    ...
    public static abstract class LayoutManager {
        ...
        private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback = new ViewBoundsCheck.Callback() {
            ...
            public int getChildStart(View view) {
                ...
                return LayoutManager.this.getDecoratedLeft(view) - ((ViewGroup.MarginLayoutParams) params).leftMargin;
            }

            @Override
            public int getChildEnd(View view) {
                LayoutParams params = (LayoutParams) view.getLayoutParams();
                return LayoutManager.this.getDecoratedRight(view) + ((ViewGroup.MarginLayoutParams) params).rightMargin;
            }
        };
        private final ViewBoundsCheck.Callback mVerticalBoundCheckCallback = new ViewBoundsCheck.Callback() {
            ...
            public int getChildStart(View view) {
                LayoutParams params = (LayoutParams) view.getLayoutParams();
                return LayoutManager.this.getDecoratedTop(view) - ((ViewGroup.MarginLayoutParams) params).topMargin;
            }

            @Override
            public int getChildEnd(View view) {
                LayoutParams params = (LayoutParams) view.getLayoutParams();
                return LayoutManager.this.getDecoratedBottom(view) + ((ViewGroup.MarginLayoutParams) params).bottomMargin;
            }
        };
        ...
        boolean shouldReMeasureChild(View child, int widthSpec, int heightSpec, LayoutParams lp) {
            return (this.mMeasurementCacheEnabled && isMeasurementUpToDate(child.getMeasuredWidth(), widthSpec, ((ViewGroup.LayoutParams) lp).width) && isMeasurementUpToDate(child.getMeasuredHeight(), heightSpec, ((ViewGroup.LayoutParams) lp).height)) ? false : true;
        }

        boolean shouldMeasureChild(View child, int widthSpec, int heightSpec, LayoutParams lp) {
            return (!child.isLayoutRequested() && this.mMeasurementCacheEnabled && isMeasurementUpToDate(child.getWidth(), widthSpec, ((ViewGroup.LayoutParams) lp).width) && isMeasurementUpToDate(child.getHeight(), heightSpec, ((ViewGroup.LayoutParams) lp).height)) ? false : true;
        }
        ...
        public void measureChildWithMargins(View child, int widthUsed, int heightUsed) {
            ...
            int widthSpec = getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight() + ((ViewGroup.MarginLayoutParams) lp).leftMargin + ((ViewGroup.MarginLayoutParams) lp).rightMargin + widthUsed2, ((ViewGroup.LayoutParams) lp).width, canScrollHorizontally());
            int heightSpec = getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom() + ((ViewGroup.MarginLayoutParams) lp).topMargin + ((ViewGroup.MarginLayoutParams) lp).bottomMargin + heightUsed2, ((ViewGroup.LayoutParams) lp).height, canScrollVertically());
    ...
    static class AdapterDataObservable extends Observable<AdapterDataObserver> {
        ...
        public void notifyChanged() {
            for (int i = ((Observable) this).mObservers.size() - 1; i >= 0; i--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(i)).onChanged();
            }
        }

        public void notifyItemRangeChanged(int positionStart, int itemCount, Object payload) {
            for (int i = ((Observable) this).mObservers.size() - 1; i >= 0; i--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(i)).onItemRangeChanged(positionStart, itemCount, payload);
            }
        }

        public void notifyItemRangeInserted(int positionStart, int itemCount) {
            for (int i = ((Observable) this).mObservers.size() - 1; i >= 0; i--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(i)).onItemRangeInserted(positionStart, itemCount);
            }
        }

        public void notifyItemRangeRemoved(int positionStart, int itemCount) {
            for (int i = ((Observable) this).mObservers.size() - 1; i >= 0; i--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(i)).onItemRangeRemoved(positionStart, itemCount);
            }
        }

        public void notifyItemMoved(int fromPosition, int toPosition) {
            for (int i = ((Observable) this).mObservers.size() - 1; i >= 0; i--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(i)).onItemRangeMoved(fromPosition, toPosition, 1);
            }
        }
    }
