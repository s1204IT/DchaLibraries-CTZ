...
public class InputMethodPreference extends RestrictedSwitchPreference implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        } else if (((ComponentInfo) this.mImi.getServiceInfo()).directBootAware || isTv()) {
    ...
    private void showSecurityWarnDialog() {
        ...
        builder.setMessage(context.getString(R.string.ime_security_warning, ((ComponentInfo) this.mImi.getServiceInfo()).applicationInfo.loadLabel(context.getPackageManager())));
    ...
    public static void lambda$showSecurityWarnDialog$0(InputMethodPreference inputMethodPreference, DialogInterface dialogInterface, int i) {
        if (((ComponentInfo) inputMethodPreference.mImi.getServiceInfo()).directBootAware || inputMethodPreference.isTv()) {
