...
public class ApplicationsState {
    ...
    public static final Comparator<AppEntry> ALPHA_COMPARATOR = new Comparator<AppEntry>() {
        ...
        public int compare(AppEntry appEntry, AppEntry appEntry2) {
            ...
            if (appEntry.info != null && appEntry2.info != null && (iCompare = this.sCollator.compare(((PackageItemInfo) appEntry.info).packageName, ((PackageItemInfo) appEntry2.info).packageName)) != 0) {
                return iCompare;
            }
    ...
    public static final AppFilter FILTER_NOT_HIDE = new AppFilter() {
        ...
        @Override
        public boolean filterApp(AppEntry appEntry) {
            if (ArrayUtils.contains(this.mHidePackageNames, ((PackageItemInfo) appEntry.info).packageName)) {
        ...
        while (i < this.mApplications.size()) {
            ...
            if (!applicationInfo.enabled) {
                if (applicationInfo.enabledSetting != 3) {
                    ...
                    appEntry = this.mEntriesMap.get(UserHandle.getUserId(applicationInfo.uid)).get(((PackageItemInfo) applicationInfo).packageName);
                    if (appEntry == null) {
                    }
                }
            } else {
    ...
    int indexOfApplicationInfoLocked(String str, int i) {
        for (int size = this.mApplications.size() - 1; size >= 0; size--) {
            ...
            if (((PackageItemInfo) applicationInfo).packageName.equals(str) && UserHandle.getUserId(applicationInfo.uid) == i) {
                return size;
            }
        }
        return -1;
    ...
    private AppEntry getEntryLocked(ApplicationInfo applicationInfo) {
        ...
        AppEntry appEntry = this.mEntriesMap.get(userId).get(((PackageItemInfo) applicationInfo).packageName);
        if (appEntry == null) {
            Context context = this.mContext;
            long j = this.mCurId;
            this.mCurId = 1 + j;
            AppEntry appEntry2 = new AppEntry(context, applicationInfo, j);
            this.mEntriesMap.get(userId).put(((PackageItemInfo) applicationInfo).packageName, appEntry2);
                ...
                case 2:
                    synchronized (this.this$0.mEntriesMap) {
                        ...
                        for (int i5 = 0; i5 < this.this$0.mApplications.size() && i < 6; i5++) {
                            ...
                            int userId = UserHandle.getUserId(applicationInfo.uid);
                            if (this.this$0.mEntriesMap.get(userId).get(((PackageItemInfo) applicationInfo).packageName) == null) {
                                i++;
                                this.this$0.getEntryLocked(applicationInfo);
                            }
                            if (userId != 0) {
                                if (this.this$0.mEntriesMap.indexOfKey(0) >= 0) {
                                    AppEntry appEntry = this.this$0.mEntriesMap.get(0).get(((PackageItemInfo) applicationInfo).packageName);
                                    if (appEntry != null && !ApplicationsState.hasFlag(appEntry.info.flags, 8388608)) {
                                        this.this$0.mEntriesMap.get(0).remove(((PackageItemInfo) applicationInfo).packageName);
                    ...
                    if (ApplicationsState.hasFlag(combinedSessionFlags, 1)) {
                        ...
                        synchronized (this.this$0.mEntriesMap) {
                            ...
                            for (int i6 = 0; i6 < size; i6++) {
                                ...
                                while (it.hasNext()) {
                                    AppEntry appEntry2 = mapValueAt.get(((PackageItemInfo) ((ResolveInfo) it.next()).activityInfo).packageName);
                                    if (appEntry2 != null) {
                            ...
                            synchronized (this.this$0.mEntriesMap) {
                                ...
                                while (i8 < size2) {
                                    ...
                                    if (appEntry3 != null) {
                                        ...
                                        appEntry3.launcherEntryEnabled = ((ComponentInfo) resolveInfo.activityInfo).enabled | appEntry3.launcherEntryEnabled;
                                    } else {
                            ...
                            for (int i9 = 0; i9 < this.this$0.mAppEntries.size(); i9++) {
                                ...
                                if (ApplicationsState.hasFlag(appEntry5.info.flags, 8388608) && (appEntry5.size == -1 || appEntry5.sizeStale)) {
                                    if (appEntry5.sizeLoadStart == 0 || appEntry5.sizeLoadStart < jUptimeMillis - 20000) {
                                        ...
                                        this.this$0.mCurComputingSizePkg = ((PackageItemInfo) appEntry5.info).packageName;
        ...
        public void ensureLabel(Context context) {
            if (this.label == null || !this.mounted) {
                if (!this.apkFile.exists()) {
                    ...
                    this.label = charSequenceLoadLabel != null ? charSequenceLoadLabel.toString() : ((PackageItemInfo) this.info).packageName;
                }
            }
        }
