...
final class CollapsingTextHelper {
    ...
    private void calculateBaseOffsets() {
        ...
        int i = absoluteGravity & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay;
        if (i == 48) {
        ...
        int i3 = absoluteGravity2 & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay;
        if (i3 == 48) {
