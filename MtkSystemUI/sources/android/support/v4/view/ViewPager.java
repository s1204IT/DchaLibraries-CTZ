    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (childWidthSize3 < size) {
            ...
            if (child.getVisibility() == 8 || (lp2 = (LayoutParams) child.getLayoutParams()) == null || !lp2.isDecor) {
                ...
                int vgrav = lp2.gravity & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay;
        ...
        for (int paddingLeft3 = 0; paddingLeft3 < count2; paddingLeft3++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay;
                    if (hgrav == 1) {
