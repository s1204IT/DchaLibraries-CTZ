...
public abstract class SharedElementCallback {
    ...
    public Parcelable onCaptureSharedElementSnapshot(View view, Matrix viewToGlobalMatrix, RectF screenBounds) {
        Bitmap bitmap;
        if (view instanceof ImageView) {
            ...
            if (d != null && bg == null && (bitmap = createDrawableBitmap(d)) != null) {
                ...
                bundle.putString(BUNDLE_SNAPSHOT_IMAGE_SCALETYPE, view.getScaleType().toString());
    ...
    public View onCreateSnapshotView(Context context, Parcelable parcelable) {
        ...
        Bitmap bitmap = (Bitmap) parcelable.getParcelable(BUNDLE_SNAPSHOT_BITMAP);
        if (bitmap == null) {
            return null;
        }
        ImageView imageView = new ImageView(context);
        imageView.setImageBitmap(bitmap);
        imageView.setScaleType(ImageView.ScaleType.valueOf(parcelable.getString(BUNDLE_SNAPSHOT_IMAGE_SCALETYPE)));
        if (imageView.getScaleType() == ImageView.ScaleType.MATRIX) {
            float[] values = parcelable.getFloatArray(BUNDLE_SNAPSHOT_IMAGE_MATRIX);
