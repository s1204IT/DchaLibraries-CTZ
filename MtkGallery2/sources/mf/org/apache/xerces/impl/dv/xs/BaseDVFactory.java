...
public class BaseDVFactory extends SchemaDVFactory {
    ...
    static void createBuiltInTypes(SymbolHash types) {
        ...
        types.put(SchemaSymbols.ATTVAL_BOOLEAN, new XSSimpleTypeDecl(anySimpleType, SchemaSymbols.ATTVAL_BOOLEAN, (short) 2, (short) 0, false, true, false, true, (short) 3));
        ...
        types.put(SchemaSymbols.ATTVAL_DATE, new XSSimpleTypeDecl(anySimpleType, SchemaSymbols.ATTVAL_DATE, (short) 9, (short) 1, false, false, false, true, (short) 10));
