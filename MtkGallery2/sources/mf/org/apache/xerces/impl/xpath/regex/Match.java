...
public class Match implements Cloneable {
    ...
    public String getCapturedText(int index) {
        ...
        if (this.ciSource != null) {
            String ret = REUtil.substring(this.ciSource, begin, end);
            return ret;
        }
        String ret2 = this.strSource;
        if (ret2 != null) {
            String ret3 = this.strSource.substring(begin, end);
            return ret3;
        }
        String ret4 = new String(this.charSource, begin, end - begin);
        return ret4;
    }
}
