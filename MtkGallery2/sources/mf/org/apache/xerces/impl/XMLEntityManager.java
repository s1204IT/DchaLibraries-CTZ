...
public class XMLEntityManager implements XMLComponent, XMLEntityResolver {
        ...
        if (reader4 != null) {
            ...
            if (stream2 == null) {
                ...
                if (!(OpenConnection instanceof HttpURLConnection)) {
                    stream2 = OpenConnection.getInputStream();
                } else {
                    ...
                    if (xMLInputSource instanceof HTTPInputSource) {
                        ...
                        followRedirects = xMLInputSource.getFollowHTTPRedirects();
                        if (!followRedirects) {
                    ...
                    stream2 = OpenConnection.getInputStream();
                    if (followRedirects) {
                        redirect = OpenConnection.getURL().toString();
    ...
    public static OutputStream createOutputStream(String uri) throws IOException {
        ...
        OutputStream out2 = OpenConnection.getOutputStream();
        return out2;
    }
