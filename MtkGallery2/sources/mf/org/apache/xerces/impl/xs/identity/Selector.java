...
public class Selector {
    ...
    public static class XPath extends mf.org.apache.xerces.impl.xpath.XPath {
        ...
        private static String normalize(String xpath) {
            ...
            String xpath2 = xpath;
            while (true) {
                if (!XMLChar.trim(xpath2).startsWith("/") && !XMLChar.trim(xpath2).startsWith(".")) {
                    modifiedXPath.append("./");
                }
                int unionIndex = xpath2.indexOf(124);
                if (unionIndex == -1) {
                    modifiedXPath.append(xpath2);
                    return modifiedXPath.toString();
                }
                modifiedXPath.append(xpath2.substring(0, unionIndex + 1));
                xpath2 = xpath2.substring(unionIndex + 1, xpath2.length());
            }
        }
    }
