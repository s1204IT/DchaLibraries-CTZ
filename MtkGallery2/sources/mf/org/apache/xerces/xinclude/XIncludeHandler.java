...
public class XIncludeHandler implements XMLComponent, XMLDTDFilter, XMLDocumentFilter {
    ...
    protected static class Notation {
        ...
        public boolean equals(Object obj) {
            if (obj == 0 || !(obj instanceof Notation)) {
                return false;
            }
        ...
        public boolean isDuplicate(Object obj) {
            if (obj == 0 || !(obj instanceof Notation) || !this.name.equals(obj.name) || !isEqual(this.publicId, obj.publicId) || !isEqual(this.expandedSystemId, obj.expandedSystemId)) {
                return false;
            }
            return true;
        }
    ...
    protected static class UnparsedEntity {
        ...
        public boolean equals(Object obj) {
            if (obj == 0 || !(obj instanceof UnparsedEntity)) {
                return false;
            }
            return this.name.equals(obj.name);
        }
        ...
        public boolean isDuplicate(Object obj) {
            if (obj == 0 || !(obj instanceof UnparsedEntity) || !this.name.equals(obj.name) || !isEqual(this.publicId, obj.publicId) || !isEqual(this.expandedSystemId, obj.expandedSystemId) || !isEqual(this.notation, obj.notation)) {
                return false;
            }
            return true;
        }
