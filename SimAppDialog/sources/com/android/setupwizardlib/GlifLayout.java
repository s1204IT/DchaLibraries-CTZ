...
public class GlifLayout extends TemplateLayout {
    ...
    public ScrollView getScrollView() {
        ?? FindManagedViewById = findManagedViewById(R.id.suw_scroll_view);
        if (FindManagedViewById instanceof ScrollView) {
            return FindManagedViewById;
        }
        return null;
    }
    ...
    private void updateBackground() {
        ...
        ?? FindManagedViewById = findManagedViewById(R.id.suw_pattern_bg);
        if (FindManagedViewById != 0) {
            int defaultColor = 0;
            ...
            if (!(FindManagedViewById instanceof StatusBarBackgroundLayout)) {
                ...
                FindManagedViewById.setStatusBarBackground(colorDrawable);
            }
        }
    }
}
