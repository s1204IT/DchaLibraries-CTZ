...
public class FlexboxLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider, FlexContainer {
        ...
        while (true) {
            ...
            if (i3 < startPosition + itemCount2) {
                ...
                if (view2 == null) {
                    ...
                    float childLeft5 = childLeft4 + ((ViewGroup.MarginLayoutParams) lp).leftMargin + getLeftDecorationWidth(view2);
                    float childRight4 = childRight3 - (((ViewGroup.MarginLayoutParams) lp).rightMargin + getRightDecorationWidth(view2));
                    ...
                    childLeft4 = childLeft2 + view.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) lp).rightMargin + getRightDecorationWidth(view) + spaceBetweenItem2;
                    childRight3 = childRight2 - (((view.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) lp).leftMargin) + getLeftDecorationWidth(view)) + spaceBetweenItem2);
        ...
        while (true) {
            ...
            if (i2 < startPosition + itemCount2) {
                ...
                if (view2 == null) {
                    ...
                    float childTop5 = childTop4 + ((ViewGroup.MarginLayoutParams) lp).topMargin + getTopDecorationHeight(view2);
                    float childBottom4 = childBottom3 - (((ViewGroup.MarginLayoutParams) lp).rightMargin + getBottomDecorationHeight(view2));
                    if (layoutState.mLayoutDirection == 1) {
                        calculateItemDecorationsForChild(view2, TEMP_RECT);
                        addView(view2);
                    } else {
                    ...
                    childBottom3 = childBottom2 - (((view.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) lp).bottomMargin) + getTopDecorationHeight(view)) + spaceBetweenItem2);
                    childTop4 = childTop2 + view.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) lp).topMargin + getBottomDecorationHeight(view) + spaceBetweenItem2;
                    indexInFlexLine = indexInFlexLine2;
                }
                i2 = i + 1;
                itemCount = itemCount2;
    ...
    private boolean shouldMeasureChild(View child, int widthSpec, int heightSpec, RecyclerView.LayoutParams lp) {
        return (!child.isLayoutRequested() && isMeasurementCacheEnabled() && isMeasurementUpToDate(child.getWidth(), widthSpec, ((ViewGroup.LayoutParams) lp).width) && isMeasurementUpToDate(child.getHeight(), heightSpec, ((ViewGroup.LayoutParams) lp).height)) ? false : true;
    }
    ...
    private int getChildLeft(View view) {
        ...
        return getDecoratedLeft(view) - ((ViewGroup.MarginLayoutParams) params).leftMargin;
    }

    private int getChildRight(View view) {
        RecyclerView.LayoutParams params = (RecyclerView.LayoutParams) view.getLayoutParams();
        return getDecoratedRight(view) + ((ViewGroup.MarginLayoutParams) params).rightMargin;
    }

    private int getChildTop(View view) {
        RecyclerView.LayoutParams params = (RecyclerView.LayoutParams) view.getLayoutParams();
        return getDecoratedTop(view) - ((ViewGroup.MarginLayoutParams) params).topMargin;
    }

    private int getChildBottom(View view) {
        RecyclerView.LayoutParams params = (RecyclerView.LayoutParams) view.getLayoutParams();
        return getDecoratedBottom(view) + ((ViewGroup.MarginLayoutParams) params).bottomMargin;
    }
