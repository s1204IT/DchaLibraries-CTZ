...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    private void setViewLayoutParams(View view, int topMargin, int gravity) {
        ...
        ((ViewGroup.MarginLayoutParams) viewParams).topMargin = topMargin;
    ...
    public void setIconSize(int iconSize) {
        ...
        ((ViewGroup.LayoutParams) iconParams).width = iconSize;
        ((ViewGroup.LayoutParams) iconParams).height = iconSize;
