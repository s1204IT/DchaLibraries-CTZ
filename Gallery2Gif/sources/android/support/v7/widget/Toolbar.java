...
public class Toolbar extends ViewGroup {
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (parcelable.expandedMenuItemId != 0 && this.mExpandedMenuPresenter != null && menu != null && (item = menu.findItem(parcelable.expandedMenuItemId)) != null) {
            item.expandActionView();
        }
        if (parcelable.isOverflowOpen) {
    ...
    private void measureChildConstrained(View child, int parentWidthSpec, int widthUsed, int parentHeightSpec, int heightUsed, int heightConstraint) {
        ...
        int childWidthSpec = getChildMeasureSpec(parentWidthSpec, getPaddingLeft() + getPaddingRight() + lp.leftMargin + lp.rightMargin + widthUsed, ((ViewGroup.LayoutParams) lp).width);
        int childHeightSpec = getChildMeasureSpec(parentHeightSpec, getPaddingTop() + getPaddingBottom() + lp.topMargin + lp.bottomMargin + heightUsed, ((ViewGroup.LayoutParams) lp).height);
    ...
    private int measureChildCollapseMargins(View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed, int[] collapsingMargins) {
        ...
        int childWidthMeasureSpec = getChildMeasureSpec(parentWidthMeasureSpec, getPaddingLeft() + getPaddingRight() + hMargins + widthUsed, ((ViewGroup.LayoutParams) lp).width);
        int childHeightMeasureSpec = getChildMeasureSpec(parentHeightMeasureSpec, getPaddingTop() + getPaddingBottom() + lp.topMargin + lp.bottomMargin + heightUsed, ((ViewGroup.LayoutParams) lp).height);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (layoutTitle) {
            ...
            titleHeight = 0 + ((ViewGroup.MarginLayoutParams) lp).topMargin + this.mTitleTextView.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) lp).bottomMargin;
        } else {
            paddingRight = paddingRight2;
        }
        if (layoutSubtitle) {
            LayoutParams lp2 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
            titleHeight += ((ViewGroup.MarginLayoutParams) lp2).topMargin + this.mSubtitleTextView.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) lp2).bottomMargin;
        }
        if (layoutTitle || layoutSubtitle) {
            ...
            if (layoutTitle) {
                ...
                if (bottomChild2.getMeasuredWidth() > 0) {
                    titleHasWidth = true;
                    width = width3;
                    ...
                    if (width2 != 48) {
                        ...
                        left = left3;
                        spaceBelow = getPaddingTop() + ((ViewGroup.MarginLayoutParams) toplp).topMargin + this.mTitleMarginTop;
                    } else if (width2 != 80) {
                        int space = (height - paddingTop) - paddingBottom;
                        int spaceAbove = (space - titleHeight) / 2;
                        int space2 = ((ViewGroup.MarginLayoutParams) toplp).topMargin;
                        alignmentHeight = alignmentHeight2;
                        if (spaceAbove < space2 + this.mTitleMarginTop) {
                            spaceAbove = ((ViewGroup.MarginLayoutParams) toplp).topMargin + this.mTitleMarginTop;
                            left = left3;
                        } else {
                            int spaceBelow2 = (((height - paddingBottom) - titleHeight) - spaceAbove) - paddingTop;
                            left = left3;
                            if (spaceBelow2 < ((ViewGroup.MarginLayoutParams) toplp).bottomMargin + this.mTitleMarginBottom) {
                                spaceAbove = Math.max(0, spaceAbove - ((((ViewGroup.MarginLayoutParams) bottomlp).bottomMargin + this.mTitleMarginBottom) - spaceBelow2));
                            }
                        }
                        ...
                        alignmentHeight = alignmentHeight2;
                        left = left3;
                        spaceBelow = (((height - paddingBottom) - ((ViewGroup.MarginLayoutParams) bottomlp).bottomMargin) - this.mTitleMarginBottom) - titleHeight;
                    }
                    if (!isRtl) {
                        ...
                        if (layoutTitle) {
                            ...
                            spaceBelow = titleBottom + ((ViewGroup.MarginLayoutParams) lp3).bottomMargin;
                        }
                        if (layoutSubtitle) {
                            LayoutParams lp4 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                            int titleTop = spaceBelow + ((ViewGroup.MarginLayoutParams) lp4).topMargin;
                            ...
                            int titleTop2 = subtitleBottom + ((ViewGroup.MarginLayoutParams) lp4).bottomMargin;
                        }
                        if (titleHasWidth) {
                        ...
                        if (layoutTitle) {
                            ...
                            spaceBelow = titleBottom2 + ((ViewGroup.MarginLayoutParams) lp5).bottomMargin;
                        }
                        if (layoutSubtitle) {
                            LayoutParams lp6 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                            int titleTop3 = spaceBelow + ((ViewGroup.MarginLayoutParams) lp6).topMargin;
                            ...
                            int titleTop4 = subtitleBottom2 + ((ViewGroup.MarginLayoutParams) lp6).bottomMargin;
                        }
                        if (titleHasWidth) {
    ...
    private int getViewListMeasuredWidth(List<View> views, int[] collapsingMargins) {
        ...
        for (int collapseLeft3 = 0; collapseLeft3 < count; collapseLeft3++) {
            ...
            int l = ((ViewGroup.MarginLayoutParams) lp).leftMargin - collapseLeft2;
            int r = ((ViewGroup.MarginLayoutParams) lp).rightMargin - collapseRight2;
    ...
    private int getChildTop(View child, int alignmentHeight) {
        ...
        if (spaceAbove < ((ViewGroup.MarginLayoutParams) lp).topMargin) {
            ...
            if (spaceBelow < ((ViewGroup.MarginLayoutParams) lp).bottomMargin) {
                spaceAbove = Math.max(0, spaceAbove - (((ViewGroup.MarginLayoutParams) lp).bottomMargin - spaceBelow));
            }
        }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            ?? parent = Toolbar.this.mCollapseButtonView.getParent();
            if (parent != Toolbar.this) {
                if (parent instanceof ViewGroup) {
                    parent.removeView(Toolbar.this.mCollapseButtonView);
                }
                Toolbar.this.addView(Toolbar.this.mCollapseButtonView);
            }
            Toolbar.this.mExpandedActionView = item.getActionView();
            this.mCurrentExpandedItem = item;
            ?? parent2 = Toolbar.this.mExpandedActionView.getParent();
            if (parent2 != Toolbar.this) {
                if (parent2 instanceof ViewGroup) {
                    parent2.removeView(Toolbar.this.mExpandedActionView);
                }
