...
public abstract class Nat {
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i5;
            long j2 = j + (((long) iArr[i2 + i5]) & M) + (((long) iArr2[i3 + i5]) & M) + (((long) iArr3[i6]) & M);
            iArr3[i6] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            int i3 = i2 + i;
            long jMulWordAddTo = (((long) mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2)) & M) + j + (M & ((long) iArr3[i3]));
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            int i7 = i5 + i;
            long jMulWordAddTo = (((long) mulWordAddTo(i, iArr[i2 + i6], iArr2, i3, iArr3, i5)) & M) + j + (M & ((long) iArr3[i7]));
    ...
    public static int mul31BothAdd(int i, int i2, int[] iArr, int i3, int[] iArr2, int[] iArr3, int i4) {
        ...
        while (true) {
            int i6 = i4 + i5;
            long j4 = j;
            long j5 = j3 + ((((long) iArr[i5]) & M) * j) + ((((long) iArr2[i5]) & M) * j2) + (((long) iArr3[i6]) & M);
            iArr3[i6] = (int) j5;
            j3 = j5 >>> 32;
            i5++;
            if (i5 < i) {
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i5;
            long j2 = j + (((((long) iArr3[i6]) & M) - (((long) iArr[i2 + i5]) & M)) - (((long) iArr2[i3 + i5]) & M));
            iArr3[i6] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
