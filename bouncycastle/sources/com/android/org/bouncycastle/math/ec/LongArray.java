...
class LongArray implements Cloneable {
    ...
    private static void multiplyWord(long j, long[] jArr, int i, long[] jArr2, int i2) {
        ...
        while (true) {
            ...
            if (j3 != 0) {
                if ((j3 & 1) != 0) {
                    long jAddShiftedUp = addShiftedUp(jArr2, i2, jArr3, 0, i, i3);
                    if (jAddShiftedUp != 0) {
                        int i4 = i2 + i;
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        int i2 = (iDegree + 63) >>> 6;
        int i3 = (iDegree2 + 63) >>> 6;
        int i4 = ((iDegree + iDegree2) + 62) >>> 6;
        int i5 = 1;
        if (i2 == 1) {
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        int i4 = (iDegree + 63) >>> 6;
        int i5 = (iDegree2 + 63) >>> 6;
        int i6 = ((iDegree + iDegree2) + 62) >>> 6;
        if (i4 == 1) {
            long j = longArray2.m_ints[0];
            if (j == 1) {
                return longArray3;
        ...
        iArr2[1] = i10;
        int i11 = i10;
        for (int i12 = 2; i12 < iArr2.length; i12++) {
            i11 += i6;
            iArr2[i12] = i11;
        }
        ...
        while (true) {
            length--;
            if (length <= i2) {
                return reduceResult(jArr2, iArr2[i2], i6, i, iArr);
            }
            if ((((long) length) & 1) == 0) {
                i3 = i2;
                ...
                i3 = i2;
                distribute(jArr2, iArr2[length], iArr2[length - 1], iArr2[i3], i6);
            }
            i2 = i3;
        }
    }
    ...
    public void reduce(int i, int[] iArr) {
        ...
        if (iReduceInPlace < jArr.length) {
            this.m_ints = new long[iReduceInPlace];
            System.arraycopy(jArr, 0, this.m_ints, 0, iReduceInPlace);
        }
    }
    ...
    private static long interleave3_21to63(int i) {
        ...
        return ((((long) INTERLEAVE3_TABLE[i >>> 14]) & 4294967295L) << 42) | ((((long) INTERLEAVE3_TABLE[(i >>> 7) & 127]) & 4294967295L) << 21) | (((long) i2) & 4294967295L);
    }
    ...
    private static long interleave3_13to65(int i) {
        return ((((long) INTERLEAVE5_TABLE[i >>> 7]) & 4294967295L) << 35) | (4294967295L & ((long) INTERLEAVE5_TABLE[i & 127]));
    }
    ...
    private static long interleave4_16to64(int i) {
        return ((((long) INTERLEAVE4_TABLE[i >>> 8]) & 4294967295L) << 32) | (4294967295L & ((long) INTERLEAVE4_TABLE[i & 255]));
    }

    private static long interleave2_32to64(int i) {
        int i2 = INTERLEAVE2_TABLE[i & 255] | (INTERLEAVE2_TABLE[(i >>> 8) & 255] << 16);
        return ((((long) ((INTERLEAVE2_TABLE[i >>> 24] << 16) | INTERLEAVE2_TABLE[(i >>> 16) & 255])) & 4294967295L) << 32) | (4294967295L & ((long) i2));
    }
    ...
    public LongArray modInverse(int i, int[] iArr) {
        ...
        while (true) {
            if (i5 < 0) {
                i5 = -i5;
                iArr2[i7] = i6;
                iArr3[i7] = iDegreeFrom;
                i7 = 1 - i7;
                i6 = iArr2[i7];
                iDegreeFrom = iArr3[i7];
            }
            int i8 = 1 - i7;
            longArrayArr[i7].addShiftedByBitsSafe(longArrayArr[i8], iArr2[i8], i5);
            int iDegreeFrom2 = longArrayArr[i7].degreeFrom(i6);
            if (iDegreeFrom2 == 0) {
                return longArrayArr2[i8];
            }
            int i9 = iArr3[i8];
            longArrayArr2[i7].addShiftedByBitsSafe(longArrayArr2[i8], i9, i5);
            int i10 = i9 + i5;
            if (i10 <= iDegreeFrom) {
                if (i10 == iDegreeFrom) {
                    iDegreeFrom = longArrayArr2[i7].degreeFrom(iDegreeFrom);
                }
            } else {
                iDegreeFrom = i10;
            }
