...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    protected void processBlock() {
        ...
        while (i2 < 10) {
            long j14 = jSum0;
            int i4 = i3 + 1;
            long jSum1 = j13 + Sum1(j12) + Ch(j12, j11, j10) + K[i3] + this.W[i3];
            long j15 = j9 + jSum1;
            long jSum02 = jSum1 + Sum0(j14) + Maj(j14, j7, j8);
            int i5 = i4 + 1;
            long jSum12 = j10 + Sum1(j15) + Ch(j15, j12, j11) + K[i4] + this.W[i4];
            long j16 = j8 + jSum12;
            long jSum03 = jSum12 + Sum0(jSum02) + Maj(jSum02, j14, j7);
            int i6 = i5 + 1;
            long jSum13 = j11 + Sum1(j16) + Ch(j16, j15, j12) + K[i5] + this.W[i5];
            long j17 = j7 + jSum13;
            long jSum04 = jSum13 + Sum0(jSum03) + Maj(jSum03, jSum02, j14);
            int i7 = i6 + 1;
            long jSum14 = j12 + Sum1(j17) + Ch(j17, j16, j15) + K[i6] + this.W[i6];
            long j18 = j14 + jSum14;
            long jSum05 = jSum14 + Sum0(jSum04) + Maj(jSum04, jSum03, jSum02);
            int i8 = i7 + 1;
            long jSum15 = j15 + Sum1(j18) + Ch(j18, j17, j16) + K[i7] + this.W[i7];
            long j19 = jSum02 + jSum15;
            long jSum06 = jSum15 + Sum0(jSum05) + Maj(jSum05, jSum04, jSum03);
            int i9 = i8 + 1;
            long jSum16 = j16 + Sum1(j19) + Ch(j19, j18, j17) + K[i8] + this.W[i8];
            long j20 = jSum03 + jSum16;
            long jSum07 = jSum16 + Sum0(jSum06) + Maj(jSum06, jSum05, jSum04);
            int i10 = i9 + 1;
            long jSum17 = j17 + Sum1(j20) + Ch(j20, j19, j18) + K[i9] + this.W[i9];
            long j21 = jSum04 + jSum17;
            long jSum08 = jSum17 + Sum0(jSum07) + Maj(jSum07, jSum06, jSum05);
            long jSum18 = j18 + Sum1(j21) + Ch(j21, j20, j19) + K[i10] + this.W[i10];
            long j22 = jSum05 + jSum18;
