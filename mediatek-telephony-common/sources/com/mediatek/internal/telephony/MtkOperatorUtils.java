...
import com.mediatek.internal.telephony.test.SimulatedCommands;
...
public class MtkOperatorUtils {
    ...
    private static final Map<OPID, List> mOPMap = new HashMap<OPID, List>() {
        {
            ...
            put(OPID.OP08, Arrays.asList("310160", SimulatedCommands.FAKE_MCC_MNC, "310490", "310580", "310660"));
    ...
    public static boolean isOperator(String str, OPID opid) {
        ...
        sb.append(str);
        sb.append(z ? " = " : " != ");
        sb.append(idToString(opid));
        Rlog.d(TAG, sb.toString());
        return z;
    }

    private static String idToString(OPID opid) {
        if (opid == OPID.OP01) {
