...
public class MtkSuppSrvRequest {
    ...
    public static MtkSuppSrvRequest obtain(int i, Message message) {
        MtkSuppSrvRequest mtkSuppSrvRequest = new MtkSuppSrvRequest();
        mtkSuppSrvRequest.mRequestCode = i;
        mtkSuppSrvRequest.mResultCallback = message;
        mtkSuppSrvRequest.mParcel = Parcel.obtain();
        return mtkSuppSrvRequest;
    }
    ...
    public void setResultCallback(Message message) {
        this.mResultCallback = message;
    }
