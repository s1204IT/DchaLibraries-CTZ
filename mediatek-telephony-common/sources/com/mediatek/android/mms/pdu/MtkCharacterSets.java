...
public class MtkCharacterSets extends CharacterSets {
    ...
    private static final int[] MIBENUM_NUMBERS_EXTENDS = {BIG5_HKSCS, BOCU_1, CESU_8, CP864, 18, 38, 114, 113, HZ_GB_2312, GB_2312, ISO_2022_CN, ISO_2022_CN_EXT, 39, 37, 13, 109, 110, 111, 112, KOI8_R, KOI8_U, MACINTOSH, SCSU, TIS_620, UTF_16BE, UTF_16LE, UTF_32, UTF_32BE, UTF_32LE, UTF_7, WINDOWS_1250, WINDOWS_1251, WINDOWS_1252, WINDOWS_1253, WINDOWS_1254, WINDOWS_1255, WINDOWS_1256, WINDOWS_1257, WINDOWS_1258};
    ...
    static {
        int length = MIBENUM_NUMBERS_EXTENDS.length - 1;
    ...
    public static String getMimeName(int i) {
        String str = (String) MIBENUM_TO_NAME_MAP.get(Integer.valueOf(i));
        if (str == null && (str = MIBENUM_TO_NAME_MAP_EXTENDS.get(Integer.valueOf(i))) == null) {
            return "utf-8";
        }
        return str;
    }
    ...
    public static int getMibEnumValue(String str) throws UnsupportedEncodingException {
        ...
        Integer num = (Integer) CharacterSets.NAME_TO_MIBENUM_MAP.get(lowerCase);
        if (num == null) {
            Log.i(LOG_TAG, "getMibEnumValue failed, mimeName is: " + lowerCase);
