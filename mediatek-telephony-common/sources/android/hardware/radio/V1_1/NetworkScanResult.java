...
public final class NetworkScanResult {
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        ...
        HwBlob embeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * MtkCharacterSets.ISO_2022_CN, hwBlob.handle(), j2 + 0, true);
        this.networkInfos.clear();
        for (int i = 0; i < int32; i++) {
            CellInfo cellInfo = new CellInfo();
            cellInfo.readEmbeddedFromParcel(hwParcel, embeddedBuffer, i * MtkCharacterSets.ISO_2022_CN);
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        ...
        for (int i = 0; i < size; i++) {
            this.networkInfos.get(i).writeEmbeddedToBlob(hwBlob2, i * MtkCharacterSets.ISO_2022_CN);
        }
