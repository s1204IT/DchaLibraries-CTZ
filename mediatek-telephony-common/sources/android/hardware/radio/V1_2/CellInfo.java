...
public final class CellInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        ...
        HwBlob embeddedBuffer3 = hwParcel.readEmbeddedBuffer(int323 * 112, hwBlob.handle(), j4 + 0, true);
        this.lte.clear();
        ...
        HwBlob embeddedBuffer4 = hwParcel.readEmbeddedBuffer(int324 * 96, hwBlob.handle(), j5 + 0, true);
        this.wcdma.clear();
        ...
        HwBlob embeddedBuffer5 = hwParcel.readEmbeddedBuffer(int325 * MtkCharacterSets.ISO_2022_CN, hwBlob.handle(), 0 + j6, true);
        this.tdscdma.clear();
        for (int i5 = 0; i5 < int325; i5++) {
            CellInfoTdscdma cellInfoTdscdma = new CellInfoTdscdma();
            cellInfoTdscdma.readEmbeddedFromParcel(hwParcel, embeddedBuffer5, i5 * MtkCharacterSets.ISO_2022_CN);
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        ...
        HwBlob hwBlob6 = new HwBlob(size5 * MtkCharacterSets.ISO_2022_CN);
        for (int i5 = 0; i5 < size5; i5++) {
            this.tdscdma.get(i5).writeEmbeddedToBlob(hwBlob6, i5 * MtkCharacterSets.ISO_2022_CN);
        }
