...
public final class CdmaInformationRecords {
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long j) {
        ...
        HwBlob embeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * DataCallFailCause.IFACE_AND_POL_FAMILY_MISMATCH, hwBlob.handle(), j2 + 0, true);
        this.infoRec.clear();
        for (int i = 0; i < int32; i++) {
            CdmaInformationRecord cdmaInformationRecord = new CdmaInformationRecord();
            cdmaInformationRecord.readEmbeddedFromParcel(hwParcel, embeddedBuffer, i * DataCallFailCause.IFACE_AND_POL_FAMILY_MISMATCH);
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        ...
        for (int i = 0; i < size; i++) {
            this.infoRec.get(i).writeEmbeddedToBlob(hwBlob2, i * DataCallFailCause.IFACE_AND_POL_FAMILY_MISMATCH);
        }
