...
public class FontsContractCompat {
    ...
    private static final SelfDestructiveThread sBackgroundThread = new SelfDestructiveThread("fonts", 10, TimeConsumingPreferenceActivity.PASSWORD_ERROR);
        ...
        try {
            ...
            if (cursor2 != null && cursor2.getCount() > 0) {
                ...
                while (cursor2.moveToNext()) {
                    ...
                    int weight = weightColumnIndex != -1 ? cursor2.getInt(weightColumnIndex) : TimeConsumingPreferenceActivity.RESPONSE_ERROR;
