...
public class ViewDragHelper {
    ...
    private int computeAxisDuration(int delta, int velocity, int motionRange) {
        ...
        return Math.min(duration, TimeConsumingPreferenceActivity.FDN_CHECK_FAILURE);
    }
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(TimeConsumingPreferenceActivity.STK_CC_SS_TO_DIAL_VIDEO_ERROR, this.mMaxVelocity);
