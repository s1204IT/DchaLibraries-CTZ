...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public AutoScrollHelper(View target) {
        ...
        setRampUpDuration(TimeConsumingPreferenceActivity.RADIO_OFF_ERROR);
        setRampDownDuration(TimeConsumingPreferenceActivity.RADIO_OFF_ERROR);
    }
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long currentTime) {
            ...
            if (this.mStopTime < 0 || currentTime < this.mStopTime) {
                ...
                return 0.5f * AutoScrollHelper.constrain(elapsedSinceStart / this.mRampUpDuration, 0.0f, 1.0f);
            }
