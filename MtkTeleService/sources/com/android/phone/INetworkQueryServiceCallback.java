...
public interface INetworkQueryServiceCallback extends IInterface {
    ...
    void onResults(List<CellInfo> list) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements INetworkQueryServiceCallback {
        ...
        public static INetworkQueryServiceCallback asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof INetworkQueryServiceCallback)) {
                return (INetworkQueryServiceCallback) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements INetworkQueryServiceCallback {
            ...
            @Override
            public void onResults(List<CellInfo> list) throws RemoteException {
