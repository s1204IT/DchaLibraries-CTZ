...
final class DictionaryData {
    ...
    public static DictionaryMatcher loadDictionaryFor(String str) throws IOException {
        ByteBuffer requiredData = ICUBinary.getRequiredData("brkitr/" + ((ICUResourceBundle) UResourceBundle.getBundleInstance(ICUData.ICU_BRKITR_BASE_NAME)).getStringWithFallback("dictionaries/" + str));
