...
abstract class CECalendar extends Calendar {
    ...
    public static int ceToJD(long j, int i, int i2, int i3) {
        ...
        return (int) (((((((long) i3) + (365 * j2)) + floorDivide(j2, 4L)) + ((long) (30 * i4))) + ((long) i2)) - 1);
    }

    public static void jdToCE(int i, int i2, int[] iArr) {
        int[] iArr2 = new int[1];
        iArr[0] = (4 * floorDivide(i - i2, 1461, iArr2)) + ((iArr2[0] / 365) - (iArr2[0] / 1460));
        int i3 = iArr2[0] != 1460 ? iArr2[0] % 365 : 365;
        iArr[1] = i3 / 30;
        iArr[2] = (i3 % 30) + 1;
    }
}
