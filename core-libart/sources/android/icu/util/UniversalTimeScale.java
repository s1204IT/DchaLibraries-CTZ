...
public final class UniversalTimeScale {
    ...
    private static final class TimeScaleData {
        ...
        TimeScaleData(long j, long j2, long j3, long j4, long j5, long j6) {
            ...
            if (j != UniversalTimeScale.ticks) {
                ...
                long j7 = this.epochOffset;
                this.epochOffsetM1 = j7;
                this.epochOffsetP1 = j7;
            }
            this.toMin = j3;
            this.toMax = j4;
            this.fromMin = j5;
    ...
    public static long from(long j, int i) {
        TimeScaleData timeScaleDataFromRangeCheck = fromRangeCheck(j, i);
        return (j + timeScaleDataFromRangeCheck.epochOffset) * timeScaleDataFromRangeCheck.units;
    }
    ...
    public static long toLong(long j, int i) {
        ...
        if (j < 0) {
            if (j < rangeCheck.minRound) {
                return ((j + rangeCheck.unitsRound) / rangeCheck.units) - rangeCheck.epochOffsetP1;
            }
            return ((j - rangeCheck.unitsRound) / rangeCheck.units) - rangeCheck.epochOffset;
        }
        if (j > rangeCheck.maxRound) {
            return ((j - rangeCheck.unitsRound) / rangeCheck.units) - rangeCheck.epochOffsetM1;
        }
        return ((j + rangeCheck.unitsRound) / rangeCheck.units) - rangeCheck.epochOffset;
    }
