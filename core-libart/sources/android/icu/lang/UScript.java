...
public final class UScript {
    ...
    public static final int[] getCode(String str) {
        ...
        int[] iArrFindCodeFromLocale = findCodeFromLocale(new ULocale(str));
        if (iArrFindCodeFromLocale != null) {
            return iArrFindCodeFromLocale;
        }
    ...
    private static final class ScriptMetadata {
        ...
        private static final int getScriptProps(int i) {
            if (i >= 0 && i < SCRIPT_PROPS.length) {
                return SCRIPT_PROPS[i];
            }
            return 0;
        }
    }
    ...
    public static final String getSampleString(int i) {
        ...
        if (scriptProps != 0) {
            return new StringBuilder().appendCodePoint(scriptProps).toString();
        }
        return "";
    }
