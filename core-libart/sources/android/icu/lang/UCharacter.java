...
public final class UCharacter implements UCharacterEnums.ECharacterCategory, UCharacterEnums.ECharacterDirection {
    ...
    public static int digit(int i, int i2) {
        ...
        int iDigit = digit(i);
        if (iDigit < 0) {
            europeanDigit = UCharacterProperty.getEuropeanDigit(i);
        } else {
            europeanDigit = iDigit;
        }
        if (europeanDigit < i2) {
    ...
    public static String getName(String str, String str2) {
        ...
        while (iCharCount < str.length()) {
            ...
            sb.append(getName(iCodePointAt));
            iCharCount += Character.charCount(iCodePointAt);
        }
        return sb.toString();
    }
    ...
    @Deprecated
    public static String toTitleFirst(ULocale uLocale, String str) {
    ...
    public static final int codePointAt(CharSequence charSequence, int i) {
        ...
        if (isHighSurrogate(cCharAt) && i2 < charSequence.length()) {
    ...
    public static final int codePointBefore(CharSequence charSequence, int i) {
        ...
        if (isLowSurrogate(cCharAt) && i2 > 0) {
    ...
    public static int codePointCount(CharSequence charSequence, int i, int i2) {
        ...
        while (i2 > i) {
            ...
            char cCharAt = charSequence.charAt(i2);
            while (true) {
                if (cCharAt >= 56320 && cCharAt <= 57343 && i2 > i) {
                    i2--;
    ...
    public static int offsetByCodePoints(CharSequence charSequence, int i, int i2) {
        ...
        if (i2 >= 0) {
            ...
            while (true) {
                ...
                int i3 = i + 1;
                char cCharAt = charSequence.charAt(i);
                while (cCharAt >= 55296 && cCharAt <= 56319 && i3 < length) {
                    int i4 = i3 + 1;
                    char cCharAt2 = charSequence.charAt(i3);
                    if ((cCharAt2 >= 56320 && cCharAt2 <= 57343) || i2 - 1 >= 0) {
                        i3 = i4;
                        cCharAt = cCharAt2;
                    } else {
                        return i4 - 1;
            ...
            while (true) {
                ...
                while (cCharAt3 >= 56320 && cCharAt3 <= 57343 && i > 0) {
                    i--;
                    cCharAt3 = charSequence.charAt(i);
