...
public class DecimalFormatProperties implements Cloneable, Serializable {
    ...
    private DecimalFormatProperties _copyFrom(DecimalFormatProperties decimalFormatProperties) {
        ...
        this.parseGroupingMode = decimalFormatProperties.parseGroupingMode;
    ...
    void readObjectImpl(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
