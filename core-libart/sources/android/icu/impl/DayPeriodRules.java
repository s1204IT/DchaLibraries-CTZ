...
public final class DayPeriodRules {
    ...
    private static final class DayPeriodRulesDataSink extends UResource.Sink {
        ...
        private void addCutoff(CutoffType cutoffType, String str) {
            ...
            int hour = parseHour(str);
            int[] iArr = this.cutoffs;
            iArr[hour] = (1 << cutoffType.ordinal()) | iArr[hour];
        }
    ...
    public static DayPeriodRules getInstance(ULocale uLocale) {
        ...
        Integer num = null;
        while (num == null) {
            num = DATA.localesToRuleSetNumMap.get(fallback);
            if (num != null) {
                break;
            }
            fallback = ULocale.getFallback(fallback);
            if (fallback.isEmpty()) {
                break;
            }
        }
    ...
    private static int parseSetNum(String str) {
