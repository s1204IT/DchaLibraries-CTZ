...
public class Trie2_32 extends Trie2 {
    ...
    public final int get(int i) {
        if (i >= 0) {
            ...
            if (i <= 65535) {
                return this.data32[(this.index[2048 + ((i - 55296) >> 5)] << 2) + (i & 31)];
            }
            if (i < this.highStart) {
                return this.data32[(this.index[this.index[2080 + (i >> 11)] + ((i >> 5) & 63)] << 2) + (i & 31)];
            }
            if (i <= 1114111) {
    ...
    public int serialize(OutputStream outputStream) throws IOException {
        ...
        return iSerializeHeader + (this.dataLength * 4);
    }
