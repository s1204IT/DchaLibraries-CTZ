...
public final class Collation {
    ...
    static long ceFromSimpleCE32(int i) {
        return (((long) (SECONDARY_MASK & i)) << 32) | (((long) (65280 & i)) << 16) | ((long) ((i & 255) << 8));
    }

    static long ceFromCE32(int i) {
        int i2 = i & 255;
        if (i2 < 192) {
            return (((long) (SECONDARY_MASK & i)) << 32) | (((long) (i & 65280)) << 16) | ((long) (i2 << 8));
        }
        int i3 = i - i2;
        if ((i2 & 15) == 1) {
    ...
    static long decThreeBytePrimaryByOneStep(long j, boolean z, int i) {
        ...
        if (i3 >= 2) {
            return (j & MAX_PRIMARY) | ((long) (i3 << 8));
        }
        int i4 = i3 + 254;
        ...
        return (j & 4278190080L) | ((long) (i2 << 16)) | ((long) (i4 << 8));
    }
    ...
    static long unassignedPrimaryFromCodePoint(int i) {
        ...
        long j = ((i2 % 18) * 14) + 2;
        int i3 = i2 / 18;
        return ((long) ((2 + (i3 % 254)) << 8)) | j | ((long) ((4 + ((i3 / 254) % 251)) << 16)) | 4261412864L;
    }
