...
public class LocaleIDs {
    ...
    public static String getISO3Country(String str) {
        int iFindIndex = findIndex(_countries, str);
        if (iFindIndex >= 0) {
            return _countries3[iFindIndex];
        }
        int iFindIndex2 = findIndex(_obsoleteCountries, str);
        if (iFindIndex2 >= 0) {
            return _obsoleteCountries3[iFindIndex2];
        }
        return "";
    }

    public static String getISO3Language(String str) {
        int iFindIndex = findIndex(_languages, str);
        if (iFindIndex >= 0) {
            return _languages3[iFindIndex];
        }
        int iFindIndex2 = findIndex(_obsoleteLanguages, str);
        if (iFindIndex2 >= 0) {
            return _obsoleteLanguages3[iFindIndex2];
        }
        return "";
    }

    public static String threeToTwoLetterLanguage(String str) {
        int iFindIndex = findIndex(_languages3, str);
        if (iFindIndex >= 0) {
            return _languages[iFindIndex];
        }
        int iFindIndex2 = findIndex(_obsoleteLanguages3, str);
        if (iFindIndex2 >= 0) {
            return _obsoleteLanguages[iFindIndex2];
        }
        return null;
    }

    public static String threeToTwoLetterRegion(String str) {
        int iFindIndex = findIndex(_countries3, str);
        if (iFindIndex >= 0) {
            return _countries[iFindIndex];
        }
        int iFindIndex2 = findIndex(_obsoleteCountries3, str);
        if (iFindIndex2 >= 0) {
            return _obsoleteCountries[iFindIndex2];
        }
        return null;
    }
    ...
    public static String getCurrentCountryID(String str) {
        int iFindIndex = findIndex(_deprecatedCountries, str);
        if (iFindIndex >= 0) {
            return _replacementCountries[iFindIndex];
        }
        return str;
    }

    public static String getCurrentLanguageID(String str) {
        int iFindIndex = findIndex(_obsoleteLanguages, str);
        if (iFindIndex >= 0) {
            return _replacementLanguages[iFindIndex];
        }
        return str;
    }
}
