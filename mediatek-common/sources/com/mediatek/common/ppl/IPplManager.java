...
public interface IPplManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPplManager {
        ...
        public static IPplManager asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IPplManager)) {
                return (IPplManager) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 4:
                    parcel.enforceInterface(DESCRIPTOR);
                    boolean zUnlock = unlock(parcel.readString());
                    parcel2.writeNoException();
                    parcel2.writeInt(zUnlock ? 1 : 0);
                    return true;
                default:
