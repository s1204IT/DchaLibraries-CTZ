...
public interface IMWSystemUiCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMWSystemUiCallback {
        ...
        public static IMWSystemUiCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IMWSystemUiCallback)) {
                return (IMWSystemUiCallback) iInterfaceQueryLocalInterface;
            }
