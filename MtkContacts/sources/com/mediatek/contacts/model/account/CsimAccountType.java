...
public class CsimAccountType extends SimAccountType {
    public CsimAccountType(Context context, String str) {
        Log.i("CsimAccountType", "[CsimAccountType]resPackageName:" + str);
        this.accountType = "CSIM Account";
        ...
        try {
            ...
            Log.e("CsimAccountType", "[UsimAccountType]DefinitionException:" + e);
        }
    }
    ...
    protected DataKind addDataKindEmail(Context context) throws AccountType.DefinitionException {
        ...
        Log.e("CsimAccountType", "[addDataKindEmail]");
