...
public class ContactsPreferences implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    ContactsPreferences(Context context, boolean z) throws Settings.SettingNotFoundException {
        this.mSortOrder = -1;
    ...
    public void setSortOrder(int i) {
        ...
        editorEdit.putInt(SORT_ORDER_KEY, i);
        editorEdit.commit();
    ...
    public void setDisplayOrder(int i) {
        ...
        SharedPreferences.Editor editorEdit = this.mPreferences.edit();
        editorEdit.putInt(DISPLAY_ORDER_KEY, i);
        editorEdit.commit();
        this.mBackupManager.dataChanged();
    }

    public int getDefaultPhoneticNameDisplayPreference() {
        if (this.mContext.getResources().getBoolean(R.bool.config_default_hide_phonetic_name_if_empty)) {
            return 1;
        }
        return 0;
    }
    ...
    public void setPhoneticNameDisplayPreference(int i) {
        ...
        SharedPreferences.Editor editorEdit = this.mPreferences.edit();
        editorEdit.putInt(PHONETIC_NAME_DISPLAY_KEY, i);
        editorEdit.commit();
        this.mBackupManager.dataChanged();
    }
    ...
    private void maybeMigrateSystemSettings() throws Settings.SettingNotFoundException {
        ...
        if (!this.mPreferences.contains(this.mDefaultAccountKey)) {
            String string = PreferenceManager.getDefaultSharedPreferences(this.mContext).getString(this.mDefaultAccountKey, null);
            if (!TextUtils.isEmpty(string)) {
