...
public final class PhoneCapabilityTester {
    ...
    public static boolean isPhone(Context context) {
        ...
        Log.d("PhoneCapabilityTester", "isPhone,sIsPhone = " + sIsPhone);
        return sIsPhone;
    }

    private static void initialize(Context context) {
        sIsPhone = TelephonyManagerCompat.isVoiceCapable((TelephonyManager) context.getSystemService("phone"));
        sIsSms = ((TelephonyManager) context.getSystemService("phone")).isSmsCapable();
    ...
    public static boolean isSupportSms(Context context) {
        ...
        Log.i("PhoneCapabilityTester", "sIsSms : " + sIsSms);
        return sIsSms;
    }
}
