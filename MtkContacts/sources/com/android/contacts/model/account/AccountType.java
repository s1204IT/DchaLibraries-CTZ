...
public abstract class AccountType {
    ...
    public Drawable getDisplayIconBySubId(Context context, int i) {
        return AccountTypeUtils.getDisplayIconBySubId(context, i, this.titleRes, this.iconRes, this.syncAdapterPackageName);
    }
    ...
    public void removeKind(String str) {
        if (this.mMimeKinds.get(str) != null) {
            this.mKinds.remove(this.mMimeKinds.get(str));
            this.mMimeKinds.remove(str);
        }
    }
}
