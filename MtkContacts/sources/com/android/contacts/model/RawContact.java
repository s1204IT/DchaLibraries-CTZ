...
public final class RawContact implements Parcelable {
    ...
    public static RawContact createFrom(Entity entity) {
        ...
        for (Entity.NamedContentValues namedContentValues : subValues) {
            rawContact.addNamedDataItemValues(namedContentValues.uri, namedContentValues.values);
        }
        return rawContact;
    }
    ...
    public ArrayList<ContentValues> getContentValues() {
        ArrayList<ContentValues> arrayListNewArrayListWithCapacity = Lists.newArrayListWithCapacity(this.mDataItems.size());
        for (NamedDataItem namedDataItem : this.mDataItems) {
            if (ContactsContract.Data.CONTENT_URI.equals(namedDataItem.mUri)) {
                arrayListNewArrayListWithCapacity.add(namedDataItem.mContentValues);
            }
        }
    ...
    public List<DataItem> getDataItems() {
        ArrayList arrayListNewArrayListWithCapacity = Lists.newArrayListWithCapacity(this.mDataItems.size());
        for (NamedDataItem namedDataItem : this.mDataItems) {
            if (ContactsContract.Data.CONTENT_URI.equals(namedDataItem.mUri)) {
                arrayListNewArrayListWithCapacity.add(DataItem.createFrom(namedDataItem.mContentValues));
            }
        }
        return arrayListNewArrayListWithCapacity;
    }
    ...
    public String toString() {
        ...
        for (NamedDataItem namedDataItem : this.mDataItems) {
            sb.append("\n  ");
            sb.append(namedDataItem.mUri);
            sb.append("\n  -> ");
            sb.append(namedDataItem.mContentValues);
        }
        return sb.toString();
    }
