...
public class ContactEditorUtils {
    ...
    public AccountWithDataSet getOnlyOrDefaultAccountEx(List<AccountWithDataSet> list) {
        return ContactEditorUtilsEx.getOnlyOrDefaultAccountEx(this.mContactsPrefs, list);
    }
}
