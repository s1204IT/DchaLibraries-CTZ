...
public class AccountHeaderPresenter {
    ...
    public void setCurrentAccount(AccountWithDataSet accountWithDataSet) {
        if (this.mCurrentAccount != null && this.mCurrentAccount.equals(accountWithDataSet)) {
            return;
        }
    ...
    public void setAccounts(List<AccountInfo> list) {
        this.mAccounts = list;
        if (this.mCurrentAccount == null || !AccountInfo.contains(this.mAccounts, this.mCurrentAccount)) {
    ...
    private void updateDisplayedAccount() {
        ...
        if (this.mCurrentAccount == null || this.mAccounts == null) {
            return;
        }
        String accountLabel = getAccountLabel(this.mCurrentAccount);
    ...
    private void addAccountHeader(String str) {
        ...
        if (this.mAccountHeaderType != null) {
            this.mAccountHeaderType.setText(string);
        }
