...
public class EditorIntents {
    ...
    public static Intent createViewLinkedContactsIntent(Context context, Uri uri, MaterialColorMapUtils.MaterialPalette materialPalette) {
        Intent intentCreateEditContactIntent = createEditContactIntent(context, uri, materialPalette, -1L);
        intentCreateEditContactIntent.putExtra("showReadOnly", true);
        return intentCreateEditContactIntent;
    }
