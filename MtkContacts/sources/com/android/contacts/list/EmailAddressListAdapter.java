...
public class EmailAddressListAdapter extends ContactEntryListAdapter {
    ...
    public void configureLoader(CursorLoader cursorLoader, long j) {
        ...
        Log.d("EmailAddressListAdapter", "[configureLoader]directoryId = " + j);
        if (isSearchMode()) {
        ...
        builderBuildUpon.appendQueryParameter("remove_duplicate_entries", "true");
    ...
    protected void bindView(View view, int i, Cursor cursor, int i2) {
        Log.d("EmailAddressListAdapter", "[bindView]partition = " + i + ",position = " + i2);
