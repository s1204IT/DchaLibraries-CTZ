...
public class ContactsIntentResolver {
    ...
    public ContactsRequest resolveIntent(Intent intent) {
        ...
        if ("com.android.contacts.action.LIST_DEFAULT".equals(action)) {
            ...
            String strResolveType = intent.resolveType(this.mContext);
            if ("vnd.android.cursor.dir/phone_v2".equals(strResolveType)) {
                contactsRequest.setActionCode(107);
            } else if ("vnd.android.cursor.dir/email_v2".equals(strResolveType)) {
                contactsRequest.setActionCode(106);
            }
        } else if ("android.intent.action.PICK".equals(action)) {
            String strResolveType2 = intent.resolveType(this.mContext);
            if ("vnd.android.cursor.dir/contact".equals(strResolveType2)) {
                contactsRequest.setActionCode(60);
            } else if ("vnd.android.cursor.dir/person".equals(strResolveType2)) {
                contactsRequest.setActionCode(60);
                contactsRequest.setLegacyCompatibilityMode(true);
            } else if ("vnd.android.cursor.dir/phone_v2".equals(strResolveType2)) {
                contactsRequest.setActionCode(90);
            } else if ("vnd.android.cursor.dir/phone".equals(strResolveType2)) {
                contactsRequest.setActionCode(90);
                contactsRequest.setLegacyCompatibilityMode(true);
            } else if ("vnd.android.cursor.dir/postal-address_v2".equals(strResolveType2)) {
                contactsRequest.setActionCode(100);
            } else if ("vnd.android.cursor.dir/postal-address".equals(strResolveType2)) {
                contactsRequest.setActionCode(100);
                contactsRequest.setLegacyCompatibilityMode(true);
            } else if ("vnd.android.cursor.dir/email_v2".equals(strResolveType2)) {
                contactsRequest.setActionCode(105);
            } else if ("vnd.android.cursor.dir/group".equals(strResolveType2)) {
            ...
            if (className.equals("alias.DialShortcut")) {
                contactsRequest.setActionCode(BaseAccountType.Weight.EVENT);
            ...
            String strResolveType3 = intent.resolveType(this.mContext);
            if ("vnd.android.cursor.dir/contact".equals(strResolveType3) || "vnd.android.cursor.dir/person".equals(strResolveType3)) {
                contactsRequest.setActionCode(15);
            } else if (!GroupUtil.isGroupUri(intent.getData())) {
                contactsRequest.setActionCode(BaseAccountType.Weight.IM);
