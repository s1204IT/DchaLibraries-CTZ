...
public class FloatingActionButtonController {
    ...
    public FloatingActionButtonController(Activity activity, View view, ImageButton imageButton) {
        ...
        this.mFabInterpolator = AnimationUtils.loadInterpolator(activity, R.interpolator.fast_out_slow_in);
        this.mFloatingActionButtonWidth = resources.getDimensionPixelSize(com.android.contacts.R.dimen.floating_action_button_width);
        this.mFloatingActionButtonMarginRight = resources.getDimensionPixelOffset(com.android.contacts.R.dimen.floating_action_button_margin_right);
        this.mAnimationDuration = resources.getInteger(com.android.contacts.R.integer.floating_action_button_animation_duration);
    ...
    public void scaleIn(int i) {
        ...
        AnimUtils.fadeIn(this.mFloatingActionButton, 186, i + 70, null);
    }
    ...
    public void scaleOut() {
        ...
        AnimUtils.fadeOut(this.mFloatingActionButton, 46, null);
    }
}
