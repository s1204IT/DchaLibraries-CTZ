...
public class NonPhoneActivity extends ContactsActivity {
    ...
    public static final class NonPhoneDialogFragment extends DialogFragment implements DialogInterface.OnClickListener {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            AlertDialog alertDialogCreate = new AlertDialog.Builder(getActivity(), R.style.NonPhoneDialogTheme).create();
            alertDialogCreate.setTitle(R.string.non_phone_caption);
            alertDialogCreate.setMessage(getArgumentPhoneNumber());
            alertDialogCreate.setButton(-1, getActivity().getString(R.string.non_phone_add_to_contacts), this);
            alertDialogCreate.setButton(-2, getActivity().getString(R.string.non_phone_close), this);
