...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    class WrappedNavigableSet extends AbstractMapBasedMultimap<K, V>.WrappedSortedSet implements NavigableSet<V> {
        ...
        NavigableSet<V> m9getSortedSetDelegate() {
            return (NavigableSet) super.getSortedSetDelegate();
        }

        @Override
        public V lower(V v) {
            return m9getSortedSetDelegate().lower(v);
        }

        @Override
        public V floor(V v) {
            return m9getSortedSetDelegate().floor(v);
        }

        @Override
        public V ceiling(V v) {
            return m9getSortedSetDelegate().ceiling(v);
        }

        @Override
        public V higher(V v) {
            return m9getSortedSetDelegate().higher(v);
        }
        ...
        public NavigableSet<V> descendingSet() {
            return wrap(m9getSortedSetDelegate().descendingSet());
        }

        @Override
        public Iterator<V> descendingIterator() {
            return new WrappedCollection.WrappedIterator(m9getSortedSetDelegate().descendingIterator());
        }

        @Override
        public NavigableSet<V> subSet(V v, boolean z, V v2, boolean z2) {
            return wrap(m9getSortedSetDelegate().subSet(v, z, v2, z2));
        }

        @Override
        public NavigableSet<V> headSet(V v, boolean z) {
            return wrap(m9getSortedSetDelegate().headSet(v, z));
        }

        @Override
        public NavigableSet<V> tailSet(V v, boolean z) {
            return wrap(m9getSortedSetDelegate().tailSet(v, z));
        }
    }
    ...
    class NavigableKeySet extends AbstractMapBasedMultimap<K, V>.SortedKeySet implements NavigableSet<K> {
        ...
        NavigableMap<K, Collection<V>> m7sortedMap() {
            return (NavigableMap) super.sortedMap();
        }

        @Override
        public K lower(K k) {
            return m7sortedMap().lowerKey(k);
        }

        @Override
        public K floor(K k) {
            return m7sortedMap().floorKey(k);
        }

        @Override
        public K ceiling(K k) {
            return m7sortedMap().ceilingKey(k);
        }

        @Override
        public K higher(K k) {
            return m7sortedMap().higherKey(k);
        }
        ...
        public NavigableSet<K> descendingSet() {
            return new NavigableKeySet(m7sortedMap().descendingMap());
        }
        ...
        public NavigableSet<K> headSet(K k, boolean z) {
            return new NavigableKeySet(m7sortedMap().headMap(k, z));
        }
        ...
        public NavigableSet<K> subSet(K k, boolean z, K k2, boolean z2) {
            return new NavigableKeySet(m7sortedMap().subMap(k, z, k2, z2));
        }
        ...
        public NavigableSet<K> tailSet(K k, boolean z) {
            return new NavigableKeySet(m7sortedMap().tailMap(k, z));
        }
    }
    ...
    class NavigableAsMap extends AbstractMapBasedMultimap<K, V>.SortedAsMap implements NavigableMap<K, Collection<V>> {
        ...
        NavigableMap<K, Collection<V>> m6sortedMap() {
            return (NavigableMap) super.sortedMap();
        }

        @Override
        public Map.Entry<K, Collection<V>> lowerEntry(K k) {
            Map.Entry<K, Collection<V>> entryLowerEntry = m6sortedMap().lowerEntry(k);
        ...
        public K lowerKey(K k) {
            return m6sortedMap().lowerKey(k);
        }

        @Override
        public Map.Entry<K, Collection<V>> floorEntry(K k) {
            Map.Entry<K, Collection<V>> entryFloorEntry = m6sortedMap().floorEntry(k);
        ...
        public K floorKey(K k) {
            return m6sortedMap().floorKey(k);
        }

        @Override
        public Map.Entry<K, Collection<V>> ceilingEntry(K k) {
            Map.Entry<K, Collection<V>> entryCeilingEntry = m6sortedMap().ceilingEntry(k);
        ...
        public K ceilingKey(K k) {
            return m6sortedMap().ceilingKey(k);
        }

        @Override
        public Map.Entry<K, Collection<V>> higherEntry(K k) {
            Map.Entry<K, Collection<V>> entryHigherEntry = m6sortedMap().higherEntry(k);
        ...
        public K higherKey(K k) {
            return m6sortedMap().higherKey(k);
        }

        @Override
        public Map.Entry<K, Collection<V>> firstEntry() {
            Map.Entry<K, Collection<V>> entryFirstEntry = m6sortedMap().firstEntry();
        ...
        public Map.Entry<K, Collection<V>> lastEntry() {
            Map.Entry<K, Collection<V>> entryLastEntry = m6sortedMap().lastEntry();
        ...
        public NavigableMap<K, Collection<V>> descendingMap() {
            return new NavigableAsMap(m6sortedMap().descendingMap());
        }
        ...
        NavigableSet<K> m5createKeySet() {
            return new NavigableKeySet(m6sortedMap());
        }
        ...
        public NavigableMap<K, Collection<V>> subMap(K k, boolean z, K k2, boolean z2) {
            return new NavigableAsMap(m6sortedMap().subMap(k, z, k2, z2));
        }
        ...
        public NavigableMap<K, Collection<V>> headMap(K k, boolean z) {
            return new NavigableAsMap(m6sortedMap().headMap(k, z));
        }
        ...
        public NavigableMap<K, Collection<V>> tailMap(K k, boolean z) {
            return new NavigableAsMap(m6sortedMap().tailMap(k, z));
        }
    }
}
