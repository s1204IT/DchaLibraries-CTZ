...
public class FlexboxLayout extends ViewGroup implements FlexContainer {
        ...
        while (i < size2) {
            ...
            switch (this.mJustifyContent) {
                case 0:
                    ...
                    float spaceBetweenItem3 = Math.max(spaceBetweenItem, ContactPhotoManager.OFFSET_DEFAULT);
                    j = 0;
                    while (true) {
                ...
                case 1:
                    ...
                    float spaceBetweenItem32 = Math.max(spaceBetweenItem, ContactPhotoManager.OFFSET_DEFAULT);
                    j = 0;
                    while (true) {
                        paddingBottom = paddingBottom3;
                        paddingBottom2 = flexLine.mItemCount;
                ...
                case 2:
                    ...
                    float spaceBetweenItem322 = Math.max(spaceBetweenItem, ContactPhotoManager.OFFSET_DEFAULT);
                    j = 0;
                    while (true) {
                        paddingBottom = paddingBottom3;
                        paddingBottom2 = flexLine.mItemCount;
                ...
                case 3:
                    ...
                    float spaceBetweenItem3222 = Math.max(spaceBetweenItem, ContactPhotoManager.OFFSET_DEFAULT);
                    j = 0;
                    while (true) {
                        paddingBottom = paddingBottom3;
                        paddingBottom2 = flexLine.mItemCount;
                ...
                case CompatUtils.TYPE_ASSERT:
                    ...
                    float spaceBetweenItem32222 = Math.max(spaceBetweenItem, ContactPhotoManager.OFFSET_DEFAULT);
                    j = 0;
                    while (true) {
                        paddingBottom = paddingBottom3;
                        paddingBottom2 = flexLine.mItemCount;
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams implements FlexItem {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.mFlexGrow = a.getFloat(R.styleable.FlexboxLayout_Layout_layout_flexGrow, ContactPhotoManager.OFFSET_DEFAULT);
