...
class FlexboxHelper {
    ...
    private void expandFlexItems(int widthMeasureSpec, int heightMeasureSpec, FlexLine flexLine, int maxMainSize, int paddingAlongMainAxis, boolean calledRecursively) {
        ...
        float accumulatedRoundError2;
        if (flexLine.mTotalFlexGrow <= ContactPhotoManager.OFFSET_DEFAULT || maxMainSize < flexLine.mMainSize) {
            return;
        }
        ...
        float accumulatedRoundError3 = 0.0f;
        while (true) {
            int i2 = i;
            ...
            if (child != null && child.getVisibility() != 8) {
                ...
                if (flexDirection2 == 0 || flexDirection2 == 1) {
                    ...
                    if (this.mChildrenFrozen[index] || flexItem.getFlexGrow() <= ContactPhotoManager.OFFSET_DEFAULT) {
                        ...
                        if (i2 == flexLine.mItemCount - 1) {
                            rawCalculatedWidth += accumulatedRoundError3;
                            accumulatedRoundError3 = ContactPhotoManager.OFFSET_DEFAULT;
                        }
                        ...
                        if (newWidth > flexItem.getMaxWidth()) {
                            ...
                            float accumulatedRoundError4 = accumulatedRoundError3 + (rawCalculatedWidth - newWidth);
                            if (accumulatedRoundError4 > 1.0d) {
                                ...
                                accumulatedRoundError3 = accumulatedRoundError4;
                            }
                            accumulatedRoundError3 = accumulatedRoundError;
                        }
                    ...
                    int childMeasuredHeight5 = flexItem.getMarginTop();
                    int largestCrossSize3 = Math.max(largestCrossSize2, childMeasuredHeight + childMeasuredHeight5 + flexItem.getMarginBottom() + this.mFlexContainer.getDecorationLengthCrossAxis(child));
                    ...
                    if (this.mMeasuredSizeCache != null) {
                        int childMeasuredHeight7 = extractHigherInt(this.mMeasuredSizeCache[index]);
                        flexDirection = childMeasuredHeight7;
                    } else {
                    ...
                    if (this.mChildrenFrozen[index] || flexItem.getFlexGrow() <= ContactPhotoManager.OFFSET_DEFAULT) {
                        ...
                        if (i2 == flexLine.mItemCount - 1) {
                            rawCalculatedHeight += accumulatedRoundError3;
                            accumulatedRoundError3 = ContactPhotoManager.OFFSET_DEFAULT;
                        }
                        ...
                        if (newHeight > flexItem.getMaxHeight()) {
                            ...
                            float accumulatedRoundError5 = accumulatedRoundError3 + (rawCalculatedHeight - newHeight);
                            if (accumulatedRoundError5 > 1.0d) {
                                newHeight++;
                                accumulatedRoundError2 = (float) (((double) accumulatedRoundError5) - 1.0d);
                            } else if (accumulatedRoundError5 < -1.0d) {
                                newHeight--;
                                accumulatedRoundError2 = (float) (((double) accumulatedRoundError5) + 1.0d);
                            } else {
                                accumulatedRoundError3 = accumulatedRoundError5;
                            }
                            accumulatedRoundError3 = accumulatedRoundError2;
                        }
                        ...
                        childMeasuredHeight2 = childMeasuredHeight8;
                    }
    ...
    private void shrinkFlexItems(int widthMeasureSpec, int heightMeasureSpec, FlexLine flexLine, int maxMainSize, int paddingAlongMainAxis, boolean calledRecursively) {
        ...
        if (flexLine.mTotalFlexShrink > ContactPhotoManager.OFFSET_DEFAULT && maxMainSize <= flexLine.mMainSize) {
            ...
            while (true) {
                ...
                if (child == null) {
                    ...
                    if (flexDirection == 0 || flexDirection == 1) {
                        ...
                        if (this.mChildrenFrozen[index] || flexItem.getFlexShrink() <= ContactPhotoManager.OFFSET_DEFAULT) {
                            childMeasuredHeight = childMeasuredHeight3;
                        } else {
                            float rawCalculatedWidth = childMeasuredWidth2 - (flexItem.getFlexShrink() * unitShrink);
                            if (i2 == flexLine.mItemCount - 1) {
                                rawCalculatedWidth += accumulatedRoundError;
                                accumulatedRoundError = ContactPhotoManager.OFFSET_DEFAULT;
                            }
                            int newWidth = Math.round(rawCalculatedWidth);
                        ...
                        int childMeasuredWidth4 = child.getMeasuredWidth();
                        if (this.mMeasuredSizeCache != null) {
                            int childMeasuredWidth5 = extractLowerInt(this.mMeasuredSizeCache[index]);
                            childMeasuredWidth = childMeasuredWidth5;
                        } else {
                            childMeasuredWidth = childMeasuredWidth4;
                        }
                        if (this.mChildrenFrozen[index] || flexItem.getFlexShrink() <= ContactPhotoManager.OFFSET_DEFAULT) {
                            ...
                            float rawCalculatedHeight = childMeasuredHeight5 - (flexItem.getFlexShrink() * unitShrink);
                            if (i2 == flexLine.mItemCount - 1) {
                        ...
                        largestCrossSize = Math.max(largestCrossSize2, childMeasuredWidth + childMeasuredHeight8 + flexItem.getMarginRight() + this.mFlexContainer.getDecorationLengthCrossAxis(child));
                        int largestCrossSize5 = flexLine.mMainSize;
                        flexLine.mMainSize = largestCrossSize5 + childMeasuredHeight2 + flexItem.getMarginTop() + flexItem.getMarginBottom();
                        int largestCrossSize42 = flexLine.mCrossSize;
                        flexLine.mCrossSize = Math.max(largestCrossSize42, largestCrossSize);
                        largestCrossSize2 = largestCrossSize;
                    }
                ...
                switch (this.mFlexContainer.getAlignContent()) {
                    ...
                    case 3:
                        if (totalCrossSize < size) {
                            ...
                            float accumulatedError = ContactPhotoManager.OFFSET_DEFAULT;
                            ...
                            for (int i = 0; i < flexLineSize; i++) {
                                ...
                                if (i == flexLines.size() - 1) {
                                    ...
                                    if (i == flexLines.size() - 2) {
                                        ...
                                        accumulatedError = ContactPhotoManager.OFFSET_DEFAULT;
                                    } else {
                    ...
                    case 5:
                        if (totalCrossSize < size) {
                            ...
                            float accumulatedError2 = ContactPhotoManager.OFFSET_DEFAULT;
                            ...
                            for (int i2 = 0; i2 < flexLinesSize; i2++) {
                                ...
                                if (i2 == flexLines.size() - 1) {
                                    ...
                                    accumulatedError2 = ContactPhotoManager.OFFSET_DEFAULT;
                                }
