...
public class FlexboxLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider, FlexContainer {
    ...
    public PointF computeScrollVectorForPosition(int targetPosition) {
        ...
        if (isMainAxisDirectionHorizontal()) {
            return new PointF(ContactPhotoManager.OFFSET_DEFAULT, direction);
        }
        return new PointF(direction, ContactPhotoManager.OFFSET_DEFAULT);
    }
    ...
    private int layoutFlexLineMainAxisHorizontal(FlexLine flexLine, LayoutState layoutState) {
        ...
        float spaceBetweenItem = ContactPhotoManager.OFFSET_DEFAULT;
        int i2 = 1;
        ...
        float spaceBetweenItem2 = Math.max(spaceBetweenItem, ContactPhotoManager.OFFSET_DEFAULT);
    ...
    private int layoutFlexLineMainAxisVertical(FlexLine flexLine, LayoutState layoutState) {
        ...
        switch (this.mJustifyContent) {
            ...
            case 1:
                ...
                break;
            case 2:
                float childTop4 = paddingTop2;
                childTop = childTop4 + ((parentHeight2 - flexLine.mMainSize) / 2.0f);
        ...
        float childTop5 = childTop - this.mAnchorInfo.mPerpendicularCoordinate;
        ...
        while (true) {
            ...
            if (i2 < startPosition + itemCount2) {
                ...
                if (view2 == null) {
                    ...
                    float childTop6 = lp.topMargin + getTopDecorationHeight(view2) + childTop5;
                    ...
                    int leftWithDecoration = childLeft2 + indexInFlexLine3;
                    ...
                    if (!this.mIsRtl) {
                        ...
                        int i3 = rightWithDecoration - view2.getMeasuredWidth();
                        paddingTop = paddingTop2;
                        childBottom2 = childBottom4;
                        paddingBottom = paddingBottom2;
                        view = view2;
                        ...
                        childTop2 = childTop6;
                        childTop3 = Float.MIN_VALUE;
                        flexboxHelper.layoutSingleChildVertical(view2, flexLine, z, i3, Math.round(childBottom4) - view2.getMeasuredHeight(), rightWithDecoration, Math.round(childBottom4));
                    } else {
                        i = i2;
                        paddingTop = paddingTop2;
                        paddingBottom = paddingBottom2;
                    ...
                    childTop5 = childTop2 + view.getMeasuredHeight() + lp.topMargin + getBottomDecorationHeight(view) + spaceBetweenItem2;
                    indexInFlexLine = indexInFlexLine2;
                }
                i2 = i + 1;
                itemCount = itemCount2;
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams implements FlexItem {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.mFlexGrow = ContactPhotoManager.OFFSET_DEFAULT;
