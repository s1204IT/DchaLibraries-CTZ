                    ...
                    this.mShowActionModePopup = new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (AppCompatDelegateImpl.this.shouldAnimateActionModeView()) {
                                AppCompatDelegateImpl.this.mActionModeView.setAlpha(ContactPhotoManager.OFFSET_DEFAULT);
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode2, mode2.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        this.mActionModeView.setAlpha(ContactPhotoManager.OFFSET_DEFAULT);
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImpl.this.mActionModeView != null) {
                AppCompatDelegateImpl.this.endOnGoingFadeAnimation();
                AppCompatDelegateImpl.this.mFadeAnim = ViewCompat.animate(AppCompatDelegateImpl.this.mActionModeView).alpha(ContactPhotoManager.OFFSET_DEFAULT);
                AppCompatDelegateImpl.this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(View view) {
