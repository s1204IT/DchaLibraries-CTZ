...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new ViewPropertyAnimatorListenerAdapter() {
        ...
        public void onAnimationEnd(View view) {
            if (WindowDecorActionBar.this.mContentAnimations && WindowDecorActionBar.this.mContentView != null) {
                WindowDecorActionBar.this.mContentView.setTranslationY(ContactPhotoManager.OFFSET_DEFAULT);
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            ViewPropertyAnimatorCompat a = ViewCompat.animate(this.mContainerView).translationY(ContactPhotoManager.OFFSET_DEFAULT);
            a.setUpdateListener(this.mUpdateListener);
            anim.play(a);
            if (this.mContentAnimations && this.mContentView != null) {
                this.mContentView.setTranslationY(startingY);
                anim.play(ViewCompat.animate(this.mContentView).translationY(ContactPhotoManager.OFFSET_DEFAULT));
            }
            ...
            this.mContainerView.setTranslationY(ContactPhotoManager.OFFSET_DEFAULT);
            if (this.mContentAnimations && this.mContentView != null) {
                this.mContentView.setTranslationY(ContactPhotoManager.OFFSET_DEFAULT);
            }
