...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    private final ValueAnimator mShowHideAnimator = ValueAnimator.ofFloat(ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
    ...
    void hide(int duration) {
        ...
        this.mShowHideAnimator.setFloatValues(((Float) this.mShowHideAnimator.getAnimatedValue()).floatValue(), ContactPhotoManager.OFFSET_DEFAULT);
    ...
    private void drawVerticalScrollbar(Canvas canvas) {
        ...
        canvas.translate(left, ContactPhotoManager.OFFSET_DEFAULT);
        this.mVerticalTrackDrawable.draw(canvas);
        canvas.translate(ContactPhotoManager.OFFSET_DEFAULT, top);
        this.mVerticalThumbDrawable.draw(canvas);
