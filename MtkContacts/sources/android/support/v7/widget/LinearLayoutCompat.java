...
public class LinearLayoutCompat extends ViewGroup {
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.mTotalLength = 0;
        int childState2 = 0;
        float totalWeight3 = ContactPhotoManager.OFFSET_DEFAULT;
            ...
            if (maxWidth2 < count3) {
                ...
                if (child2 == null) {
                    ...
                    if (childState6 == 8) {
                        ...
                        if (heightMode4 == 1073741824 && lp2.height == 0 && lp2.weight > ContactPhotoManager.OFFSET_DEFAULT) {
                            ...
                            if (lp2.height == 0 && lp2.weight > ContactPhotoManager.OFFSET_DEFAULT) {
                                oldHeight = 0;
                                lp2.height = -2;
                            }
                            ...
                            int oldHeight3 = i7;
                            alternativeMaxWidth3 = weightedMaxWidth4;
                            int alternativeMaxWidth5 = totalWeight4 == ContactPhotoManager.OFFSET_DEFAULT ? this.mTotalLength : 0;
                        ...
                        if (i3 < baselineChildIndex2 && lp.weight > ContactPhotoManager.OFFSET_DEFAULT) {
                        ...
                        if (lp.weight > ContactPhotoManager.OFFSET_DEFAULT) {
                            i5 = i12;
                ...
                if (skippedMeasure3) {
                    ...
                    if (delta3 == 0 || totalWeight3 <= ContactPhotoManager.OFFSET_DEFAULT) {
                            ...
                            if (heightMode != 1073741824) {
                                ...
                                while (true) {
                                    ...
                                    if (child4 != null) {
                                        ...
                                        } else if (((LayoutParams) child4.getLayoutParams()).weight > ContactPhotoManager.OFFSET_DEFAULT) {
                ...
                float weightSum = this.mWeightSum > ContactPhotoManager.OFFSET_DEFAULT ? this.mWeightSum : totalWeight;
                this.mTotalLength = 0;
                int i17 = 0;
                int delta5 = delta;
                while (i17 < count) {
                    ...
                    if (child5.getVisibility() == 8) {
                        ...
                        if (childExtra > ContactPhotoManager.OFFSET_DEFAULT) {
                            baselineChildIndex = baselineChildIndex2;
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.mTotalLength = 0;
        float totalWeight = ContactPhotoManager.OFFSET_DEFAULT;
        int count3 = getVirtualChildCount();
        int widthMode = View.MeasureSpec.getMode(widthMeasureSpec);
        ...
        while (maxHeight5 < count3) {
            ...
            if (child == null) {
                ...
                if (largestChildWidth7 == 8) {
                    ...
                    if (widthMode == 1073741824 && lp2.width == 0 && lp2.weight > ContactPhotoManager.OFFSET_DEFAULT) {
                        if (isExactly) {
                        ...
                        if (lp2.width == 0 && lp2.weight > ContactPhotoManager.OFFSET_DEFAULT) {
                            oldWidth = 0;
                            lp2.width = -2;
                        }
                        ...
                        maxHeight4 = childState3;
                        int maxHeight6 = totalWeight2 == ContactPhotoManager.OFFSET_DEFAULT ? this.mTotalLength : 0;
                        int oldWidth3 = i9;
                        baselineAligned = baselineAligned2;
                        i5 = -1;
        ...
        if (skippedMeasure || (delta2 != 0 && totalWeight > ContactPhotoManager.OFFSET_DEFAULT)) {
            float weightSum2 = this.mWeightSum > ContactPhotoManager.OFFSET_DEFAULT ? this.mWeightSum : totalWeight;
            maxAscent[3] = -1;
            maxAscent[2] = -1;
            maxAscent[1] = -1;
            maxAscent[0] = -1;
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            this.weight = a.getFloat(R.styleable.LinearLayoutCompat_Layout_android_layout_weight, ContactPhotoManager.OFFSET_DEFAULT);
