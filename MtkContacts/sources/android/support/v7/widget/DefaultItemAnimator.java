...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(ContactPhotoManager.OFFSET_DEFAULT).setListener(new AnimatorListenerAdapter() {
            @Override
    ...
    public boolean animateAdd(RecyclerView.ViewHolder holder) {
        resetAnimation(holder);
        holder.itemView.setAlpha(ContactPhotoManager.OFFSET_DEFAULT);
    ...
    public boolean animateChange(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder, int fromX, int fromY, int toX, int toY) {
        ...
        if (newHolder != null) {
            ...
            newHolder.itemView.setAlpha(ContactPhotoManager.OFFSET_DEFAULT);
        }
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(ContactPhotoManager.OFFSET_DEFAULT).setListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationStart(Animator animator) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(ContactPhotoManager.OFFSET_DEFAULT).translationY(ContactPhotoManager.OFFSET_DEFAULT).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationStart(Animator animator) {
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    newView.setTranslationX(ContactPhotoManager.OFFSET_DEFAULT);
                    newView.setTranslationY(ContactPhotoManager.OFFSET_DEFAULT);
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, RecyclerView.ViewHolder item) {
        ...
        item.itemView.setTranslationX(ContactPhotoManager.OFFSET_DEFAULT);
        item.itemView.setTranslationY(ContactPhotoManager.OFFSET_DEFAULT);
