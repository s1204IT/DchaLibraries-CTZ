...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        float radius = a.getDimension(android.support.v7.cardview.R.styleable.CardView_cardCornerRadius, ContactPhotoManager.OFFSET_DEFAULT);
        float elevation = a.getDimension(android.support.v7.cardview.R.styleable.CardView_cardElevation, ContactPhotoManager.OFFSET_DEFAULT);
        float maxElevation = a.getDimension(android.support.v7.cardview.R.styleable.CardView_cardMaxElevation, ContactPhotoManager.OFFSET_DEFAULT);
