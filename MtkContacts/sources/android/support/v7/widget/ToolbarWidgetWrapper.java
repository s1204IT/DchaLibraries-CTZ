...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int visibility, long duration) {
        return ViewCompat.animate(this.mToolbar).alpha(visibility == 0 ? 1.0f : ContactPhotoManager.OFFSET_DEFAULT).setDuration(duration).setListener(new ViewPropertyAnimatorListenerAdapter() {
