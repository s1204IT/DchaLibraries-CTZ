    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mRemoveActionBarHideOffset = new Runnable() {
            ...
            public void run() {
                ...
                ActionBarOverlayLayout.this.mCurrentActionBarTopAnimator = ActionBarOverlayLayout.this.mActionBarTop.animate().translationY(ContactPhotoManager.OFFSET_DEFAULT).setListener(ActionBarOverlayLayout.this.mTopAnimatorListener);
            }
        };
