...
class FloatingActionButtonImpl {
    ...
    private void calculateImageMatrixFromScale(float scale, Matrix matrix) {
        ...
        if (drawable != null && this.maxImageSize != 0) {
            ...
            drawableBounds.set(ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
            imageBounds.set(ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, this.maxImageSize, this.maxImageSize);
    ...
    void hide(final InternalVisibilityChangedListener listener, final boolean fromUser) {
        ...
        if (shouldAnimateVisibilityChange()) {
            AnimatorSet set = createAnimator(this.hideMotionSpec != null ? this.hideMotionSpec : getDefaultHideMotionSpec(), ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT);
    ...
    private ValueAnimator createElevationAnimator(ShadowAnimatorImpl impl) {
        ...
        animator.setFloatValues(ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
        return animator;
    }
