...
public class AppBarLayout extends LinearLayout {
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset, float velocity) {
            ...
            if (velocity2 > ContactPhotoManager.OFFSET_DEFAULT) {
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, AppBarLayout abl) {
            ...
            if (offsetChildIndex >= 0) {
                ...
                if ((flags & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, abl, MathUtils.constrain(newOffset, -abl.getTotalScrollRange(), 0), ContactPhotoManager.OFFSET_DEFAULT);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout parent, AppBarLayout abl, int layoutDirection) {
            ...
            if (this.offsetToChildIndexOnLayout >= 0 && (pendingAction & 8) == 0) {
                ...
                if ((pendingAction & 2) != 0) {
                    ...
                    if (animate) {
                        animateOffsetTo(parent, abl, offset3, ContactPhotoManager.OFFSET_DEFAULT);
                    } else {
                        setHeaderTopBottomOffset(parent, abl, offset3);
                    }
                } else if ((pendingAction & 1) != 0) {
                    if (animate) {
                        animateOffsetTo(parent, abl, 0, ContactPhotoManager.OFFSET_DEFAULT);
                    } else {
