...
public class CircularRevealHelper {
    ...
    private float getDistanceToFurthestCorner(CircularRevealWidget.RevealInfo revealInfo) {
        return MathUtils.distanceToFurthestCorner(revealInfo.centerX, revealInfo.centerY, ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, this.view.getWidth(), this.view.getHeight());
    }
        ...
        if (shouldDrawCircularReveal()) {
            switch (STRATEGY) {
                ...
                case 1:
                    ...
                    if (shouldDrawScrim()) {
                        canvas.drawRect(ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, this.view.getWidth(), this.view.getHeight(), this.scrimPaint);
                    }
