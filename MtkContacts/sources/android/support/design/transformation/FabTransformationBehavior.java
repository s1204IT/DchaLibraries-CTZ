...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
        ...
        set.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                if (expanded) {
                    ...
                    dependency.setAlpha(ContactPhotoManager.OFFSET_DEFAULT);
    ...
    private void createElevationAnimation(View dependency, View child, boolean expanded, boolean currentlyAnimating, FabTransformationSpec spec, List<Animator> animations, List<Animator.AnimatorListener> unusedListeners) {
        ...
        if (expanded) {
            ...
            animator = ObjectAnimator.ofFloat(child, (Property<View, Float>) View.TRANSLATION_Z, ContactPhotoManager.OFFSET_DEFAULT);
        } else {
    ...
    private void createTranslationAnimation(View dependency, View child, boolean expanded, boolean currentlyAnimating, FabTransformationSpec spec, List<Animator> animations, List<Animator.AnimatorListener> unusedListeners, RectF childBounds) {
        ...
        if (translationX == ContactPhotoManager.OFFSET_DEFAULT || translationY == ContactPhotoManager.OFFSET_DEFAULT) {
            translationXTiming = spec.timings.getTiming("translationXLinear");
            translationYTiming = spec.timings.getTiming("translationYLinear");
        } else if ((expanded && translationY < ContactPhotoManager.OFFSET_DEFAULT) || (!expanded && translationY > ContactPhotoManager.OFFSET_DEFAULT)) {
        ...
        if (expanded) {
            ...
            ValueAnimator translationXAnimator2 = ObjectAnimator.ofFloat(child, (Property<View, Float>) View.TRANSLATION_X, ContactPhotoManager.OFFSET_DEFAULT);
            translationYAnimator = ObjectAnimator.ofFloat(child, (Property<View, Float>) View.TRANSLATION_Y, ContactPhotoManager.OFFSET_DEFAULT);
            translationYTiming2 = translationYTiming3;
            translationXTiming2 = translationXTiming3;
            calculateChildVisibleBoundsAtEndOfExpansion(child, spec, translationXTiming3, translationYTiming3, -translationX, -translationY, ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, childBounds);
    ...
    private void createExpansionAnimation(View dependency, View view, boolean expanded, boolean currentlyAnimating, FabTransformationSpec spec, float childWidth, float childHeight, List<Animator> animations, List<Animator.AnimatorListener> listeners) {
        ...
        if (expanded) {
            ...
            float toRadius = MathUtils.distanceToFurthestCorner(revealCenterX, revealCenterY, ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, childWidth, childHeight);
    ...
    private void createChildrenFadeAnimation(View unusedDependency, View child, boolean expanded, boolean currentlyAnimating, FabTransformationSpec spec, List<Animator> animations, List<Animator.AnimatorListener> unusedListeners) {
        ...
        if (expanded) {
            if (!currentlyAnimating) {
                ChildrenAlphaProperty.CHILDREN_ALPHA.set(childContentContainer, Float.valueOf(ContactPhotoManager.OFFSET_DEFAULT));
            }
            animator = ObjectAnimator.ofFloat(childContentContainer, ChildrenAlphaProperty.CHILDREN_ALPHA, 1.0f);
        } else {
            animator = ObjectAnimator.ofFloat(childContentContainer, ChildrenAlphaProperty.CHILDREN_ALPHA, ContactPhotoManager.OFFSET_DEFAULT);
        }
    ...
    private float calculateTranslationX(View dependency, View child, Positioning positioning) {
        ...
        float translationX = ContactPhotoManager.OFFSET_DEFAULT;
    ...
    private float calculateTranslationY(View dependency, View child, Positioning positioning) {
        ...
        calculateWindowBounds(dependency, dependencyBounds);
        calculateWindowBounds(child, childBounds);
        float translationY = ContactPhotoManager.OFFSET_DEFAULT;
    ...
    private void calculateWindowBounds(View view, RectF rect) {
        rect.set(ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, view.getWidth(), view.getHeight());
    ...
    private float calculateRevealCenterX(View dependency, View child, Positioning positioning) {
        ...
        childBounds.offset(-translationX, ContactPhotoManager.OFFSET_DEFAULT);
    ...
    private float calculateRevealCenterY(View dependency, View child, Positioning positioning) {
        ...
        childBounds.offset(ContactPhotoManager.OFFSET_DEFAULT, -translationY);
