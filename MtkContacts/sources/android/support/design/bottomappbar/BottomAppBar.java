...
public class BottomAppBar extends Toolbar {
    ...
    private void translateActionMenuView(ActionMenuView actionMenuView, int fabAlignmentMode, boolean fabAttached) {
        ...
        actionMenuView.setTranslationX((fabAlignmentMode == 1 && fabAttached) ? offset : ContactPhotoManager.OFFSET_DEFAULT);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        float cradleVerticalOffset = ContactPhotoManager.OFFSET_DEFAULT;
        materialShapeDrawable.setInterpolation(z ? 1.0f : 0.0f);
        ...
        if (fab != null) {
            if (!isFabAttached()) {
                cradleVerticalOffset = (-fab.getMeasuredHeight()) + getCradleVerticalOffset();
            }
            fab.setTranslationY(cradleVerticalOffset);
