...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public void draw(Canvas canvas) {
        ...
        if (canvasSkewX != ContactPhotoManager.OFFSET_DEFAULT || canvasSkewY != ContactPhotoManager.OFFSET_DEFAULT) {
            canvasScaleX = 1.0f;
            canvasScaleY = 1.0f;
        }
        ...
        if (needMirroring) {
            canvas.translate(this.mTmpBounds.width(), ContactPhotoManager.OFFSET_DEFAULT);
    ...
    private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser) throws XmlPullParserException {
        ...
        if (pathRenderer.mViewportWidth <= ContactPhotoManager.OFFSET_DEFAULT) {
            throw new XmlPullParserException(a.getPositionDescription() + "<vector> tag requires viewportWidth > 0");
        }
        if (pathRenderer.mViewportHeight <= ContactPhotoManager.OFFSET_DEFAULT) {
        ...
        if (pathRenderer.mBaseWidth <= ContactPhotoManager.OFFSET_DEFAULT) {
            throw new XmlPullParserException(a.getPositionDescription() + "<vector> tag requires width > 0");
        }
        if (pathRenderer.mBaseHeight <= ContactPhotoManager.OFFSET_DEFAULT) {
    ...
    private static class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int w, int h, ColorFilter filter) {
            ...
            if (fullPath.mTrimPathStart != ContactPhotoManager.OFFSET_DEFAULT || fullPath.mTrimPathEnd != 1.0f) {
                ...
                if (start2 > end2) {
                    ...
                    len = ContactPhotoManager.OFFSET_DEFAULT;
                    pathMeasure.getSegment(ContactPhotoManager.OFFSET_DEFAULT, end2, path, true);
                } else {
                    len = ContactPhotoManager.OFFSET_DEFAULT;
        ...
        private float getMatrixScale(Matrix groupStackedMatrix) {
            float[] unitVectors = {ContactPhotoManager.OFFSET_DEFAULT, 1.0f, 1.0f, ContactPhotoManager.OFFSET_DEFAULT};
            ...
            if (maxScale <= ContactPhotoManager.OFFSET_DEFAULT) {
    ...
    private static class VGroup {
        ...
        public VGroup(VGroup copy, ArrayMap<String, Object> targetsMap) {
            ...
            this.mRotate = ContactPhotoManager.OFFSET_DEFAULT;
            this.mPivotX = ContactPhotoManager.OFFSET_DEFAULT;
            this.mPivotY = ContactPhotoManager.OFFSET_DEFAULT;
            this.mScaleX = 1.0f;
            this.mScaleY = 1.0f;
            this.mTranslateX = ContactPhotoManager.OFFSET_DEFAULT;
            this.mTranslateY = ContactPhotoManager.OFFSET_DEFAULT;
    ...
    private static class VFullPath extends VPath {
        ...
        public VFullPath() {
            this.mStrokeColor = 0;
            this.mStrokeWidth = ContactPhotoManager.OFFSET_DEFAULT;
            this.mFillColor = 0;
            this.mStrokeAlpha = 1.0f;
            this.mFillRule = 0;
            this.mFillAlpha = 1.0f;
            this.mTrimPathStart = ContactPhotoManager.OFFSET_DEFAULT;
            this.mTrimPathEnd = 1.0f;
            this.mTrimPathOffset = ContactPhotoManager.OFFSET_DEFAULT;
