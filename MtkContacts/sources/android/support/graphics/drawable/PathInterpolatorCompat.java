...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void parseInterpolatorFromTypeArray(TypedArray a, XmlPullParser parser) {
        ...
        float x1 = TypedArrayUtils.getNamedFloat(a, parser, "controlX1", 0, ContactPhotoManager.OFFSET_DEFAULT);
        float y1 = TypedArrayUtils.getNamedFloat(a, parser, "controlY1", 1, ContactPhotoManager.OFFSET_DEFAULT);
        ...
        float x2 = TypedArrayUtils.getNamedFloat(a, parser, "controlX2", 2, ContactPhotoManager.OFFSET_DEFAULT);
        float y2 = TypedArrayUtils.getNamedFloat(a, parser, "controlY2", 3, ContactPhotoManager.OFFSET_DEFAULT);
    ...
    private void initPath(Path path) {
        ...
        float prevX = ContactPhotoManager.OFFSET_DEFAULT;
    ...
    public float getInterpolation(float t) {
        if (t <= ContactPhotoManager.OFFSET_DEFAULT) {
        ...
        if (xRange == ContactPhotoManager.OFFSET_DEFAULT) {
