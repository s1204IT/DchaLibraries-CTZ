...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private void setupAnimators() {
        ...
        ValueAnimator animator = ValueAnimator.ofFloat(ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
    ...
    private static class Ring {
        ...
        void draw(Canvas c, Rect bounds) {
            ...
            if (this.mRingCenterRadius <= ContactPhotoManager.OFFSET_DEFAULT) {
        ...
        void drawTriangle(Canvas c, float startAngle, float sweepAngle, RectF bounds) {
            if (this.mShowArrow) {
                ...
                this.mArrow.lineTo(this.mArrowWidth * this.mArrowScale, ContactPhotoManager.OFFSET_DEFAULT);
