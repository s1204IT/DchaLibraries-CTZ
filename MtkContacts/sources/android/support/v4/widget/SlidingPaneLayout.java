...
public class SlidingPaneLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        float weightSum = ContactPhotoManager.OFFSET_DEFAULT;
        ...
        if (canSlide || weightSum > ContactPhotoManager.OFFSET_DEFAULT) {
            ...
            while (i3 < childCount2) {
                ...
                if (child2.getVisibility() == i) {
                    ...
                    if (child2.getVisibility() != i) {
                        boolean skippedFirstPass = lp2.width == 0 && lp2.weight > ContactPhotoManager.OFFSET_DEFAULT;
                        int measuredWidth = skippedFirstPass ? 0 : child2.getMeasuredWidth();
                        if (!canSlide || child2 == this.mSlideableView) {
                            heightMode = heightMode2;
                            childCount = childCount2;
                            if (lp2.weight > ContactPhotoManager.OFFSET_DEFAULT) {
                                if (lp2.width != 0) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (this.mFirstLayout) {
            this.mSlideOffset = (this.mCanSlide && this.mPreservedOpenState) ? 1.0f : ContactPhotoManager.OFFSET_DEFAULT;
        }
        int xStart2 = xStart;
        int xStart3 = 0;
        ...
        if (this.mFirstLayout) {
            if (this.mCanSlide) {
                ...
                for (int i = 0; i < childCount; i++) {
                    dimChildView(getChildAt(i), ContactPhotoManager.OFFSET_DEFAULT, this.mSliderFadeColor);
                }
            }
    ...
    private boolean closePane(View pane, int initialVelocity) {
        if (!this.mFirstLayout && !smoothSlideTo(ContactPhotoManager.OFFSET_DEFAULT, initialVelocity)) {
            return false;
        }
    ...
    private void dimChildView(View v, float mag, int fadeColor) {
        ...
        if (mag <= ContactPhotoManager.OFFSET_DEFAULT || fadeColor == 0) {
            if (v.getLayerType() != 0) {
                if (lp.dimPaint != null) {
    ...
    boolean isDimmed(View child) {
        ...
        LayoutParams lp = (LayoutParams) child.getLayoutParams();
        return this.mCanSlide && lp.dimWhenOffset && this.mSlideOffset > ContactPhotoManager.OFFSET_DEFAULT;
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            this.weight = a.getFloat(0, ContactPhotoManager.OFFSET_DEFAULT);
            a.recycle();
        }
    }
