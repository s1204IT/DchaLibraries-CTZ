...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    AnimationOrAnimator loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case 1:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.125f, 1.0f, ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
            case 2:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.0f, 0.975f, 1.0f, ContactPhotoManager.OFFSET_DEFAULT);
            case 3:
                return makeOpenCloseAnimation(this.mHost.getContext(), 0.975f, 1.0f, ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
            case CompatUtils.TYPE_ASSERT:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.0f, 1.075f, 1.0f, ContactPhotoManager.OFFSET_DEFAULT);
            case 5:
                return makeFadeAnimation(this.mHost.getContext(), ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
            case 6:
                return makeFadeAnimation(this.mHost.getContext(), 1.0f, ContactPhotoManager.OFFSET_DEFAULT);
            default:
                    ...
                    case 2:
                        if (newState2 < 2) {
                            ...
                            if (f.mView != null && f.mContainer != null) {
                                ...
                                if (this.mCurState > 0 && !this.mDestroyed && f.mView.getVisibility() == 0 && f.mPostponedAlpha >= ContactPhotoManager.OFFSET_DEFAULT) {
                                    anim = loadAnimation(f, transit, false, transitionStyle);
                                }
                                f.mPostponedAlpha = ContactPhotoManager.OFFSET_DEFAULT;
                                if (anim != null) {
    ...
    void moveFragmentToExpectedState(Fragment f) {
        ...
        if (f.mView != null) {
            ...
            if (f.mIsNewlyAdded && f.mContainer != null) {
                if (f.mPostponedAlpha > ContactPhotoManager.OFFSET_DEFAULT) {
        ...
        if (this.mActive != null) {
            ...
            for (int i = 0; i < numActive; i++) {
                ...
                if (fragment != null && fragment.mView != null && fragment.mIsNewlyAdded && record.interactsWith(fragment.mContainerId)) {
                    if (fragment.mPostponedAlpha > ContactPhotoManager.OFFSET_DEFAULT) {
                        fragment.mView.setAlpha(fragment.mPostponedAlpha);
                    }
                    if (moveToState) {
                        fragment.mPostponedAlpha = ContactPhotoManager.OFFSET_DEFAULT;
                    } else {
