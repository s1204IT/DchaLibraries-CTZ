...
public final class ColorUtils {
    ...
    public static void RGBToHSL(int r, int g, int b, float[] outHsl) {
        ...
        if (h2 < ContactPhotoManager.OFFSET_DEFAULT) {
            h2 += 360.0f;
        }
        outHsl[0] = constrain(h2, ContactPhotoManager.OFFSET_DEFAULT, 360.0f);
        outHsl[1] = constrain(s, ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
        outHsl[2] = constrain(l, ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
    }
