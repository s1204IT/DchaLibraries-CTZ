    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            while (true) {
                ...
                switch (cmd) {
                    case 'A':
                        k = k3;
                        drawArc(path, currentX2, currentY2, val[k + 5], val[k + 6], val[k + 0], val[k + 1], val[k + 2], val[k + 3] != ContactPhotoManager.OFFSET_DEFAULT, val[k + 4] != ContactPhotoManager.OFFSET_DEFAULT);
                        currentX2 = val[k + 5];
                        currentY2 = val[k + 6];
                    ...
                    case 'a':
                        k = k3;
                        drawArc(path, currentX2, currentY2, val[k + 5] + currentX2, val[k + 6] + currentY2, val[k + 0], val[k + 1], val[k + 2], val[k + 3] != ContactPhotoManager.OFFSET_DEFAULT ? true : z, val[k + 4] != ContactPhotoManager.OFFSET_DEFAULT ? true : z);
                        currentX2 += val[k + 5];
                        currentY2 += val[k + 6];
                        ctrlPointX = currentX2;
                        ctrlPointY = currentY2;
                    ...
                    case 'h':
                        k = k3;
                        path.rLineTo(val[k + 0], ContactPhotoManager.OFFSET_DEFAULT);
                        currentX2 += val[k + 0];
                        break;
                    case 'l':
                        k = k3;
                    ...
                    case 's':
                        ...
                        break;
                    case 't':
                        float reflectiveCtrlPointX5 = ContactPhotoManager.OFFSET_DEFAULT;
                        float reflectiveCtrlPointY5 = ContactPhotoManager.OFFSET_DEFAULT;
                        ...
                        break;
                    case 'v':
                        path.rLineTo(ContactPhotoManager.OFFSET_DEFAULT, val[k3 + 0]);
                        currentY2 += val[k3 + 0];
                        k = k3;
                        break;
                    default:
        ...
        private static void arcToBezier(Path p, double cx, double cy, double a, double b, double e1x, double e1y, double theta, double start, double sweep) {
            ...
            while (true) {
                ...
                p.rLineTo(ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT);
