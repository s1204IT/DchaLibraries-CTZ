...
public class EventLogTags {
    ...
    public static void writePdpBadDnsAddress(String str) {
        EventLog.writeEvent(PDP_BAD_DNS_ADDRESS, str);
    }

    public static void writePdpRadioResetCountdownTriggered(int i) {
        EventLog.writeEvent(PDP_RADIO_RESET_COUNTDOWN_TRIGGERED, i);
    }

    public static void writePdpRadioReset(int i) {
        EventLog.writeEvent(PDP_RADIO_RESET, i);
    }

    public static void writePdpContextReset(int i) {
        EventLog.writeEvent(PDP_CONTEXT_RESET, i);
    }

    public static void writePdpReregisterNetwork(int i) {
        EventLog.writeEvent(PDP_REREGISTER_NETWORK, i);
    }

    public static void writePdpSetupFail(int i, int i2, int i3) {
        EventLog.writeEvent(PDP_SETUP_FAIL, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3));
    }

    public static void writeCallDrop(int i, int i2, int i3) {
        EventLog.writeEvent(CALL_DROP, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3));
    }

    public static void writeDataNetworkRegistrationFail(int i, int i2) {
        EventLog.writeEvent(DATA_NETWORK_REGISTRATION_FAIL, Integer.valueOf(i), Integer.valueOf(i2));
    }

    public static void writeDataNetworkStatusOnRadioOff(String str, int i) {
        EventLog.writeEvent(DATA_NETWORK_STATUS_ON_RADIO_OFF, str, Integer.valueOf(i));
    }

    public static void writePdpNetworkDrop(int i, int i2) {
        EventLog.writeEvent(PDP_NETWORK_DROP, Integer.valueOf(i), Integer.valueOf(i2));
    }

    public static void writeCdmaDataSetupFailed(int i, int i2, int i3) {
        EventLog.writeEvent(CDMA_DATA_SETUP_FAILED, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3));
    }

    public static void writeCdmaDataDrop(int i, int i2) {
        EventLog.writeEvent(CDMA_DATA_DROP, Integer.valueOf(i), Integer.valueOf(i2));
    }

    public static void writeGsmRatSwitched(int i, int i2, int i3) {
        EventLog.writeEvent(GSM_RAT_SWITCHED, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3));
    }

    public static void writeGsmDataStateChange(String str, String str2) {
        EventLog.writeEvent(GSM_DATA_STATE_CHANGE, str, str2);
    }

    public static void writeGsmServiceStateChange(int i, int i2, int i3, int i4) {
        EventLog.writeEvent(GSM_SERVICE_STATE_CHANGE, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4));
    }

    public static void writeCdmaDataStateChange(String str, String str2) {
        EventLog.writeEvent(CDMA_DATA_STATE_CHANGE, str, str2);
    }

    public static void writeCdmaServiceStateChange(int i, int i2, int i3, int i4) {
        EventLog.writeEvent(CDMA_SERVICE_STATE_CHANGE, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4));
    }

    public static void writeBadIpAddress(String str) {
        EventLog.writeEvent(BAD_IP_ADDRESS, str);
    }

    public static void writeDataStallRecoveryGetDataCallList(int i) {
        EventLog.writeEvent(DATA_STALL_RECOVERY_GET_DATA_CALL_LIST, i);
    }

    public static void writeDataStallRecoveryCleanup(int i) {
        EventLog.writeEvent(DATA_STALL_RECOVERY_CLEANUP, i);
    }

    public static void writeDataStallRecoveryReregister(int i) {
        EventLog.writeEvent(DATA_STALL_RECOVERY_REREGISTER, i);
    }

    public static void writeDataStallRecoveryRadioRestart(int i) {
        EventLog.writeEvent(DATA_STALL_RECOVERY_RADIO_RESTART, i);
    }

    public static void writeDataStallRecoveryRadioRestartWithProp(int i) {
        EventLog.writeEvent(DATA_STALL_RECOVERY_RADIO_RESTART_WITH_PROP, i);
    }

    public static void writeGsmRatSwitchedNew(int i, int i2, int i3) {
        EventLog.writeEvent(GSM_RAT_SWITCHED_NEW, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3));
    }

    public static void writeExpDetSmsDeniedByUser(String str) {
        EventLog.writeEvent(EXP_DET_SMS_DENIED_BY_USER, str);
    }

    public static void writeExpDetSmsSentByUser(String str) {
        EventLog.writeEvent(EXP_DET_SMS_SENT_BY_USER, str);
    }
}
