...
public interface CommandsInterface {
    ...
    void setAllowedCarriers(List<android.service.carrier.CarrierIdentifier> list, Message message);
    ...
    default void getNeighboringCids(Message message, WorkSource workSource) {
    }
