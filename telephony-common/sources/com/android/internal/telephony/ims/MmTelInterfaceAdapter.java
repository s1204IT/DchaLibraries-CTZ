...
public class MmTelInterfaceAdapter {
    ...
    private IImsMMTelFeature getInterface() throws RemoteException {
        IImsMMTelFeature iImsMMTelFeatureAsInterface = IImsMMTelFeature.Stub.asInterface(this.mBinder);
        if (iImsMMTelFeatureAsInterface == null) {
            throw new RemoteException("Binder not Available");
        }
        return iImsMMTelFeatureAsInterface;
    }
}
