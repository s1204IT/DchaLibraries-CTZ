...
public final class CdmaInformationRecords {
    ...
    public CdmaInformationRecords(Parcel parcel) {
        ...
        switch (i) {
            case 0:
            case 7:
                this.record = new CdmaDisplayInfoRec(i, parcel.readString());
                return;
            case 1:
            case 2:
            case 3:
                this.record = new CdmaNumberInfoRec(i, parcel.readString(), parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt());
                return;
            case 4:
