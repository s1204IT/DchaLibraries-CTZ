...
public class SimulatedCommands extends BaseCommands implements CommandsInterface, SimulatedRadioControl {
    ...
    public void getSignalStrength(Message message) {
        if (this.mSignalStrength == null) {
            this.mSignalStrength = new SignalStrength(20, 0, -1, -1, -1, -1, -1, 99, KeepaliveStatus.INVALID_HANDLE, KeepaliveStatus.INVALID_HANDLE, KeepaliveStatus.INVALID_HANDLE, KeepaliveStatus.INVALID_HANDLE, KeepaliveStatus.INVALID_HANDLE);
        }
