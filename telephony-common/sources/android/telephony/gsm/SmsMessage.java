...
public class SmsMessage {
    ...
    public static SmsMessage createFromPdu(byte[] bArr) {
        com.android.internal.telephony.cdma.SmsMessage smsMessageCreateFromPdu;
        if (2 == TelephonyManager.getDefault().getCurrentPhoneType()) {
            smsMessageCreateFromPdu = com.android.internal.telephony.cdma.SmsMessage.createFromPdu(bArr);
        } else {
            smsMessageCreateFromPdu = com.android.internal.telephony.gsm.SmsMessage.createFromPdu(bArr);
        }
        return new SmsMessage(smsMessageCreateFromPdu);
    }
    ...
    public static int[] calculateLength(CharSequence charSequence, boolean z) {
        GsmAlphabet.TextEncodingDetails textEncodingDetailsCalculateLength = com.android.internal.telephony.gsm.SmsMessage.calculateLength(charSequence, z);
