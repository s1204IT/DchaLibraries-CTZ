...
public interface IRadioConfig extends IBase {
    ...
    static IRadioConfig asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IRadioConfig)) {
            return (IRadioConfig) iHwInterfaceQueryLocalInterface;
        }
    ...
    public static abstract class Stub extends HwBinder implements IRadioConfig {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadioConfig.kInterfaceName, IBase.kInterfaceName));
        }
