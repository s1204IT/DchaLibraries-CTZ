...
public final class CardStatus {
    ...
    public final boolean equals(Object obj) {
        ...
        if (HidlSupport.deepEquals(this.base, cardStatus.base) && this.physicalSlotId == cardStatus.physicalSlotId && HidlSupport.deepEquals(this.atr, cardStatus.atr) && HidlSupport.deepEquals(this.iccid, cardStatus.iccid)) {
            return true;
        }
        return false;
    }
