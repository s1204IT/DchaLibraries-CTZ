...
public interface IOemHookIndication extends IBase {
    ...
    static IOemHookIndication asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IOemHookIndication)) {
            return (IOemHookIndication) iHwInterfaceQueryLocalInterface;
        }
