...
public interface IOemHook extends IBase {
    ...
    static IOemHook asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IOemHook)) {
            return (IOemHook) iHwInterfaceQueryLocalInterface;
        }
    ...
    public static final class Proxy implements IOemHook {
        ...
        public void setResponseFunctions(IOemHookResponse iOemHookResponse, IOemHookIndication iOemHookIndication) throws RemoteException {
            ...
            hwParcel.writeStrongBinder(iOemHookResponse == null ? null : iOemHookResponse.asBinder());
            hwParcel.writeStrongBinder(iOemHookIndication != null ? iOemHookIndication.asBinder() : null);
