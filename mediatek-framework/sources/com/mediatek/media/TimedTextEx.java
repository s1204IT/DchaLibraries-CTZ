...
public class TimedTextEx {
    ...
    public static byte[] getTextByteChars(TimedText timedText) throws IllegalAccessException, IllegalArgumentException {
        return (byte[]) textField.get(timedText);
    }

    public static int getBitmapWidth(TimedText timedText) throws IllegalAccessException, IllegalArgumentException {
        return ((Integer) widthField.get(timedText)).intValue();
    }

    public static int getBitmapHeight(TimedText timedText) throws IllegalAccessException, IllegalArgumentException {
        return ((Integer) heightField.get(timedText)).intValue();
    }

    public static int getBitmapFd(TimedText timedText) throws IllegalAccessException, IllegalArgumentException {
