...
public final class MtkSettingsExt {
    ...
    public static final class System {
        ...
        public static void setVoiceCommandValue(ContentResolver contentResolver, String str, int i, String str2) {
            Settings.System.putString(contentResolver, str + i, str2);
        }

        public static String getVoiceCommandValue(ContentResolver contentResolver, String str, int i) {
            return Settings.System.getString(contentResolver, str + i);
        }

        public static void putInPublicSettings(Set<String> set) {
            Log.d(MtkSettingsExt.TAG, "putInPublicSettings");
            set.add("msim_mode_setting");
            set.add("auto_time_gps");
            set.add(ACCELEROMETER_ROTATION_RESTORE);
            set.add(BG_POWER_SAVING_ENABLE);
            set.add(HDMI_ENABLE_STATUS);
            set.add(HDMI_VIDEO_RESOLUTION);
            set.add(HDMI_VIDEO_SCALE);
            set.add(HDMI_CABLE_PLUGGED);
            set.add(HDMI_AUDIO_OUTPUT_MODE);
            set.add(WIFI_CONNECT_TYPE);
            set.add(WIFI_CONNECT_AP_TYPE);
            set.add(WIFI_CONNECT_REMINDER);
            set.add(WIFI_PRIORITY_TYPE);
            set.add(WIFI_SELECT_SSID_TYPE);
            set.add(LAST_SIMID_BEFORE_WIFI_DISCONNECTED);
            set.add(VOLTE_DMYK_STATE_0);
            set.add(VOLTE_DMYK_STATE_1);
            set.add(BASE_VOICE_WAKEUP_COMMAND_KEY);
            set.add(VOICE_WAKEUP_MODE);
            set.add(VOICE_WAKEUP_COMMAND_STATUS);
        }

        public static void moveToGlobal(HashSet<String> hashSet) {
            Log.d(MtkSettingsExt.TAG, "System moveToGlobal");
            hashSet.add("msim_mode_setting");
            hashSet.add("auto_time_gps");
        }
