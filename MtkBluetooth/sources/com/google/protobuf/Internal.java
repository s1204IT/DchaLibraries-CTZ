...
public final class Internal {
    ...
    static final Charset ISO_8859_1 = Charset.forName(VCardConfig.DEFAULT_INTERMEDIATE_CHARSET);
    ...
    public static int hashEnumList(List<? extends EnumLite> list) {
        ...
        int iHashEnum = 1;
        while (it.hasNext()) {
            iHashEnum = hashEnum(it.next()) + (31 * iHashEnum);
        }
        return iHashEnum;
    }
    ...
    public static int hashCode(List<byte[]> list) {
        ...
        int iHashCode = 1;
        while (it.hasNext()) {
            iHashCode = hashCode(it.next()) + (31 * iHashCode);
        }
        return iHashCode;
    }
    ...
    public static int hashCodeByteBuffer(List<ByteBuffer> list) {
        ...
        while (it.hasNext()) {
            iHashCodeByteBuffer = hashCodeByteBuffer(it.next()) + (31 * iHashCodeByteBuffer);
        }
    ...
    public static int hashCodeByteBuffer(ByteBuffer byteBuffer) {
        ...
        while (byteBufferDuplicate.remaining() > 0) {
            if (byteBufferDuplicate.remaining() <= iCapacity) {
                iRemaining = byteBufferDuplicate.remaining();
            } else {
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        public static <T extends EnumLite> Converter<Integer, T> newEnumConverter(final EnumLiteMap<T> enumLiteMap, final T t) {
            return (Converter<Integer, T>) new Converter<Integer, T>() {
                @Override
