...
final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    public boolean equals(Object obj) {
        ...
        return obj.fields.equals(obj.fields);
    }
    ...
    public Object getField(FieldDescriptorType fielddescriptortype) {
        ?? r2 = this.fields.get(fielddescriptortype);
        return r2 instanceof LazyField ? r2.getValue() : r2;
    }
    ...
    private void mergeFromField(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        if (key.getLiteJavaType() == WireFormat.JavaType.MESSAGE) {
            ...
            if (field2 == null) {
                this.fields.put(key, cloneIfMutable(value2));
                return;
            } else {
                this.fields.put(key, key.internalMergeFrom(((MessageLite) field2).toBuilder(), (MessageLite) value2).build());
                return;
            }
        }
        this.fields.put(key, cloneIfMutable(value2));
    ...
    private void writeMessageSetTo(Map.Entry<FieldDescriptorType, Object> entry, CodedOutputStream codedOutputStream) throws IOException {
        ...
        if (key.getLiteJavaType() == WireFormat.JavaType.MESSAGE && !key.isRepeated() && !key.isPacked()) {
            ...
            codedOutputStream.writeMessageSetExtension(entry.getKey().getNumber(), (MessageLite) value2);
            return;
        }
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            ...
            case 11:
                if (!(obj instanceof ByteString)) {
                    ...
                    codedOutputStream.writeBytesNoTag(obj);
                }
                break;
            case 12:
                if (!(obj instanceof ByteString)) {
    ...
    public static void writeField(FieldDescriptorLite<?> fieldDescriptorLite, Object obj, CodedOutputStream codedOutputStream) throws IOException {
        ...
        if (!(obj instanceof LazyField)) {
            ...
            writeElement(codedOutputStream, liteType, number, obj.getValue());
        }
    }
    ...
    static int computeElementSizeNoTag(WireFormat.FieldType fieldType, Object obj) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            ...
            case 10:
                return obj instanceof LazyField ? CodedOutputStream.computeLazyFieldSizeNoTag(obj) : CodedOutputStream.computeMessageSizeNoTag((MessageLite) obj);
            case 11:
                return obj instanceof ByteString ? CodedOutputStream.computeBytesSizeNoTag(obj) : CodedOutputStream.computeStringSizeNoTag((String) obj);
            case 12:
                return obj instanceof ByteString ? CodedOutputStream.computeBytesSizeNoTag(obj) : CodedOutputStream.computeByteArraySizeNoTag((byte[]) obj);
            case 13:
