...
public class VCardUtils {
    ...
    static {
        ...
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_OTHER_FAX, 13);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_TYPE_TLX, 15);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_TYPE_MSG, 20);
        ...
        sKnownImPropNameMap_ItoS.put(-1, VCardConstants.PROPERTY_X_CUSTOM_IM);
            ...
            while (it2.hasNext()) {
                ...
                if (next != null) {
                    ...
                    if (!upperCase.equals(VCardConstants.PARAM_TYPE_PREF)) {
                        if (!upperCase.equals(VCardConstants.PARAM_TYPE_FAX)) {
