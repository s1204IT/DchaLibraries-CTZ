            ...
            for (ContentValues contentValues : list) {
                ...
                if (asInteger != null) {
                    if (-1 == asInteger.intValue()) {
                        ...
                        appendLineWithCharsetAndQPDetection(VCardConstants.PROPERTY_X_CUSTOM_IM, arrayList, contentValues.getAsString("data1"));
                    } else {
                        ...
                        if (propertyNameForIm != null) {
                            ...
                            if (!TextUtils.isEmpty(asString2)) {
                                ...
                                if (z) {
                                    arrayList2.add(VCardConstants.PARAM_TYPE_PREF);
                                }
    ...
    public VCardBuilder appendOrganizations(List<ContentValues> list) {
        if (list != null) {
            for (ContentValues contentValues : list) {
                ...
                appendLine(VCardConstants.PROPERTY_ORG, string, !VCardUtils.containsOnlyPrintableAscii(string), this.mShouldUseQuotedPrintable && !VCardUtils.containsOnlyNonCrLfPrintableAscii(string));
                if (!TextUtils.isEmpty(asString3)) {
    ...
    public void appendTelLine(Integer num, String str, String str2, boolean z) {
        ...
        switch (iIntValue) {
            ...
            case 7:
                ...
                break;
            case 8:
                arrayList.add(VCardConstants.PARAM_PHONE_EXTRA_TYPE_CALLBACK);
                z2 = z;
                break;
            case 9:
                ...
                break;
            case 10:
                arrayList.add(VCardConstants.PARAM_PHONE_EXTRA_TYPE_COMPANY_MAIN);
                break;
            case 11:
            ...
            case 12:
                break;
            case 13:
                arrayList.add(VCardConstants.PARAM_PHONE_EXTRA_OTHER_FAX);
                z2 = z;
                break;
            case 14:
                arrayList.add(VCardConstants.PARAM_PHONE_EXTRA_TYPE_RADIO);
                z2 = z;
                break;
            case 15:
                ...
                break;
            case 16:
                arrayList.add(VCardConstants.PARAM_PHONE_EXTRA_TYPE_TTY_TDD);
                z2 = z;
                break;
            case 17:
            ...
            case 18:
                ...
                break;
            case 19:
                arrayList.add(VCardConstants.PARAM_PHONE_EXTRA_TYPE_ASSISTANT);
                z2 = z;
                break;
            case 20:
