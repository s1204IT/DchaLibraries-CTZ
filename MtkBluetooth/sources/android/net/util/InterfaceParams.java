...
public class InterfaceParams {
    ...
    public InterfaceParams(String str, int i, MacAddress macAddress) {
        this(str, i, macAddress, NetworkConstants.ETHER_MTU);
    }
    ...
    public InterfaceParams(String str, int i, MacAddress macAddress, int i2) {
        ...
        Preconditions.checkArgument(i > 0, "invalid interface index");
        this.name = str;
        this.index = i;
        this.macAddr = macAddress == null ? MacAddress.ALL_ZEROS_ADDRESS : macAddress;
        this.defaultMtu = i2 > 1280 ? i2 : NetworkConstants.IPV6_MIN_MTU;
    }
