...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (obj == 0 || !(obj instanceof Params)) {
                return false;
            }
            if (this.mWrapped != null) {
                return this.mWrapped.equals(obj.mWrapped);
            }
            if (Build.VERSION.SDK_INT >= 23 && (this.mBreakStrategy != obj.getBreakStrategy() || this.mHyphenationFrequency != obj.getHyphenationFrequency())) {
                return false;
            }
            if ((Build.VERSION.SDK_INT >= 18 && this.mTextDir != obj.getTextDirection()) || this.mPaint.getTextSize() != obj.getTextPaint().getTextSize() || this.mPaint.getTextScaleX() != obj.getTextPaint().getTextScaleX() || this.mPaint.getTextSkewX() != obj.getTextPaint().getTextSkewX()) {
                return false;
            }
            if ((Build.VERSION.SDK_INT >= 21 && (this.mPaint.getLetterSpacing() != obj.getTextPaint().getLetterSpacing() || !TextUtils.equals(this.mPaint.getFontFeatureSettings(), obj.getTextPaint().getFontFeatureSettings()))) || this.mPaint.getFlags() != obj.getTextPaint().getFlags()) {
                return false;
            }
            if (Build.VERSION.SDK_INT >= 24) {
                if (!this.mPaint.getTextLocales().equals(obj.getTextPaint().getTextLocales())) {
                    return false;
                }
            } else if (Build.VERSION.SDK_INT >= 17 && !this.mPaint.getTextLocale().equals(obj.getTextPaint().getTextLocale())) {
                return false;
            }
            if (this.mPaint.getTypeface() != null) {
                if (!this.mPaint.getTypeface().equals(obj.getTextPaint().getTypeface())) {
                    return false;
                }
            } else if (obj.getTextPaint().getTypeface() != null) {
                return false;
            }
            return true;
        }
