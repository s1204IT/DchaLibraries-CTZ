...
public class SlidingPaneLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (true) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.weight > 0.0f) {
                    weightSum += lp.weight;
                    if (((ViewGroup.LayoutParams) lp).width == 0) {
                    }
                    layoutHeight2++;
                    widthMode = widthMode2;
                    heightSize2 = heightSize;
                }
                int horizontalMargin = ((ViewGroup.MarginLayoutParams) lp).leftMargin + ((ViewGroup.MarginLayoutParams) lp).rightMargin;
                heightSize = heightSize2;
                if (((ViewGroup.LayoutParams) lp).width == -2) {
                    childWidthSpec = View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, Integer.MIN_VALUE);
                } else {
                    int childWidthSpec2 = ((ViewGroup.LayoutParams) lp).width;
                    childWidthSpec = childWidthSpec2 == -1 ? View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, 1073741824) : View.MeasureSpec.makeMeasureSpec(((ViewGroup.LayoutParams) lp).width, 1073741824);
                }
                int childHeightSpec3 = ((ViewGroup.LayoutParams) lp).height == -2 ? View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, Integer.MIN_VALUE) : ((ViewGroup.LayoutParams) lp).height == -1 ? View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, 1073741824) : View.MeasureSpec.makeMeasureSpec(((ViewGroup.LayoutParams) lp).height, 1073741824);
            ...
            while (i3 < childCount2) {
                ...
                if (child2.getVisibility() == i) {
                    ...
                    if (child2.getVisibility() != i) {
                        ...
                        if (!canSlide || child2 == this.mSlideableView) {
                        ...
                        } else if (((ViewGroup.LayoutParams) lp2).width < 0) {
                            ...
                            if (skippedFirstPass) {
                                childCount = childCount2;
                                if (((ViewGroup.LayoutParams) lp2).height == -2) {
                                    ...
                                    i2 = 1073741824;
                                    childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(((ViewGroup.LayoutParams) lp2).height, 1073741824);
                                }
                            } else {
                                childCount = childCount2;
                                i2 = 1073741824;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        while (xStart3 < childCount) {
            ...
            if (child.getVisibility() == 8) {
                ...
                int offset = 0;
                if (lp.slideable) {
                    int margin = ((ViewGroup.MarginLayoutParams) lp).leftMargin + ((ViewGroup.MarginLayoutParams) lp).rightMargin;
                    int range = (Math.min(nextXStart, (width - paddingEnd) - this.mOverhangSize) - xStart2) - margin;
                    this.mSlideRange = range;
                    int lpMargin = isLayoutRtl ? ((ViewGroup.MarginLayoutParams) lp).rightMargin : ((ViewGroup.MarginLayoutParams) lp).leftMargin;
                    paddingStart = paddingStart2;
    ...
    boolean smoothSlideTo(float slideOffset, int velocity) {
        ...
        LayoutParams lp = (LayoutParams) this.mSlideableView.getLayoutParams();
        if (isLayoutRtl) {
            int startBound2 = getPaddingRight() + ((ViewGroup.MarginLayoutParams) lp).rightMargin;
            int childWidth = this.mSlideableView.getWidth();
            startBound = (int) (getWidth() - ((startBound2 + (this.mSlideRange * slideOffset)) + childWidth));
        } else {
            int x = getPaddingLeft();
            int startBound3 = x + ((ViewGroup.MarginLayoutParams) lp).leftMargin;
    ...
    private void parallaxOtherViews(float slideOffset) {
        ...
        if (!slideLp.dimWhenOffset) {
            dimViews = false;
        } else if ((isLayoutRtl ? ((ViewGroup.MarginLayoutParams) slideLp).rightMargin : ((ViewGroup.MarginLayoutParams) slideLp).leftMargin) <= 0) {
            dimViews = true;
        }
        int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (SlidingPaneLayout.this.isLayoutRtlSupport()) {
                int startToRight = SlidingPaneLayout.this.getPaddingRight() + ((ViewGroup.MarginLayoutParams) lp).rightMargin;
                ...
                int left2 = SlidingPaneLayout.this.getPaddingLeft() + ((ViewGroup.MarginLayoutParams) lp).leftMargin;
                if (xvel > 0.0f || (xvel == 0.0f && SlidingPaneLayout.this.mSlideOffset > 0.5f)) {
        ...
        public int clampViewPositionHorizontal(View child, int left, int dx) {
            ...
            if (SlidingPaneLayout.this.isLayoutRtlSupport()) {
                int startBound = SlidingPaneLayout.this.getWidth() - ((SlidingPaneLayout.this.getPaddingRight() + ((ViewGroup.MarginLayoutParams) lp).rightMargin) + SlidingPaneLayout.this.mSlideableView.getWidth());
                int endBound = startBound - SlidingPaneLayout.this.mSlideRange;
                return Math.max(Math.min(left, startBound), endBound);
            }
            int startBound2 = SlidingPaneLayout.this.getPaddingLeft() + ((ViewGroup.MarginLayoutParams) lp).leftMargin;
