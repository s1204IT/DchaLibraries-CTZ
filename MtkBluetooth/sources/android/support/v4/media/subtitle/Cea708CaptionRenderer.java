        ...
        class ScaledLayout extends ViewGroup {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                while (i < count) {
                    ...
                    float scaleStartRow = layoutParams.scaleStartRow;
                    float scaleEndRow = layoutParams.scaleEndRow;
                    float scaleStartCol = layoutParams.scaleStartCol;
                    float scaleEndCol = layoutParams.scaleEndCol;
