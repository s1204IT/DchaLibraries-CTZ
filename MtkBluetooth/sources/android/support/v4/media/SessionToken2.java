...
public final class SessionToken2 {
    ...
    public boolean equals(Object obj) {
        ...
        return this.mImpl.equals(obj.mImpl);
    }
    ...
    private static String getSessionIdFromService(PackageManager manager, String serviceInterface, ComponentName serviceComponent) {
        ...
        if (list != null) {
            for (int i = 0; i < list.size(); i++) {
                ...
                if (resolveInfo != null && resolveInfo.serviceInfo != null && TextUtils.equals(((PackageItemInfo) resolveInfo.serviceInfo).name, serviceComponent.getClassName())) {
