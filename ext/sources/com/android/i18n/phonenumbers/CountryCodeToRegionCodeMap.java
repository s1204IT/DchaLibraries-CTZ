...
public class CountryCodeToRegionCodeMap {
    static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList125.add("UA");
        map.put(Integer.valueOf(Response.ALTERNATIVE_SERVICE), arrayList125);
        ...
        arrayList132.add("CZ");
        map.put(Integer.valueOf(Response.BAD_EXTENSION), arrayList132);
        ArrayList arrayList133 = new ArrayList(1);
        arrayList133.add("SK");
        map.put(Integer.valueOf(Response.EXTENSION_REQUIRED), arrayList133);
        ArrayList arrayList134 = new ArrayList(1);
        arrayList134.add("LI");
        map.put(Integer.valueOf(Response.INTERVAL_TOO_BRIEF), arrayList134);
        ArrayList arrayList135 = new ArrayList(1);
        arrayList135.add("FK");
        map.put(500, arrayList135);
        ArrayList arrayList136 = new ArrayList(1);
        arrayList136.add("BZ");
        map.put(Integer.valueOf(Response.NOT_IMPLEMENTED), arrayList136);
        ArrayList arrayList137 = new ArrayList(1);
        arrayList137.add("GT");
        map.put(Integer.valueOf(Response.BAD_GATEWAY), arrayList137);
        ArrayList arrayList138 = new ArrayList(1);
        arrayList138.add("SV");
        map.put(Integer.valueOf(Response.SERVICE_UNAVAILABLE), arrayList138);
        ArrayList arrayList139 = new ArrayList(1);
        arrayList139.add("HN");
        map.put(Integer.valueOf(Response.SERVER_TIMEOUT), arrayList139);
        ArrayList arrayList140 = new ArrayList(1);
        arrayList140.add("NI");
        map.put(Integer.valueOf(Response.VERSION_NOT_SUPPORTED), arrayList140);
