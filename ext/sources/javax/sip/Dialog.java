...
public interface Dialog extends Serializable {
    Request createAck(long j) throws SipException;

    Request createPrack(Response response) throws SipException;

    Response createReliableProvisionalResponse(int i) throws SipException;
    ...
    void sendRequest(ClientTransaction clientTransaction) throws SipException;
