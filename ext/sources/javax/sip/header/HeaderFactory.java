...
public interface HeaderFactory {
    ...
    CSeqHeader createCSeqHeader(int i, String str) throws InvalidArgumentException, ParseException;

    CSeqHeader createCSeqHeader(long j, String str) throws InvalidArgumentException, ParseException;
