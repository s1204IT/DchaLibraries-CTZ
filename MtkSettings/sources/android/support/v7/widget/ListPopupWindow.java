...
public class ListPopupWindow implements ShowableListMenu {
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            if (view != null) {
                ...
                if (this.mDropDownWidth >= 0) {
                    i2 = AccessPoint.UNREACHABLE_RSSI;
        ...
        switch (this.mDropDownWidth) {
            case -2:
                iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), AccessPoint.UNREACHABLE_RSSI);
                break;
            case -1:
