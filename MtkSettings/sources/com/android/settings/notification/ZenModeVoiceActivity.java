...
public class ZenModeVoiceActivity extends VoiceSettingsActivity {
    ...
    private CharSequence getChangeSummary(int i, int i2) {
        ...
        CharSequence charSequence = DateFormat.format(DateFormat.getBestDateTimePattern(Locale.getDefault(), DateFormat.is24HourFormat(this, UserHandle.myUserId()) ? "Hm" : "hma"), System.currentTimeMillis() + ((long) (60000 * i2)));
