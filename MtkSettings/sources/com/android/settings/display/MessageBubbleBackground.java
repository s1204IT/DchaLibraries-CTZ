...
public class MessageBubbleBackground extends LinearLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i) - paddingLeft, (int) (Math.ceil((getMeasuredWidth() - paddingLeft) / this.mSnapWidthPixels) * ((double) this.mSnapWidthPixels))) + paddingLeft, 1073741824), i2);
    }
}
