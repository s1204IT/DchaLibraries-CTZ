...
public interface ISupplicantStaIfaceCallback extends IBase {
    ...
    public static final class Proxy implements ISupplicantStaIfaceCallback {
        ...
        @Override
        public void onEssDisassocImminentNotice(byte[] bArr, int i, int i2, String str) throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantStaIfaceCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{52, -91, -95, 59, -69, -15, -44, 47, 47, 124, 107, -76, 72, -54, 99, 25, 123, 46, -108, 102, -83, 0, 122, -82, -18, 89, 117, -32, 86, -42, -72, -91}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }
            ...
            switch (i) {
                case 1:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
                        ...
                        onEssDisassocImminentNotice(bArr, hwParcel.readInt32(), hwParcel.readInt32(), hwParcel.readString());
                    }
                    break;
                case 256067662:
                    if ((i2 & 1) != 0) {
