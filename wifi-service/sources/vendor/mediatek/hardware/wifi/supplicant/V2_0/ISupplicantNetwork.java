...
public interface ISupplicantNetwork extends IBase {
    ...
    static ISupplicantNetwork asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface iHwInterfaceQueryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof ISupplicantNetwork)) {
            return (ISupplicantNetwork) iHwInterfaceQueryLocalInterface;
        }
    ...
    static ISupplicantNetwork castFrom(IHwInterface iHwInterface) {
    ...
    static ISupplicantNetwork getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static ISupplicantNetwork getService(boolean z) throws RemoteException {
        return getService(HalDeviceManager.HAL_INSTANCE_NAME, z);
    }

    static ISupplicantNetwork getService(String str) throws RemoteException {
    ...
    public static final class Proxy implements ISupplicantNetwork {
        ...
        @Override
        public void getInterfaceName(getInterfaceNameCallback getinterfacenamecallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(ISupplicantNetwork.kInterfaceName);
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantNetwork {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-62, 67, 11, -90, -19, -102, 81, 62, -120, WifiLoggerHal.WIFI_ALERT_REASON_MAX, 40, -49, -24, -54, 59, 75, 93, 9, -45, 101, 113, 23, -121, 44, 1, -54, 48, -76, -90, 120, 9, 75}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (ISupplicantNetwork.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
