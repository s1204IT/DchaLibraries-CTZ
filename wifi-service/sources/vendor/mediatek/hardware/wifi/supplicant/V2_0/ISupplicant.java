...
public interface ISupplicant extends IBase {
    ...
    public static final class Proxy implements ISupplicant {
        ...
        @Override
        public void getInterface(ISupplicant.IfaceInfo ifaceInfo, getInterfaceCallback getinterfacecallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(ISupplicant.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements ISupplicant {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-106, -81, 35, -52, 113, 114, -118, 123, -112, 2, 34, -39, -124, -128, -33, -34, 2, 84, -20, -10, -105, 10, -22, 54, 6, -37, -8, 38, 22, 116, -21, -30}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }
