...
public class RttService extends SystemService {
    ...
    public void onBootPhase(int i) {
        if (i == 500) {
            ...
            HandlerThread rttHandlerThread = wifiInjector.getRttHandlerThread();
            ...
            this.mImpl.start(rttHandlerThread.getLooper(), wifiInjector.getClock(), ServiceManager.getService("wifiaware"), new RttNative(this.mImpl, halDeviceManager), rttMetrics, wifiPermissionsUtil, wifiInjector.getFrameworkFacade());
        }
    }
}
