...
public interface WifiNvRamAgent extends IInterface {
    ...
    public static abstract class Stub extends Binder implements WifiNvRamAgent {
        ...
        public static WifiNvRamAgent asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof WifiNvRamAgent)) {
                return (WifiNvRamAgent) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    byte[] file = readFile(parcel.readInt());
                    parcel2.writeNoException();
                    parcel2.writeByteArray(file);
                    return true;
                case 2:
                    parcel.enforceInterface(DESCRIPTOR);
                    int iWriteFile = writeFile(parcel.readInt(), parcel.createByteArray());
                    parcel2.writeNoException();
                    parcel2.writeInt(iWriteFile);
                    return true;
                default:
        ...
        private static class Proxy implements WifiNvRamAgent {
            ...
            @Override
            public byte[] readFileByName(String str) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override
            public int writeFileByName(String str, byte[] bArr) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
