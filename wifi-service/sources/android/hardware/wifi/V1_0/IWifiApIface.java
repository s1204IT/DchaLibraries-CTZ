...
public interface IWifiApIface extends IWifiIface {
    ...
    static IWifiApIface asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface iHwInterfaceQueryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IWifiApIface)) {
            return (IWifiApIface) iHwInterfaceQueryLocalInterface;
        }
    ...
    static IWifiApIface castFrom(IHwInterface iHwInterface) {
    ...
    static IWifiApIface getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static IWifiApIface getService(boolean z) throws RemoteException {
        return getService(HalDeviceManager.HAL_INSTANCE_NAME, z);
    }

    static IWifiApIface getService(String str) throws RemoteException {
    ...
    public static final class Proxy implements IWifiApIface {
        ...
        public WifiStatus setCountryCode(byte[] bArr) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IWifiApIface.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IWifiApIface {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (IWifiApIface.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
            ...
            switch (i) {
                ...
                case 3:
                    if ((i2 & 1) != 0) {
                        ...
                        hwParcel.enforceInterface(IWifiApIface.kInterfaceName);
                        byte[] bArr = new byte[2];
                        hwParcel.readBuffer(2L).copyToInt8Array(0L, bArr, 2);
                        WifiStatus countryCode = setCountryCode(bArr);
                        hwParcel2.writeStatus(0);
