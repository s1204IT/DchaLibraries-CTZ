...
public interface IWifiNanIface extends IWifiIface {
    ...
    public static final class Proxy implements IWifiNanIface {
        ...
        @Override
        public WifiStatus registerEventCallback(IWifiNanIfaceEventCallback iWifiNanIfaceEventCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            ...
            switch (i) {
                ...
                case 3:
                    if ((i2 & 1) != 0) {
                        ...
                        WifiStatus wifiStatusRegisterEventCallback = registerEventCallback(IWifiNanIfaceEventCallback.asInterface(hwParcel.readStrongBinder()));
                        hwParcel2.writeStatus(0);
