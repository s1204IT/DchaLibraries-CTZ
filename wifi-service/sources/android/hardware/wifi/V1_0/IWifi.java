...
public interface IWifi extends IBase {
    ...
    public static final class Proxy implements IWifi {
        ...
        public WifiStatus registerEventCallback(IWifiEventCallback iWifiEventCallback) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(IWifi.kInterfaceName);
        ...
        @Override
        public void getChipIds(getChipIdsCallback getchipidscallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IWifi.kInterfaceName);
            HwParcel hwParcel2 = new HwParcel();
            try {
        ...
        @Override
        public void getChip(int i, getChipCallback getchipcallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IWifi.kInterfaceName);
            ...
            try {
                ...
                WifiStatus wifiStatus = new WifiStatus();
                wifiStatus.readFromParcel(hwParcel2);
                getchipcallback.onValues(wifiStatus, IWifiChip.asInterface(hwParcel2.readStrongBinder()));
            } finally {
                hwParcel2.release();
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IWifi {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-71, -66, 54, 113, -102, -118, -43, 52, 0, 10, 81, -22, 7, -66, -111, -66, -108, -60, 5, -65, 30, 3, -118, -24, 37, -84, -10, 80, -121, -1, -45, 120}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }
            ...
            switch (i) {
                case 1:
                    if ((i2 & 1) != 0) {
                        ...
                        hwParcel.enforceInterface(IWifi.kInterfaceName);
                ...
                case 6:
                    if (((i2 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        hwParcel.enforceInterface(IWifi.kInterfaceName);
                        getChip(hwParcel.readInt32(), new getChipCallback() {
                            @Override
                            public void onValues(WifiStatus wifiStatus, IWifiChip iWifiChip) {
                                hwParcel2.writeStatus(0);
                                wifiStatus.writeToParcel(hwParcel2);
