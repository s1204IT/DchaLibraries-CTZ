...
public final class NanFollowupReceivedInd {
    ...
    public static final ArrayList<NanFollowupReceivedInd> readVectorFromParcel(HwParcel hwParcel) {
        ArrayList<NanFollowupReceivedInd> arrayList = new ArrayList<>();
        ...
        for (int i = 0; i < int32; i++) {
            ...
            nanFollowupReceivedInd.readEmbeddedFromParcel(hwParcel, embeddedBuffer, i * 48);
            arrayList.add(nanFollowupReceivedInd);
        }
        return arrayList;
    }
    ...
    public static final void writeVectorToParcel(HwParcel hwParcel, ArrayList<NanFollowupReceivedInd> arrayList) {
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        ...
        hwBlob.putBool(j + 14, this.receivedInFaw);
