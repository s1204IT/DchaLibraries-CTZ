...
public interface IWifiChipEventCallback extends android.hardware.wifi.V1_0.IWifiChipEventCallback {
    ...
    static IWifiChipEventCallback asInterface(IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        IHwInterface iHwInterfaceQueryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IWifiChipEventCallback)) {
            return (IWifiChipEventCallback) iHwInterfaceQueryLocalInterface;
        }
    ...
    static IWifiChipEventCallback castFrom(IHwInterface iHwInterface) {
    ...
    static IWifiChipEventCallback getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, str, z));
    }

    static IWifiChipEventCallback getService(boolean z) throws RemoteException {
        return getService(HalDeviceManager.HAL_INSTANCE_NAME, z);
    }

    static IWifiChipEventCallback getService(String str) throws RemoteException {
    ...
    public static final class IfaceInfo {
        ...
        public final boolean equals(Object obj) {
            ...
            if (HidlSupport.deepEquals(this.name, ifaceInfo.name) && this.channel == ifaceInfo.channel) {
                return true;
            }
            return false;
        }
    ...
    public static final class RadioModeInfo {
        ...
        public final boolean equals(Object obj) {
            ...
            if (this.radioId == radioModeInfo.radioId && this.bandInfo == radioModeInfo.bandInfo && HidlSupport.deepEquals(this.ifaceInfos, radioModeInfo.ifaceInfos)) {
                return true;
            }
            return false;
        }
        ...
        public static final ArrayList<RadioModeInfo> readVectorFromParcel(HwParcel hwParcel) {
            ArrayList<RadioModeInfo> arrayList = new ArrayList<>();
            HwBlob buffer = hwParcel.readBuffer(16L);
            int int32 = buffer.getInt32(8L);
            HwBlob embeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 24, buffer.handle(), 0L, true);
            arrayList.clear();
            for (int i = 0; i < int32; i++) {
                ...
                radioModeInfo.readEmbeddedFromParcel(hwParcel, embeddedBuffer, i * 24);
        ...
        public static final void writeVectorToParcel(HwParcel hwParcel, ArrayList<RadioModeInfo> arrayList) {
            HwBlob hwBlob = new HwBlob(16);
            int size = arrayList.size();
            hwBlob.putInt32(8L, size);
            hwBlob.putBool(12L, false);
        ...
        public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
            hwBlob.putInt32(j + 0, this.radioId);
            hwBlob.putInt32(4 + j, this.bandInfo);
            int size = this.ifaceInfos.size();
            long j2 = j + 8;
            hwBlob.putInt32(8 + j2, size);
            hwBlob.putBool(12 + j2, false);
            HwBlob hwBlob2 = new HwBlob(size * 24);
            for (int i = 0; i < size; i++) {
                this.ifaceInfos.get(i).writeEmbeddedToBlob(hwBlob2, i * 24);
            }
    ...
    public static final class Proxy implements IWifiChipEventCallback {
        ...
        public void onChipReconfigured(int i) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(android.hardware.wifi.V1_0.IWifiChipEventCallback.kInterfaceName);
        ...
        public void onChipReconfigureFailure(WifiStatus wifiStatus) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.wifi.V1_0.IWifiChipEventCallback.kInterfaceName);
            wifiStatus.writeToParcel(hwParcel);
            HwParcel hwParcel2 = new HwParcel();
            try {
        ...
        public void onDebugRingBufferDataAvailable(WifiDebugRingBufferStatus wifiDebugRingBufferStatus, ArrayList<Byte> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.wifi.V1_0.IWifiChipEventCallback.kInterfaceName);
            wifiDebugRingBufferStatus.writeToParcel(hwParcel);
        ...
        @Override
        public void onRadioModeChange(ArrayList<RadioModeInfo> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IWifiChipEventCallback.kInterfaceName);
            RadioModeInfo.writeVectorToParcel(hwParcel, arrayList);
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IWifiChipEventCallback {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (IWifiChipEventCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
            ...
            switch (i) {
                case 1:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
                        ...
                        hwParcel.enforceInterface(android.hardware.wifi.V1_0.IWifiChipEventCallback.kInterfaceName);
                ...
                case 7:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
                        ...
                        hwParcel.enforceInterface(IWifiChipEventCallback.kInterfaceName);
