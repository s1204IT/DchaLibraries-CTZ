...
public interface IWifiNanIfaceEventCallback extends android.hardware.wifi.V1_0.IWifiNanIfaceEventCallback {
    ...
    public static final class Proxy implements IWifiNanIfaceEventCallback {
        ...
        public void notifyCapabilitiesResponse(short s, WifiNanStatus wifiNanStatus, NanCapabilities nanCapabilities) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(android.hardware.wifi.V1_0.IWifiNanIfaceEventCallback.kInterfaceName);
        ...
        @Override
        public void eventDataPathConfirm(android.hardware.wifi.V1_0.NanDataPathConfirmInd nanDataPathConfirmInd) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.wifi.V1_0.IWifiNanIfaceEventCallback.kInterfaceName);
        ...
        @Override
        public void eventDataPathConfirm_1_2(NanDataPathConfirmInd nanDataPathConfirmInd) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IWifiNanIfaceEventCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{30, 96, 116, -17, -83, -99, -93, 51, -128, 63, -73, -63, -84, -37, 113, -99, 81, -61, 11, 46, 30, -110, 8, 123, 4, 32, 52, 22, 49, -61, 11, 96}, new byte[]{50, 92, -108, -13, -31, -91, 101, -75, 107, -68, 116, -6, -35, -67, 11, -89, -53, -126, 79, 38, 61, -52, -7, -33, -1, 45, -81, 98, -72, 110, -41, 116}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }
            ...
            switch (i) {
                case 1:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
                        ...
                        hwParcel.enforceInterface(android.hardware.wifi.V1_0.IWifiNanIfaceEventCallback.kInterfaceName);
                ...
                case 24:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
                        ...
                        hwParcel.enforceInterface(android.hardware.wifi.V1_0.IWifiNanIfaceEventCallback.kInterfaceName);
                        android.hardware.wifi.V1_0.NanDataPathConfirmInd nanDataPathConfirmInd = new android.hardware.wifi.V1_0.NanDataPathConfirmInd();
                ...
                case ISupplicantStaIfaceCallback.ReasonCode.TDLS_TEARDOWN_UNSPECIFIED:
                    if (((i2 & 1) != 0 ? 1 : 0) != 1) {
                        ...
                        NanDataPathConfirmInd nanDataPathConfirmInd2 = new NanDataPathConfirmInd();
