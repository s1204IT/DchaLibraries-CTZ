...
public interface IWifiChip extends android.hardware.wifi.V1_1.IWifiChip {
    ...
    public static final class Proxy implements IWifiChip {
        ...
        @Override
        public WifiStatus registerEventCallback(android.hardware.wifi.V1_0.IWifiChipEventCallback iWifiChipEventCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.wifi.V1_0.IWifiChip.kInterfaceName);
        ...
        public void createNanIface(IWifiChip.createNanIfaceCallback createnanifacecallback) throws RemoteException {
            ...
            try {
                ...
                WifiStatus wifiStatus = new WifiStatus();
                wifiStatus.readFromParcel(hwParcel2);
                createnanifacecallback.onValues(wifiStatus, android.hardware.wifi.V1_0.IWifiNanIface.asInterface(hwParcel2.readStrongBinder()));
            } finally {
                hwParcel2.release();
            }
        }
        ...
        public void getNanIface(String str, IWifiChip.getNanIfaceCallback getnanifacecallback) throws RemoteException {
            ...
            try {
                ...
                WifiStatus wifiStatus = new WifiStatus();
                wifiStatus.readFromParcel(hwParcel2);
                getnanifacecallback.onValues(wifiStatus, android.hardware.wifi.V1_0.IWifiNanIface.asInterface(hwParcel2.readStrongBinder()));
            } finally {
                hwParcel2.release();
            }
        }
        ...
        public void createStaIface(IWifiChip.createStaIfaceCallback createstaifacecallback) throws RemoteException {
            ...
            try {
                ...
                WifiStatus wifiStatus = new WifiStatus();
                wifiStatus.readFromParcel(hwParcel2);
                createstaifacecallback.onValues(wifiStatus, android.hardware.wifi.V1_0.IWifiStaIface.asInterface(hwParcel2.readStrongBinder()));
            } finally {
                hwParcel2.release();
            }
        }
        ...
        public void getStaIface(String str, IWifiChip.getStaIfaceCallback getstaifacecallback) throws RemoteException {
            ...
            try {
                ...
                WifiStatus wifiStatus = new WifiStatus();
                wifiStatus.readFromParcel(hwParcel2);
                getstaifacecallback.onValues(wifiStatus, android.hardware.wifi.V1_0.IWifiStaIface.asInterface(hwParcel2.readStrongBinder()));
            } finally {
                hwParcel2.release();
            }
        }
        ...
        public WifiStatus selectTxPowerScenario(int i) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.wifi.V1_1.IWifiChip.kInterfaceName);
            hwParcel.writeInt32(i);
            HwParcel hwParcel2 = new HwParcel();
            try {
            ...
            switch (i) {
                ...
                case 2:
                    if ((i2 & 1) != 0) {
                        ...
                        hwParcel.enforceInterface(android.hardware.wifi.V1_0.IWifiChip.kInterfaceName);
                        WifiStatus wifiStatusRegisterEventCallback = registerEventCallback(android.hardware.wifi.V1_0.IWifiChipEventCallback.asInterface(hwParcel.readStrongBinder()));
                        hwParcel2.writeStatus(0);
                ...
                case 14:
                    if (((i2 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        createNanIface(new IWifiChip.createNanIfaceCallback() {
                            @Override
                            public void onValues(WifiStatus wifiStatus, android.hardware.wifi.V1_0.IWifiNanIface iWifiNanIface) {
                                hwParcel2.writeStatus(0);
                                wifiStatus.writeToParcel(hwParcel2);
                ...
                case 22:
                    if (((i2 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        createStaIface(new IWifiChip.createStaIfaceCallback() {
                            @Override
                            public void onValues(WifiStatus wifiStatus, android.hardware.wifi.V1_0.IWifiStaIface iWifiStaIface) {
                                hwParcel2.writeStatus(0);
                                wifiStatus.writeToParcel(hwParcel2);
                ...
                case 33:
                    if ((i2 & 1) != 0) {
                        ...
                        hwParcel.enforceInterface(android.hardware.wifi.V1_1.IWifiChip.kInterfaceName);
                ...
                case 35:
                    if ((i2 & 1) != 0) {
                        ...
                        WifiStatus wifiStatusSelectTxPowerScenario_1_2 = selectTxPowerScenario_1_2(hwParcel.readInt32());
                        hwParcel2.writeStatus(0);
                        wifiStatusSelectTxPowerScenario_1_2.writeToParcel(hwParcel2);
                        hwParcel2.send();
                    }
                    break;
                case ISupplicantStaIfaceCallback.ReasonCode.STA_LEAVING:
                    if ((i2 & 1) != 0) {
                        ...
                        hwParcel.enforceInterface(IWifiChip.kInterfaceName);
                        WifiStatus wifiStatusRegisterEventCallback_1_2 = registerEventCallback_1_2(IWifiChipEventCallback.asInterface(hwParcel.readStrongBinder()));
                        hwParcel2.writeStatus(0);
