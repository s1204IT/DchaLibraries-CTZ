...
public final class Character implements Serializable, Comparable<Character> {
    ...
    public enum UnicodeScript {
        ...
        public static UnicodeScript of(int i) {
            ...
            int iBinarySearch = Arrays.binarySearch(scriptStarts, i);
            if (iBinarySearch < 0) {
    ...
    public static int codePointAt(CharSequence charSequence, int i) {
        ...
        if (isHighSurrogate(cCharAt) && (i2 = i + 1) < charSequence.length()) {
    ...
    public static byte getDirectionality(int i) {
        ...
        if (getType(i) != 0 && (directionalityImpl = getDirectionalityImpl(i)) >= 0 && directionalityImpl < DIRECTIONALITY.length) {
            return DIRECTIONALITY[directionalityImpl];
        }
        return (byte) -1;
    }
    ...
    public static String getName(int i) {
        ...
        UnicodeBlock unicodeBlockOf = UnicodeBlock.of(i);
        if (unicodeBlockOf != null) {
            return unicodeBlockOf.toString().replace('_', ' ') + " " + Integer.toHexString(i).toUpperCase(Locale.ENGLISH);
        }
