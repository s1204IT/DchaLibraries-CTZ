...
class ByteBufferAsFloatBuffer extends FloatBuffer {
    ...
    public FloatBuffer slice() {
        ...
        return new ByteBufferAsFloatBuffer(this.bb, -1, 0, i, i, (iPosition << 2) + this.offset, this.order);
    }
    ...
    public FloatBuffer get(float[] fArr, int i, int i2) {
        ...
        this.bb.getUnchecked(ix(this.position), fArr, i, i2);
        this.position += i2;
        return this;
    }
    ...
    public FloatBuffer put(int i, float f) {
        ...
        this.bb.putFloatUnchecked(ix(checkIndex(i)), f);
        return this;
    }
    ...
    public FloatBuffer put(float[] fArr, int i, int i2) {
        ...
        this.bb.putUnchecked(ix(this.position), fArr, i, i2);
        this.position += i2;
        return this;
    }
