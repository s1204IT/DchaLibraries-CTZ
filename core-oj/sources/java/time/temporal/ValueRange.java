...
public final class ValueRange implements Serializable {
    ...
    private String genInvalidFieldMessage(TemporalField temporalField, long j) {
        if (temporalField != null) {
            return "Invalid value for " + ((Object) temporalField) + " (valid values " + ((Object) this) + "): " + j;
        }
        return "Invalid value (valid values " + ((Object) this) + "): " + j;
    }
    ...
    public int hashCode() {
        long j = ((((((this.minSmallest + this.minLargest) << ((int) (16 + this.minLargest))) >> ((int) (this.maxSmallest + 48))) << ((int) (this.maxSmallest + 32))) >> ((int) (32 + this.maxLargest))) << ((int) (48 + this.maxLargest))) >> 16;
        return (int) (j ^ (j >>> 32));
    }
