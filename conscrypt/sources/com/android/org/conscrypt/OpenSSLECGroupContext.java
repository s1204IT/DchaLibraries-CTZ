...
final class OpenSSLECGroupContext {
    ...
    static OpenSSLECGroupContext getInstance(ECParameterSpec eCParameterSpec) throws InvalidAlgorithmParameterException {
        ...
        if (field instanceof ECFieldFp) {
            ...
            try {
                long jEC_GROUP_new_arbitrary = NativeCrypto.EC_GROUP_new_arbitrary(p.toByteArray(), curve.getA().toByteArray(), b.toByteArray(), affineX.toByteArray(), affineY.toByteArray(), eCParameterSpec.getOrder().toByteArray(), eCParameterSpec.getCofactor());
