...
public class CaptureSurface {
    ...
    public boolean updatePictureInfo(int i) {
        return updatePictureInfo(this.mPictureWidth, this.mPictureHeight, i, this.mMaxImages);
    }
    ...
    private byte[] getBuffer(Image image) {
        ...
        synchronized (this.mImageReaderSync) {
            ...
            if ("heif".equalsIgnoreCase(this.mFormatTag)) {
                yUVBuffer = HeifHelper.getYUVBuffer(image);
            } else if ("jpeg".equalsIgnoreCase(this.mFormatTag)) {
