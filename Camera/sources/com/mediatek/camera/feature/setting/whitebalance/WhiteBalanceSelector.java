...
public class WhiteBalanceSelector extends PreferenceFragment {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(WhiteBalanceSelector.class.getSimpleName());
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (toolbar != null) {
            toolbar.setTitle(getActivity().getResources().getString(R.string.pref_camera_whitebalance_title));
        }
    ...
    private class MyOnPreferenceClickListener implements Preference.OnPreferenceClickListener {
        ...
        public boolean onPreferenceClick(Preference preference) {
            String str = (String) WhiteBalanceSelector.this.mEntryValues.get(WhiteBalanceSelector.this.mEntries.indexOf((String) preference.getTitle()));
            WhiteBalanceSelector.this.mListener.onItemClick(str);
            WhiteBalanceSelector.this.mSelectedValue = str;
            WhiteBalanceSelector.this.getActivity().getFragmentManager().popBackStack();
            return true;
        }
    }
}
