...
public class SceneModeSettingView implements ICameraSettingView, SceneModeSelector.OnItemClickListener {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(SceneModeSettingView.class.getSimpleName());
    ...
    public SceneModeSettingView(Activity activity, String str) {
        ...
        this.mKey = str;
        String[] stringArray = this.mActivity.getResources().getStringArray(R.array.scene_mode_entries);
        String[] stringArray2 = this.mActivity.getResources().getStringArray(R.array.scene_mode_entryvalues);
        TypedArray typedArrayObtainTypedArray = this.mActivity.getResources().obtainTypedArray(R.array.scene_mode_icons);
    ...
    public void loadView(PreferenceFragment preferenceFragment) {
        if (this.mSceneModeSelector == null) {
            this.mSceneModeSelector = new SceneModeSelector();
            this.mSceneModeSelector.setOnItemClickListener(this);
        }
        ...
        this.mPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(android.preference.Preference preference) {
                ...
                FragmentTransaction fragmentTransactionBeginTransaction = SceneModeSettingView.this.mActivity.getFragmentManager().beginTransaction();
                fragmentTransactionBeginTransaction.addToBackStack(null);
                fragmentTransactionBeginTransaction.replace(R.id.setting_container, SceneModeSettingView.this.mSceneModeSelector, "picture_size_selector").commit();
                return true;
            }
        });
    ...
    public void setEntryValues(List<String> list) {
        ...
        if (list.size() == 1 && "hdr".equals(list.get(0))) {
            ...
            int iIndexOf = this.mOriginalEntryValues.indexOf("off");
            this.mEntries.add(this.mOriginalEntries.get(iIndexOf));
            this.mIcons.add(this.mOriginalIcons.get(iIndexOf));
            return;
        }
    ...
    public void setValue(String str) {
        ...
        if ("hdr".equals(this.mSelectedValue)) {
