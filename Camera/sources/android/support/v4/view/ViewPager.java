...
public class ViewPager extends ViewGroup {
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (this.mAdapter != null) {
            ...
            setCurrentItemInternal(parcelable.position, false, true);
        } else {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (childWidthSize3 < size) {
            ...
            if (child.getVisibility() == 8 || (lp2 = (LayoutParams) child.getLayoutParams()) == null || !lp2.isDecor) {
                ...
                measuredWidth = measuredWidth2;
                if (((ViewGroup.LayoutParams) lp2).width != -2) {
                    widthMode = 1073741824;
                    if (((ViewGroup.LayoutParams) lp2).width != -1) {
                    ...
                    if (((ViewGroup.LayoutParams) lp2).height != -2) {
                        heightMode2 = 1073741824;
                        if (((ViewGroup.LayoutParams) lp2).height != -1) {
    ...
    private Rect getChildRectInPagerCoordinates(Rect outRect, View child) {
        ...
        while ((parent instanceof ViewGroup) && parent != this) {
            ?? r1 = parent;
            outRect.left += r1.getLeft();
            outRect.right += r1.getRight();
            outRect.top += r1.getTop();
            outRect.bottom += r1.getBottom();
            parent = r1.getParent();
        }
        return outRect;
    }
