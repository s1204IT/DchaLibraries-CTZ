...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    @Override
    public boolean getPadding(Rect x0) {
    ...
    @Override
    public void setChangingConfigurations(int x0) {
        super.setChangingConfigurations(x0);
    }

    @Override
    public void setColorFilter(int x0, PorterDuff.Mode x1) {
        super.setColorFilter(x0, x1);
    }

    @Override
    public void setFilterBitmap(boolean x0) {
        super.setFilterBitmap(x0);
    }

    @Override
    public void setHotspot(float x0, float x1) {
        super.setHotspot(x0, x1);
    }

    @Override
    public void setHotspotBounds(int x0, int x1, int x2, int x3) {
        super.setHotspotBounds(x0, x1, x2, x3);
    }

    @Override
    public boolean setState(int[] x0) {
    ...
    private void setupColorAnimator(Animator animator) {
        ...
        if ((animator instanceof AnimatorSet) && (childAnimators = animator.getChildAnimations()) != null) {
        ...
        if (animator instanceof ObjectAnimator) {
            ...
            if ("fillColor".equals(propertyName) || "strokeColor".equals(propertyName)) {
                ...
                animator.setEvaluator(this.mArgbEvaluator);
            }
        }
    }
