...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (true) {
            ...
            if (child.getVisibility() == 8) {
                ...
                lp.cellsUsed = r13;
                lp.expandable = r13;
                ((ViewGroup.MarginLayoutParams) lp).leftMargin = r13;
                ((ViewGroup.MarginLayoutParams) lp).rightMargin = r13;
    ...
    static int measureChildForCells(View child, int cellSize, int cellsRemaining, int parentHeightMeasureSpec, int parentHeightPadding) {
        ...
        ActionMenuItemView actionMenuItemView = child instanceof ActionMenuItemView ? child : 0;
        boolean expandable = false;
        boolean hasText = actionMenuItemView != 0 && actionMenuItemView.hasText();
        int cellsUsed = 0;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (!isLayoutRtl3) {
            ...
            while (i < childCount) {
                ...
                if (v3.getVisibility() != 8 && !lp.isOverflowButton) {
                    int startLeft2 = startLeft + ((ViewGroup.MarginLayoutParams) lp).leftMargin;
                    ...
                    startLeft = startLeft2 + ((ViewGroup.MarginLayoutParams) lp).rightMargin + width2 + spacerSize;
                }
                i++;
            }
            return;
        ...
        while (i < childCount) {
            ...
            if (v4.getVisibility() == 8) {
                ...
                int startRight2 = startRight - ((ViewGroup.MarginLayoutParams) lp2).rightMargin;
                ...
                startRight = startRight2 - ((((ViewGroup.MarginLayoutParams) lp2).leftMargin + width3) + spacerSize);
            }
            i++;
    ...
    protected LayoutParams generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        if (layoutParams != 0) {
            LayoutParams result = layoutParams instanceof LayoutParams ? new LayoutParams((LayoutParams) layoutParams) : new LayoutParams(layoutParams);
            if (result.gravity <= 0) {
                result.gravity = 16;
            }
            return result;
