...
public class LinearLayoutCompat extends ViewGroup {
    ...
    void drawDividersVertical(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child != null && child.getVisibility() != 8 && hasDividerBeforeChildAt(i)) {
                ...
                int top = (child.getTop() - ((ViewGroup.MarginLayoutParams) lp).topMargin) - this.mDividerHeight;
    ...
    void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child != null && child.getVisibility() != 8 && hasDividerBeforeChildAt(i)) {
                ...
                if (isLayoutRtl) {
                    ...
                    position2 = (position3 - ((ViewGroup.MarginLayoutParams) lp).leftMargin) - this.mDividerWidth;
                }
        ...
        if (hasDividerBeforeChildAt(count)) {
            ...
            if (child2 == null) {
                ...
                LayoutParams lp2 = (LayoutParams) child2.getLayoutParams();
                if (isLayoutRtl) {
                    int position5 = (child2.getLeft() - ((ViewGroup.MarginLayoutParams) lp2).leftMargin) - this.mDividerWidth;
                    position = position5;
                } else {
                    int position6 = child2.getRight();
                    position = position6 + ((ViewGroup.MarginLayoutParams) lp2).rightMargin;
                }
            }
            ...
            if (maxWidth2 < count3) {
                ...
                if (child2 == null) {
                    ...
                    if (childState6 == 8) {
                        ...
                        if (heightMode4 == 1073741824 && ((ViewGroup.LayoutParams) lp2).height == 0 && lp2.weight > 0.0f) {
                            int totalLength = this.mTotalLength;
                            int i8 = ((ViewGroup.MarginLayoutParams) lp2).topMargin + totalLength;
                            int i9 = maxWidth2;
                            int i10 = ((ViewGroup.MarginLayoutParams) lp2).bottomMargin;
                            ...
                            if (((ViewGroup.LayoutParams) lp2).height == 0 && lp2.weight > 0.0f) {
                                oldHeight = 0;
                                ((ViewGroup.LayoutParams) lp2).height = -2;
                            }
                            ...
                            if (oldHeight2 != Integer.MIN_VALUE) {
                                lp = lp2;
                                ((ViewGroup.LayoutParams) lp).height = oldHeight2;
                            } else {
                                lp = lp2;
                            }
                            int childHeight = child.getMeasuredHeight();
                            int totalLength2 = this.mTotalLength;
                            this.mTotalLength = Math.max(totalLength2, totalLength2 + childHeight + ((ViewGroup.MarginLayoutParams) lp).topMargin + ((ViewGroup.MarginLayoutParams) lp).bottomMargin + getNextLocationOffset(child));
                        ...
                        int margin3 = ((ViewGroup.MarginLayoutParams) lp).leftMargin + ((ViewGroup.MarginLayoutParams) lp).rightMargin;
                        ...
                        int i12 = (largestChildHeight2 == 0 || ((ViewGroup.LayoutParams) lp).width != i4) ? 0 : 1;
                        if (lp.weight > 0.0f) {
                            i5 = i12;
                    ...
                    if (heightMode == Integer.MIN_VALUE || heightMode == 0) {
                        ...
                        while (i13 < count) {
                            ...
                            if (child3 == null) {
                                ...
                                i = i13;
                                int i14 = ((ViewGroup.MarginLayoutParams) lp3).topMargin;
                                this.mTotalLength = Math.max(totalLength3, totalLength3 + largestChildHeight4 + i14 + ((ViewGroup.MarginLayoutParams) lp3).bottomMargin + getNextLocationOffset(child3));
                                i13 = i + 1;
                            }
                            i = i13;
                            i13 = i + 1;
                ...
                while (i17 < count) {
                    ...
                    if (child5.getVisibility() == 8) {
                        ...
                        if (childExtra > 0.0f) {
                            ...
                            delta2 = delta5 - share;
                            int childWidthMeasureSpec = getChildMeasureSpec(widthMeasureSpec, getPaddingLeft() + getPaddingRight() + ((ViewGroup.MarginLayoutParams) lp4).leftMargin + ((ViewGroup.MarginLayoutParams) lp4).rightMargin, ((ViewGroup.LayoutParams) lp4).width);
                            if (((ViewGroup.LayoutParams) lp4).height == 0 && heightMode == 1073741824) {
                                heightMode2 = heightMode;
                        ...
                        int heightMode8 = ((ViewGroup.MarginLayoutParams) lp4).leftMargin;
                        int margin4 = heightMode8 + ((ViewGroup.MarginLayoutParams) lp4).rightMargin;
                        int measuredWidth2 = child5.getMeasuredWidth() + margin4;
                        maxWidth5 = Math.max(maxWidth5, measuredWidth2);
                        if (widthMode != 1073741824) {
                            margin = margin4;
                            int margin5 = ((ViewGroup.LayoutParams) lp4).width == -1 ? 1 : 0;
                            alternativeMaxWidth6 = Math.max(alternativeMaxWidth6, margin5 == 0 ? margin : measuredWidth2);
                            int i18 = (largestChildHeight2 == 0 && ((ViewGroup.LayoutParams) lp4).width == -1) ? 1 : 0;
                            int totalLength4 = this.mTotalLength;
                            this.mTotalLength = Math.max(totalLength4, totalLength4 + child5.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) lp4).topMargin + ((ViewGroup.MarginLayoutParams) lp4).bottomMargin + getNextLocationOffset(child5));
                        ...
                        this.mTotalLength = Math.max(totalLength42, totalLength42 + child5.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) lp4).topMargin + ((ViewGroup.MarginLayoutParams) lp4).bottomMargin + getNextLocationOffset(child5));
                        largestChildHeight2 = i18;
                        delta5 = delta2;
                        weightSum = weightSum;
                    }
        ...
        while (maxHeight5 < count3) {
            ...
            if (child == null) {
                ...
                if (largestChildWidth7 == 8) {
                    ...
                    if (widthMode == 1073741824 && ((ViewGroup.LayoutParams) lp2).width == 0 && lp2.weight > 0.0f) {
                        if (isExactly) {
                            int i10 = this.mTotalLength;
                            int i11 = ((ViewGroup.MarginLayoutParams) lp2).leftMargin;
                            i7 = maxHeight5;
                            int i12 = ((ViewGroup.MarginLayoutParams) lp2).rightMargin;
                            this.mTotalLength = i10 + i11 + i12;
                        } else {
                            i7 = maxHeight5;
                            int i13 = this.mTotalLength;
                            this.mTotalLength = Math.max(i13, ((ViewGroup.MarginLayoutParams) lp2).leftMargin + i13 + ((ViewGroup.MarginLayoutParams) lp2).rightMargin);
                        }
                        if (baselineAligned2) {
                            ...
                            margin = ((ViewGroup.MarginLayoutParams) lp).topMargin + ((ViewGroup.MarginLayoutParams) lp).bottomMargin;
                        ...
                        if (((ViewGroup.LayoutParams) lp2).width == 0 && lp2.weight > 0.0f) {
                            oldWidth = 0;
                            ((ViewGroup.LayoutParams) lp2).width = -2;
                        }
                        ...
                        if (oldWidth2 != Integer.MIN_VALUE) {
                            lp = lp2;
                            ((ViewGroup.LayoutParams) lp).width = oldWidth2;
                        } else {
                            lp = lp2;
                        }
                        int childWidth = child.getMeasuredWidth();
                        if (isExactly) {
                            this.mTotalLength += ((ViewGroup.MarginLayoutParams) lp).leftMargin + childWidth + ((ViewGroup.MarginLayoutParams) lp).rightMargin + getNextLocationOffset(child);
                        } else {
                            int totalLength = this.mTotalLength;
                            this.mTotalLength = Math.max(totalLength, totalLength + childWidth + ((ViewGroup.MarginLayoutParams) lp).leftMargin + ((ViewGroup.MarginLayoutParams) lp).rightMargin + getNextLocationOffset(child));
                        }
                        if (useLargestChild2) {
                            largestChildWidth6 = Math.max(childWidth, largestChildWidth6);
                            matchHeightLocally = false;
                            if (heightMode != 1073741824 && ((ViewGroup.LayoutParams) lp).height == i5) {
                            ...
                            boolean allFillParent2 = !matchHeight && ((ViewGroup.LayoutParams) lp).height == -1;
                            if (lp.weight <= 0.0f) {
            ...
            while (i19 < count3) {
                ...
                if (child2 == null) {
                    ...
                    if (isExactly) {
                        ...
                        int i21 = ((ViewGroup.MarginLayoutParams) lp3).leftMargin + largestChildWidth8;
                        i2 = i19;
                        int i22 = ((ViewGroup.MarginLayoutParams) lp3).rightMargin;
                        this.mTotalLength = i20 + i21 + i22 + getNextLocationOffset(child2);
                    } else {
                        i2 = i19;
                        int i23 = this.mTotalLength;
                        this.mTotalLength = Math.max(i23, i23 + largestChildWidth8 + ((ViewGroup.MarginLayoutParams) lp3).leftMargin + ((ViewGroup.MarginLayoutParams) lp3).rightMargin + getNextLocationOffset(child2));
                    }
                }
                i3 = i2;
                i19 = i3 + 1;
                ...
                if (child3 != null) {
                    ...
                    if (weightedMaxHeight8 == 8) {
                        ...
                        if (childExtra > 0.0f) {
                            ...
                            delta = delta2 - share;
                            count2 = count3;
                            int childHeightMeasureSpec = getChildMeasureSpec(heightMeasureSpec, getPaddingTop() + getPaddingBottom() + ((ViewGroup.MarginLayoutParams) lp4).topMargin + ((ViewGroup.MarginLayoutParams) lp4).bottomMargin, ((ViewGroup.LayoutParams) lp4).height);
                            if (((ViewGroup.LayoutParams) lp4).width == 0 && widthMode == 1073741824) {
                        ...
                        if (isExactly) {
                            this.mTotalLength += child3.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) lp4).leftMargin + ((ViewGroup.MarginLayoutParams) lp4).rightMargin + getNextLocationOffset(child3);
                        } else {
                            int totalLength2 = this.mTotalLength;
                            this.mTotalLength = Math.max(totalLength2, child3.getMeasuredWidth() + totalLength2 + ((ViewGroup.MarginLayoutParams) lp4).leftMargin + ((ViewGroup.MarginLayoutParams) lp4).rightMargin + getNextLocationOffset(child3));
                        }
                        boolean matchHeightLocally2 = heightMode != 1073741824 && ((ViewGroup.LayoutParams) lp4).height == -1;
                        ...
                        boolean matchHeightLocally3 = matchHeight && ((ViewGroup.LayoutParams) lp4).height == -1;
                        if (baselineAligned3) {
    ...
    private void forceUniformHeight(int count, int widthMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                LayoutParams lp = (LayoutParams) child.getLayoutParams();
                if (((ViewGroup.LayoutParams) lp).height == -1) {
                    int oldWidth = ((ViewGroup.LayoutParams) lp).width;
                    ((ViewGroup.LayoutParams) lp).width = child.getMeasuredWidth();
                    measureChildWithMargins(child, widthMeasureSpec, 0, uniformMeasureSpec, 0);
                    ((ViewGroup.LayoutParams) lp).width = oldWidth;
                }
            }
        }
    }
    ...
    void layoutVertical(int left, int top, int right, int bottom) {
        ...
        while (true) {
            ...
            if (child == null) {
                ...
                int childTop5 = childTop3 + childHeight + ((ViewGroup.MarginLayoutParams) lp).bottomMargin + getNextLocationOffset(child);
                ...
                if (i4 == 8) {
                    ...
                    if (!baselineAligned2) {
                        ...
                        if (i != 16) {
                            ...
                            childTop = (((childTop2 / 2) + paddingTop) + ((ViewGroup.MarginLayoutParams) lp).topMargin) - ((ViewGroup.MarginLayoutParams) lp).bottomMargin;
                        } else if (i == 48) {
                            int childTop3 = ((ViewGroup.MarginLayoutParams) lp).topMargin;
                            childTop = childTop3 + paddingTop;
                            if (childBaseline != -1) {
                                childTop += maxAscent2[1] - childBaseline;
                            }
                        } else if (i == 80) {
                            childTop = (childBottom - childHeight) - ((ViewGroup.MarginLayoutParams) lp).bottomMargin;
                            if (childBaseline != -1) {
                        ...
                        int childLeft6 = childLeft5 + ((ViewGroup.MarginLayoutParams) lp).leftMargin;
                        maxDescent = maxDescent2;
                        maxAscent = maxAscent2;
                        isLayoutRtl = isLayoutRtl2;
                        setChildFrame(child, childLeft6 + getLocationOffset(child), childTop, childWidth, childHeight);
                        childLeft5 = childLeft6 + childWidth + ((ViewGroup.MarginLayoutParams) lp).rightMargin + getNextLocationOffset(child);
                    ...
                    int childLeft62 = childLeft5 + ((ViewGroup.MarginLayoutParams) lp).leftMargin;
                    maxDescent = maxDescent2;
                    maxAscent = maxAscent2;
                    isLayoutRtl = isLayoutRtl2;
                    setChildFrame(child, childLeft62 + getLocationOffset(child), childTop, childWidth, childHeight);
                    childLeft5 = childLeft62 + childWidth + ((ViewGroup.MarginLayoutParams) lp).rightMargin + getNextLocationOffset(child);
                    i3 += getChildrenSkipCount(child, childIndex);
                }
            }
            i2 = i3 + 1;
