...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int ttcIndex, @IntRange(from = 1, to = Timer.MIN_LENGTH) int weight, boolean italic, int resultCode) {
        ...
        @IntRange(from = 1, to = Timer.MIN_LENGTH)
