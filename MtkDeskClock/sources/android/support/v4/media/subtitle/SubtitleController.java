    ...
    public SubtitleTrack getDefaultTrack() {
        ...
        synchronized (this.mTracksLock) {
            for (SubtitleTrack track : this.mTracks) {
                ...
                boolean languageMatches = locale2 == null || locale2.getLanguage().equals(BuildConfig.FLAVOR) || locale2.getISO3Language().equals(language) || locale2.getLanguage().equals(language);
