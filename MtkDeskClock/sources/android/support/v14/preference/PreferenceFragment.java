...
public abstract class PreferenceFragment extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        TypedArray a = this.mStyledContext.obtainStyledAttributes(null, android.support.v7.preference.R.styleable.PreferenceFragment, TypedArrayUtils.getAttr(this.mStyledContext, android.support.v7.preference.R.attr.preferenceFragmentStyle, 16844038), 0);
        this.mLayoutResId = a.getResourceId(android.support.v7.preference.R.styleable.PreferenceFragment_android_layout, this.mLayoutResId);
        Drawable divider = a.getDrawable(android.support.v7.preference.R.styleable.PreferenceFragment_android_divider);
        int dividerHeight = a.getDimensionPixelSize(android.support.v7.preference.R.styleable.PreferenceFragment_android_dividerHeight, -1);
        boolean allowDividerAfterLastItem = a.getBoolean(android.support.v7.preference.R.styleable.PreferenceFragment_allowDividerAfterLastItem, true);
        a.recycle();
        TypedValue tv = new TypedValue();
        getActivity().getTheme().resolveAttribute(android.support.v7.preference.R.attr.preferenceTheme, tv, true);
        int theme = tv.resourceId;
    ...
    public RecyclerView onCreateRecyclerView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        RecyclerView recyclerView = (RecyclerView) inflater.inflate(android.support.v7.preference.R.layout.preference_recyclerview, parent, false);
