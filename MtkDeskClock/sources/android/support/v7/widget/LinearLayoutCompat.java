...
public class LinearLayoutCompat extends ViewGroup {
                    ...
                    if (child5.getVisibility() == 8) {
                        ...
                        if (childExtra > 0.0f) {
                            ...
                            if (lp4.height == 0 && heightMode == 1073741824) {
                                ...
                                childState8 = View.combineMeasuredStates(childState8, child5.getMeasuredState() & InputDeviceCompat.SOURCE_ANY);
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (skippedMeasure || (delta2 != 0 && totalWeight > 0.0f)) {
                ...
                if (child3 != null) {
                    ...
                    if (weightedMaxHeight8 == 8) {
                        ...
                        if (childExtra > 0.0f) {
                            ...
                            childState7 = View.combineMeasuredStates(childState7, child3.getMeasuredState() & ViewCompat.MEASURED_STATE_MASK);
                        } else {
                            count2 = count3;
            ...
            setMeasuredDimension((childState & ViewCompat.MEASURED_STATE_MASK) | widthSizeAndState, View.resolveSizeAndState(Math.max(maxHeight2 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i, childState << 16));
    ...
    void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int majorGravity2 = this.mGravity & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
