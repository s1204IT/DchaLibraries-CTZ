...
class MtkDhcp6RebindPacket extends MtkDhcp6Packet {
    MtkDhcp6RebindPacket(byte[] bArr, byte[] bArr2) {
    ...
    public ByteBuffer buildPacket(short s, short s2) {
        ...
        fillInPacket(INADDR_BROADCAST_ROUTER, INADDR_ANY, s, s2, byteBufferAllocate, (byte) 3);
