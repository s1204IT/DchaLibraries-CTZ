...
public interface MtkRILConstants extends RILConstants {
    public static final int CXP_CONFIG_TYPE_OPTR = 0;
    public static final int CXP_CONFIG_TYPE_SBP = 3;
    public static final int CXP_CONFIG_TYPE_SEG = 2;
    public static final int CXP_CONFIG_TYPE_SPEC = 1;
    public static final int CXP_CONFIG_TYPE_SUBID = 4;
    ...
    public static final int RIL_REQUEST_EMERGENCY_DIAL = 2017;
    ...
    public static final int RIL_REQUEST_GET_SS_PROPERTY = 2169;
    ...
    public static final int RIL_REQUEST_IMS_BEARER_ACTIVATION_DONE = 2080;
    public static final int RIL_REQUEST_IMS_BEARER_DEACTIVATION_DONE = 2081;
    ...
    public static final int RIL_REQUEST_IMS_CONFIG_SET_RESOURCE_CAP = 2140;
    ...
    public static final int RIL_REQUEST_RELOAD_MODEM_TYPE = 2026;
    ...
    public static final int RIL_REQUEST_REPORT_AIRPLANE_MODE = 2154;
    public static final int RIL_REQUEST_REPORT_SIM_MODE = 2155;
    ...
    public static final int RIL_REQUEST_SET_ECC_SERVICE_CATEGORY = 2018;
    ...
    public static final int RIL_REQUEST_SET_OPERATOR_CONFIGURATION = 2165;
    ...
    public static final int RIL_REQUEST_SET_SILENT_REBOOT = 2156;
    ...
    public static final int RIL_REQUEST_STORE_MODEM_TYPE = 2027;
    public static final int RIL_REQUEST_SWITCH_MODE_FOR_ECC = 2023;
    public static final int RIL_REQUEST_SYNC_APN_TABLE = 2061;
    ...
    public static final int RIL_UNSOL_IMS_BEARER_ACTIVATION = 3049;
    public static final int RIL_UNSOL_IMS_BEARER_DEACTIVATION = 3050;
