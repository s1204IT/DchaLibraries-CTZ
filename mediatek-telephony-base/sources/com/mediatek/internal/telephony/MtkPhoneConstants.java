...
public class MtkPhoneConstants {
    ...
    public static final String[] MTK_APN_TYPES = {"default", "mms", "supl", "dun", "hipri", "fota", GbaManager.IMS_SERVICE, "cbs", "ia", "emergency", APN_TYPE_WAP, APN_TYPE_XCAP, APN_TYPE_RCS, APN_TYPE_BIP, APN_TYPE_VSIM};
}
