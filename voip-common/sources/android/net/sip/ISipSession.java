...
public interface ISipSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISipSession {
        ...
        public static ISipSession asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof ISipSession)) {
                return (ISipSession) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface(DESCRIPTOR);
                    SipProfile localProfile = getLocalProfile();
                    parcel2.writeNoException();
                    if (localProfile != null) {
                        parcel2.writeInt(1);
                        localProfile.writeToParcel(parcel2, 1);
                    } else {
                        parcel2.writeInt(0);
                    }
                    return true;
                case 3:
                    parcel.enforceInterface(DESCRIPTOR);
                    SipProfile peerProfile = getPeerProfile();
                    parcel2.writeNoException();
                    if (peerProfile != null) {
                        parcel2.writeInt(1);
                        peerProfile.writeToParcel(parcel2, 1);
                    } else {
                        parcel2.writeInt(0);
                    }
                    return true;
                ...
                case 10:
                    ...
                    makeCall(sipProfileCreateFromParcel, parcel.readString(), parcel.readInt());
                    parcel2.writeNoException();
                    return true;
        ...
        private static class Proxy implements ISipSession {
            ...
            public SipProfile getLocalProfile() throws RemoteException {
                ...
                try {
                    ...
                    if (parcelObtain2.readInt() != 0) {
                        sipProfileCreateFromParcel = SipProfile.CREATOR.createFromParcel(parcelObtain2);
                    } else {
                        sipProfileCreateFromParcel = null;
                    }
            ...
            public void answerCall(String str, int i) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain.writeString(str);
                    parcelObtain.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_answerCall, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
            ...
            public void endCall() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_endCall, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
            ...
            public void changeCall(String str, int i) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain.writeString(str);
                    parcelObtain.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_changeCall, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
