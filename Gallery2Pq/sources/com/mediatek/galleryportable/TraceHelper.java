...
public class TraceHelper {
    ...
    public static void beginSection(String sectionName) {
        ...
        if (sTraceBeginMethod != null && sTraceEndMethod != null) {
            try {
                ...
                Log.d("MtkGallery2/TraceHelper", "<beginSection> IllegalAccessException", e);
                return;
            } catch (InvocationTargetException e2) {
                Log.d("MtkGallery2/TraceHelper", "<beginSection> InvocationTargetException", e2);
                return;
            }
        }
        if (sSupportTrace) {
    ...
    public static void endSection() {
        ...
        if (sTraceBeginMethod != null && sTraceEndMethod != null) {
            try {
                ...
                Log.d("MtkGallery2/TraceHelper", "<endSection> IllegalAccessException", e);
                return;
            } catch (InvocationTargetException e2) {
                Log.d("MtkGallery2/TraceHelper", "<endSection> InvocationTargetException", e2);
                return;
            }
        }
        if (sSupportTrace) {
    ...
    private static void checkWhetherSupport() {
        ...
        try {
            ...
            Log.d("MtkGallery2/TraceHelper", "<checkWhetherSupport> IllegalAccessException", e);
        } catch (NoSuchFieldException e2) {
            Log.d("MtkGallery2/TraceHelper", "<checkWhetherSupport> NoSuchFieldException", e2);
        } catch (NoSuchMethodException e3) {
            Log.d("MtkGallery2/TraceHelper", "<checkWhetherSupport> NoSuchMethodException", e3);
        }
        sHasCheck = true;
    }
}
