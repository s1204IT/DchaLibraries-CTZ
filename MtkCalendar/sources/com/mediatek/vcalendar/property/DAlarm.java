...
public class DAlarm extends Property {
    public DAlarm(String str) {
        super("DALARM", str);
        LogUtil.d("DAlarm", "Constructor: DAlarm property created.");
    }

    public void writeInfoToContentValues(LinkedList<ContentValues> linkedList, long j) throws VCalendarException {
        LogUtil.d("DAlarm", "writeInfoToContentValues()");
        if (linkedList == null) {
            LogUtil.e("DAlarm", "writeInfoToContentValues(): the argument ContentValue must not be null.");
