...
public class ComponentParser {
    ...
    private static String normalizeText(String str) {
        ...
        LogUtil.d("ComponentParser", "normalizeText(): normalized text: \n" + strReplaceAll2);
    ...
    private static Component parseComponentImpl(Component component, String str) {
        ...
        for (String str2 : str.split("\n")) {
            try {
                ...
                LogUtil.e("ComponentParser", "parseComponentImpl(): Can NOT parse line: " + str2, e);
            }
        }
        return component;
    }
    ...
    private static Component parseLine(String str, ParserState parserState, Component component) throws VCalendarException {
        ...
        if (component == null && !"BEGIN".equals(strSubstring)) {
            throw new VCalendarException("parseLine(): Expected \"BEGIN\" but NOT.");
        }
        if ("BEGIN".equals(strSubstring)) {
        ...
        if (strExtractValue2 != null) {
            LogUtil.d("ComponentParser", "parseLine(): property value = " + strExtractValue2);
            propertyCreateProperty.setValue(strExtractValue2, propertyCreateProperty.getFirstParameter("ENCODING"));
            component.addProperty(propertyCreateProperty);
            LogUtil.d("ComponentParser", "parseLine(): \"" + propertyCreateProperty.getName() + "\" added to component:\"" + component.getName() + "\"");
        }
        return component;
    }
    ...
    private static String extractValue(ParserState parserState) throws VCalendarException {
        ...
        if (parserState.mIndex >= str.length() || str.charAt(parserState.mIndex) != ':') {
            LogUtil.d("ComponentParser", "extractValue(): Expect ':' before end of line in: " + str);
            return null;
        }
