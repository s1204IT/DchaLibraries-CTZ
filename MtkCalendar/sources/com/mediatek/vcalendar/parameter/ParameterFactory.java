...
public final class ParameterFactory {
    public static Parameter createParameter(String str, String str2) {
        LogUtil.d("ParameterFactory", "createParameter(): name: " + str + " value: " + str2);
        if (str == null) {
            LogUtil.e("ParameterFactory", "createParameter(): Cannot create a parameter without giving defined name");
            return null;
        }
        ...
        if ("PARTSTAT".equals(upperCase)) {
            return new PartStat(str2);
        }
        if ("ROLE".equals(upperCase)) {
        ...
        if ("X-RELATIONSHIP".equals(upperCase)) {
