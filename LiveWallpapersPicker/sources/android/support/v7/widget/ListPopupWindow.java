...
public class ListPopupWindow implements ShowableListMenu {
    ...
    private void removePromptView() {
        if (this.mPromptView != null) {
            ?? parent = this.mPromptView.getParent();
            if (parent instanceof ViewGroup) {
                parent.removeView(this.mPromptView);
            }
        }
    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mDropDownList.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ?? r0;
                    if (position != -1 && (r0 = ListPopupWindow.this.mDropDownList) != 0) {
                        throw r0;
                    }
                }
            ...
            if (view != null) {
                ...
                view2 = linearLayout;
                measuredHeight = view.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams2).bottomMargin;
            }
        ...
        int i4 = maxAvailableHeight - measuredHeight;
        ?? OnForwardedEvent = this.mDropDownList.onForwardedEvent(iMakeMeasureSpec, 0);
        if (OnForwardedEvent > 0) {
            measuredHeight += i + this.mDropDownList.getPaddingTop() + this.mDropDownList.getPaddingBottom();
        }
        return (OnForwardedEvent == true ? 1 : 0) + measuredHeight;
    }
