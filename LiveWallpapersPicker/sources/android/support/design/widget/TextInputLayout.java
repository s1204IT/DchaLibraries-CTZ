...
public class TextInputLayout extends LinearLayout {
    ...
    public void addView(View view, int index, ViewGroup.LayoutParams params) {
        if (view instanceof EditText) {
            ...
            this.inputFrame.addView(view, flp);
    ...
    private void updateInputLayoutMargins() {
        ...
        if (newTopMargin != ((ViewGroup.MarginLayoutParams) lp).topMargin) {
            ((ViewGroup.MarginLayoutParams) lp).topMargin = newTopMargin;
    ...
    private void ensureBackgroundDrawableStateWorkaround() {
        ...
        if ((sdk == 21 || sdk == 22) && (background = this.editText.getBackground()) != 0 && !this.hasReconstructedEditTextBackground) {
            Drawable newBg = background.getConstantState().newDrawable();
            if (background instanceof DrawableContainer) {
                this.hasReconstructedEditTextBackground = DrawableUtils.setContainerConstantState(background, newBg.getConstantState());
            }
