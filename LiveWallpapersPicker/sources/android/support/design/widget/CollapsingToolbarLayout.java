...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        if (parent instanceof AppBarLayout) {
            ...
            parent.addOnOffsetChangedListener(this.onOffsetChangedListener);
    ...
    protected void onDetachedFromWindow() {
        ...
        if (this.onOffsetChangedListener != null && (parent instanceof AppBarLayout)) {
            parent.removeOnOffsetChangedListener(this.onOffsetChangedListener);
        }
    ...
    private void updateDummyView() {
        if (!this.collapsingTitleEnabled && this.dummyView != null) {
            ?? parent = this.dummyView.getParent();
    ...
    private static int getHeightWithMargins(View view) {
        ...
        if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
            return view.getHeight() + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin;
        }
    ...
    final int getMaxOffsetForPinChild(View child) {
        ...
        return ((getHeight() - offsetHelper.getLayoutTop()) - child.getHeight()) - ((ViewGroup.MarginLayoutParams) lp).bottomMargin;
    }
