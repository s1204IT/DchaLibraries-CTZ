...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createIconFadeAnimation(View view, final View view2, boolean expanded, boolean currentlyAnimating, FabTransformationSpec spec, List<Animator> animations, List<Animator.AnimatorListener> listeners) {
    ...
    private ViewGroup calculateChildContentContainer(View view) {
        ...
        if ((view instanceof TransformationChildLayout) || (view instanceof TransformationChildCard)) {
            return toViewGroupOrNull(view.getChildAt(0));
        }
