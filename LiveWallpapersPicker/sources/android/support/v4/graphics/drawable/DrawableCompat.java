    ...
    public static void clearColorFilter(Drawable drawable) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (drawable instanceof InsetDrawable) {
                clearColorFilter(drawable.getDrawable());
                return;
            }
            ...
            if ((drawable instanceof DrawableContainer) && (state = (DrawableContainer.DrawableContainerState) drawable.getConstantState()) != null) {
